...
declare -a files=(hybrid_software_requirements_specifications_and_traceability)
...
clean_files () {
	...
	do
		...
		do
			rm -rf *.aux *.bbl *.blg *.log *.out *.toc *.lot *.lof hybrid_software_requirements_specifications_and_traceability.pdf
		done
	done
}
