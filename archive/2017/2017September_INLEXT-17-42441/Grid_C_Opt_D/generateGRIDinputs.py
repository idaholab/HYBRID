...
basefile = 'HYBRun_Modelica_C_RxR.xml'
        ...
        for H2 in cases['H2']:
          for Win in cases['Win']:
            for Seed in cases['Seed']:
              ...
              # make folde
              foldername = 'dem' + str(dem) + '_SES' + str(SES) + '_IP' + str(IP) + '_ES' + str(ES) + '_H2-' + str(H2) + '_win' + str(Win) + '_seed' + str(Seed)
              ...
              newfile = base.replace("REPLACE_demand", str(dem)).replace("REPLACE_SES", str(SES)).replace("REPLACE_IP",str(IP)).replace("REPLACE_ES",str(ES)).replace("REPLACE_renewable",str(Win)).replace("REPLACE_renewabl1",str(Win+0.1)).replace("REPLACE_h2price",str(H2)).replace("REPLACE_seed",str(Seed))
