...
model ElectricGenerator "Active power generator"
  ...
  parameter SI.Frequency fstart = 60 "Start value of the electrical frequency"
  ...
  parameter HydrogenTurbine.Utilities.OptionsInit.Temp initOpt=HydrogenTurbine.Utilities.OptionsInit.noInit
...
initial equation
  if initOpt == HydrogenTurbine.Utilities.OptionsInit.noInit then
    // Do nothing
  elseif initOpt == HydrogenTurbine.Utilities.OptionsInit.steadyState then
    der(omega_m) = 0;
  else
