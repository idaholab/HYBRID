...
model GasTurbineUnit
  extends HydrogenTurbine.Icons.GasTurbineUnit;
  ...
  replaceable package Fuel = Media.Hydrogen constrainedby
    Modelica.Media.Interfaces.PartialMedium "N2, CO2, H2" annotation (Dialog(group="Working fluids (Medium)"));
