...
partial package SeaWater "Salt Water media using IAPWS industrial fromulation"
  ...
  algorithm
    s := SeaWater.IAPWS_Utilities.s_pTX(
        state.p,
        state.T,
        state.X);
    annotation (Documentation(info="<html>
  ...
  package IAPWS_Utilities
    ...
    function g1 "Gibbs function for region 1: g(p,T,S)"
      ...
      output SeaWater.IAPWS_Utilities.GibbsDerivsBrine g
        "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
    ...
    protected
      SeaWater.IAPWS_Utilities.GibbsDerivsBrine gibbs
        "Dimensionless Gibbs function and derivatives w.r.t. pi and tau";
    algorithm
    ...
    function h_pTX
      ...
      output Modelica.Units.SI.SpecificEnthalpy h "Specific enthalpy";
    algorithm
      h := SeaWater.IAPWS_Utilities.h_props_pT(
            p,
            T,
            X,
            SeaWater.IAPWS_Utilities.seaWaterBaseProp_pT(
              p,
              T,
              X));
...
<ul>
 ...
 <li>Documentation added: December 2002</li>
    ...
    algorithm
      rho := SeaWater.IAPWS_Utilities.rho_props_pT(
            p,
            T,
            X,
            SeaWater.IAPWS_Utilities.seaWaterBaseProp_pT(
    ...
    algorithm
      mu := SeaWater.IAPWS_Utilities.mu_props_pT(
            p,
            T,
            X,
            SeaWater.IAPWS_Utilities.seaWaterBaseProp_pT(
    ...
    algorithm
      s := SeaWater.IAPWS_Utilities.s_props_pT(
            p,
            T,
            X,
            SeaWater.IAPWS_Utilities.seaWaterBaseProp_pT(
    ...
    algorithm
      ...
      aux.vt := 0.0 "Initialized in case it is not needed";
      aux.vp := 0.0 "Initialized in case it is not needed";
      aux.T := SeaWater.IAPWS_Utilities.tph(
            aux.p,
            aux.h,
            X);
    ...
    function rho_phX
      ...
      output Modelica.Units.SI.Density rho "Density";
    algorithm
      rho := SeaWater.IAPWS_Utilities.rho_props_ph(
            p,
            h,
            X,
            SeaWater.IAPWS_Utilities.waterBaseProp_phX(
              p,
              h,
              X));
      annotation (Inline=true);
    ...
    function rho_props_ph
      ...
      input Modelica.Units.SI.SpecificEnthalpy h "Specific enthalpy";
      input Modelica.Units.SI.MassFraction X[:];
      input SeaWater.IAPWS_Utilities.IAPWSBase properties "Auxiliary record";
      output Modelica.Units.SI.Density rho "Density";
    algorithm
      rho := properties.rho;
      annotation (
    ...
    function gs_pTX
      ...
      output Modelica.Units.SI.SpecificEnergy gs "Chemical Potential";
    algorithm
      gs := SeaWater.IAPWS_Utilities.gs_props_pT(
            p,
            T,
            X,
            SeaWater.IAPWS_Utilities.seaWaterBaseProp_pT(
    ...
    algorithm
      cp := SeaWater.IAPWS_Utilities.cp_props_pT(
            p,
            T,
            X,
            SeaWater.IAPWS_Utilities.seaWaterBaseProp_pT(
  ...
  algorithm
    state := SeaWater.ThermodynamicState(
        d=SeaWater.density_pTX(
          p,
          T,
          X),
        T=T,
        h=SeaWater.specificEnthalpy_pTX(
          p,
          T,
          X),
        p=p,
  ...
  redeclare function extends specificGibbsEnergy
    ...
    extends Modelica.Icons.Function;
  algorithm
    g := state.h - state.T*SeaWater.specificEntropy(state);
    annotation (Inline=true);
  ...
  algorithm
    muW := SeaWater.specificGibbsEnergy(state) - state.X[2]*
      SeaWater.IAPWS_Utilities.mu_pTX(
        state.p,
        state.T,
        state.X);
    annotation (Documentation(info="<html>
  ...
  algorithm
    state := SeaWater.ThermodynamicState(
        d=SeaWater.density_phX(
          p,
          h,
          X),
        T=SeaWater.temperature_phX(
          p,
          h,
          X),
        h=h,
  ...
  algorithm
    T := SeaWater.IAPWS_Utilities.tph(
        p,
        h,
        X);
    annotation (Inline=true);
  ...
  redeclare function density_phX
    ...
    output Density d "Density";
  algorithm
    d := SeaWater.IAPWS_Utilities.rho_phX(
        p,
        h,
        X);
    annotation (Inline=true);
