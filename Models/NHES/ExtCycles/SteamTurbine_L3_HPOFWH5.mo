...
equation
  ...
  connect(moistureSeperator.port_Liquid, OFWH_1.port_b) annotation (Line(
        points={{34,54},{34,-46},{42,-46},{42,-62},{32,-62}}, color={0,127,
          255}));
  ...
  connect(PA_LPT.y, LPT1.partialArc) annotation (Line(points={{-141,38},{-122,
          38},{-122,14},{-114,14},{-114,-14},{-68,-14},{-68,18},{6,18},{6,40},{
          9,40},{9,50}}, color={0,0,127}));
