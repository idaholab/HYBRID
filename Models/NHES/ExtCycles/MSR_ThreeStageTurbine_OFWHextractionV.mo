...
model MSR_ThreeStageTurbine_OFWHextractionV
...
//  parameter Modelica.Units.SI.MassFlowRate m_ext=40;
  ...
  parameter Modelica.Units.SI.Density d_ext=1.0598   "kg/m3";

  parameter Modelica.Units.SI.MassFlowRate m_ext=1.500;
  ...
  Data_L3_master                                          data(
    ...
    Tin=820.15,
    Tfeed=560.15,
    d_HPT_in(displayUnit="kg/m3") = 80.99866551,
    d_LPT1_in(displayUnit="kg/m3") = d_ext,
    d_LPT2_in(displayUnit="kg/m3") = 0.862546399,
    mdot_total=48.57102115,
    mdot_fh=15.90523117,
    mdpt_HPFH=20,
    mdot_hpt=32.66578998,
    mdot_lpt1=32.66578998,
    mdot_lpt2=28.16082304,
    m_ext=m_ext,
...
end MSR_ThreeStageTurbine_OFWHextractionV;
