within NHES.GasTurbine.Compressor;
model AirSourceW "Air mass flow source"
  extends GasTurbine.Icons.AirSourceW;
  ...
  parameter GasTurbine.Types.ThetaIGV thetaIGV0=85 "Nominal IGV angle";
  ...
  final parameter GasTurbine.Types.ThetaIGV thetaIGV_start=thetaIGV0
    "IGV angle start value";
  parameter GasTurbine.Types.ThetaIGV thetaIGVmin=11.6 "Minimum IGV angle"
    annotation (Dialog(tab="Air flow dynamics"));
  parameter GasTurbine.Types.ThetaIGV thetaIGVmax=85 "Maximum IGV angle"
    annotation (Dialog(tab="Air flow dynamics"));
  ...
  GasTurbine.Types.ThetaIGV thetaIGV(start=thetaIGV_start);
