within NHES.GasTurbine.Turbine.BaseClasses;
partial model TurbineBase_v3 "Gas Turbine"
  ...
  Modelica.Mechanics.Rotational.Interfaces.Flange_a shaft_a annotation (
      Placement(transformation(extent={{-70,-12},{-46,12}}, rotation=0)));
  Modelica.Mechanics.Rotational.Interfaces.Flange_b shaft_b annotation (
      Placement(transformation(extent={{50,-12},{74,12}}, rotation=0)));
equation
  w = inlet.m_flow;
