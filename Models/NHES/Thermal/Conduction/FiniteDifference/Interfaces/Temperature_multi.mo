...
model Temperature_multi "Temperature boundary condition in Kelvin"
  ...
  input SI.Temperature T[nPorts]=fill(293.15,nPorts) "Fixed temperature at port"             annotation(Dialog(                        enable=not use_port));
...
public
  TRANSFORM.HeatAndMassTransfer.Interfaces.HeatPort_State port[nPorts]
...
equation
  ...
  annotation (defaultComponentName="boundary",
    Icon(coordinateSystem(preserveAspectRatio=true, extent={{-40,-80},{100,60}}),
                        graphics={
        Rectangle(
          extent={{-44,60},{60,-60}},
          lineColor={0,0,0},
...
</html>"), Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-40,-80},
            {100,60}})));
end Temperature_multi;
