...
model AxialPowToNodeVolHeat_2DCyl
  ...
  Modelica.Blocks.Interfaces.RealInput Power_in[nAxial - 1]
  ...
  SI.Volume volAxial = volTotal/(nAxial-1);
  Real q_ppp_vol[nAxial-1](unit="W/m3");
...
for i in 1:nRadial loop
  ...
  q_ppp[i,nAxial] = q_ppp_vol[nAxial-1];
end for;
