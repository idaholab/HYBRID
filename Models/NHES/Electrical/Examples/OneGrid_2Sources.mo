...
model OneGrid_2Sources
  ...
  Grid grid(
    Q_nominal=10e10,
    droop=0.05,
    n=2) annotation (Placement(transformation(extent={{80,-10},{100,10}})));
  ...
  Utilities.Visualizers.displayReal display1(x=grid.ports[1].W/10^6)
    annotation (Placement(transformation(extent={{70,-30},{90,-10}})));
  Utilities.Visualizers.displayReal display3(x=grid.ports[1].f)
...
equation
  ...
  connect(generator1.portElec, grid.ports[1]) annotation (Line(points={{20,-32},
          {36,-32},{50,-32},{50,2},{80,2}},   color={255,0,0}));
  connect(generator.portElec, grid.ports[2]) annotation (Line(points={{20,54},{
          34,54},{50,54},{50,-2},{80,-2}},
                                      color={255,0,0}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end OneGrid_2Sources;
