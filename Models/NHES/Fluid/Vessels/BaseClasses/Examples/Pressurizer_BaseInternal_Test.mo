within NHES.Fluid.Vessels.BaseClasses.Examples;
model Pressurizer_BaseInternal_Test
  ...
  Modelica.Fluid.Sources.MassFlowSource_h spray(
    ...
    nPorts=1)
             annotation (Placement(transformation(extent={{-48,50},{-28,70}})));
  NHES.Fluid.Vessels.BaseClasses.Pressurizer_BaseInternal drum2Phase(
    V_total=2/3*pi + pi + 2/3*pi,
    redeclare model DrumType =
        Vessels.BaseClasses.BaseDrum.DrumTypes.Traditional (
        r_1=1,
        r_2=1,
        h_2=1,
        r_3=1),
    redeclare model BulkEvaporation =
        Vessels.BaseClasses.BaseDrum.Evaporation.ConstantTimeDelay (
          tau=15),
    redeclare model BulkCondensation =
        Vessels.BaseClasses.BaseDrum.Condensation.ConstantTimeDelay (
          tau=15),
    redeclare model MassTransfer_VL =
        Vessels.BaseClasses.BaseDrum.PhaseInterface.ConstantMassTransportCoefficient
        (alphaD0=1e-3),
    redeclare model HeatTransfer_VL =
        Vessels.BaseClasses.BaseDrum.PhaseInterface.ConstantHeatTransferCoefficient
        (alpha0=100),
    redeclare model HeatTransfer_WL =
        Vessels.BaseClasses.BaseDrum.HeatTransfer.ConstantHeatTransferCoefficient,
    redeclare model HeatTransfer_WV =
        Vessels.BaseClasses.BaseDrum.HeatTransfer.ConstantHeatTransferCoefficient
        (alpha0=0),
    Vfrac_liquid_start=0.6) annotation (Placement(transformation(
          extent={{-23,-24},{23,24}})));
...
equation
  ...
  connect(spray.ports[1], drum2Phase.sprayPort) annotation (Line(points={{-28,60},
          {-13.8,60},{-13.8,24},{-13.8,24}},   color={0,127,255}));
