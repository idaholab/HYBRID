...
model Pressurizer
  ...
  replaceable model DrumType =
    NHES.Fluid.Vessels.BaseClasses.BaseDrum.DrumTypes.PartialDrumType
  ...
  Modelica.Fluid.Interfaces.FluidPort_a sprayPort(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{-70,90},{-50,110}})));
  Modelica.Fluid.Interfaces.FluidPort_b reliefPort(redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{50,90},{70,110}})));
  Modelica.Fluid.Interfaces.FluidPort_a surgePort(redeclare package Medium =
        Medium)
