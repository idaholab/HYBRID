...
partial model SteamTurbineBase "Steam turbine"
  ...
  Modelica.Fluid.Interfaces.FluidPort_a portHP(
  ...
  Modelica.Fluid.Interfaces.FluidPort_a portLP(
      redeclare package Medium = Medium,
...
"= true to allow flow reversal, false restricts to design direction"
  ...
  replaceable model Eta_wetSteam =
      NHES.Fluid.Machines.BaseClasses.WetSteamEfficiency.eta_Constant
    constrainedby
    NHES.Fluid.Machines.BaseClasses.WetSteamEfficiency.Partial_eta
 ...
 //Initialization
  ...
  NHES.SIunits.nonDim x_th_in "Inlet thermodynamic quality";
  NHES.SIunits.nonDim x_abs_in "Inlet absolute mass quality";

  NHES.SIunits.nonDim x_th_out "Outlet thermodynamic quality";
  NHES.SIunits.nonDim x_abs_out "Outlet absolute mass quality";
