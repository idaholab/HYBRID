within NHES.Fluid.Pipes.BaseClasses.HeatTransfer.Examples;
model TestFlow1D2phChen "Test case for Flow1D2phChen"
  ...
  StraightPipe_withWall                     pipe(
    ...
    h_a_start=1e5,
    h_b_start=1e5,
    redeclare package Wall_Material = Media.Solids.GenericSolid,
    redeclare model HeatTransfer = Overall_Evaporation,
    p_a_start=6010000,
    p_b_start=6000000,
    Tref=510)
