...
model Grimson_FlowAcrossTubeBundels
  "Grimson: Flow Across Tube Bundels"
  ...
  Modelica.Blocks.Tables.CombiTable2Ds C_1a(table=[0.0,1.25,1.50,2.00,3.00;
        1.25,0.348,0.275,0.100,0.0633; 1.50,0.367,0.250,0.101,0.0678; 2.00,
        0.418,0.299,0.229,0.198; 3.00,0.290,0.357,0.374,0.286])
    "Aligned constant"
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
  Modelica.Blocks.Tables.CombiTable2Ds m_a(table=[0.0,1.25,1.50,2.00,3.00; 1.25,
        0.592,0.608,0.704,0.752; 1.50,0.586,0.620,0.702,0.744; 2.00,0.570,0.602,
        0.632,0.648; 3.00,0.601,0.584,0.581,0.608]) "Aligned constant"
    annotation (Placement(transformation(extent={{-40,-26},{-20,-6}})));
  Modelica.Blocks.Tables.CombiTable2Ds m_s(table=[0.0,1.25,1.50,2.00,3.00;
        0.600,0.556,0.558,0.571,0.636; 0.900,0.556,0.558,0.571,0.581; 1.000,
        0.556,0.558,0.568,0.571; 1.125,0.556,0.556,0.565,0.560; 1.250,0.556,
        0.554,0.556,0.562; 1.500,0.568,0.562,0.568,0.568; 2.000,0.572,0.568,
        0.556,0.570; 3.000,0.592,0.580,0.562,0.574]) "Staggered contant"
    annotation (Placement(transformation(extent={{-40,-80},{-20,-60}})));
  Modelica.Blocks.Tables.CombiTable2Ds C_1s(table=[0.0,1.25,1.50,2.00,3.00;
        0.600,0.518,0.497,0.446,0.213; 0.900,0.518,0.497,0.446,0.401; 1.000,
        0.518,0.497,0.462,0.460; 1.125,0.518,0.501,0.478,0.518; 1.250,0.518,
        0.505,0.519,0.522; 1.500,0.451,0.460,0.452,0.488; 2.000,0.404,0.416,
        0.482,0.449; 3.000,0.310,0.356,0.440,0.428]) "Staggered contant"
...
equation
  ...
  for i in 1:nHT loop
    ...
    alphas[i] =
      NHES.Utilities.CharacteristicNumbers.HeatTransferCoeffient(
                Nu=Nus[i],
                D=D,
                lambda=lambdas[i]);
  end for;
