...
model FlowCV "Flow control valve"
  ...
  Modelica.Blocks.Interfaces.RealInput opening(min=0, max=1) if Use_input
...
equation
  ...
  connect(opening, inputSwitch.u1) annotation (Line(points={{0,80},{-50,80},{-50,
          68},{-56,68},{-56,52},{-82,52},{-82,62}}, color={0,0,127}));
