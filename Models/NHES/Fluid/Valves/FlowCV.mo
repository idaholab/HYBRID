...
<p>Linear Control Valve with built in LimOffsetPID controller, controlling the valve flow rate.  This model is should only be used in model development.  Finished model should use control systems for valve controls.</p>
<p><br><br><br><br>Target flow rate can be either a set parameter or a real input.</p><p><br><br><br><br>Model developed at INL by Logan Williams <span style=\"font-family: inherit;\"><a href=\"mailto:logan.williams@inl.gov\">Logan.Williams@inl.gov</a></span></p>
