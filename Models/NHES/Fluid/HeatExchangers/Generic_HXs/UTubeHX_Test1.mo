...
model UTubeHX_Test1
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T TubeHeIn(
    ...
    m_flow=0.2,
    T=673.15,
    nPorts=1) annotation (Placement(transformation(extent={{-116,-90},{-96,-70}})));
...
equation
  ...
  connect(tube_one.port_a, TubeHeIn.ports[1]) annotation (Line(points={{-50,-80},{-96,-80}}, color={0,127,255}));
  connect(tube_two.port_b, TubeHeOut.ports[1]) annotation (Line(points={{42,-80},{94,-80}}, color={0,127,255}));
  annotation (
