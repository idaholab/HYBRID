...
model UTubeHX_Test2
  ...
  replaceable package Medium_tube = Modelica.Media.IdealGases.SingleGases.He
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT ShellHeOut(
    redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He,
    p=3000000,
    nPorts=1) annotation (Placement(transformation(extent={{-106,38},{-86,58}})));
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T TubeHeIn(
    redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He,
    m_flow=0.3,
    T=673.15,
    nPorts=1) annotation (Placement(transformation(extent={{-154,-48},{-134,-28}})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT TubeHeOut(
    redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He,
    p=4000000,
    nPorts=1)
    annotation (Placement(transformation(extent={{136,-50},{116,-30}})));
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T ShellHeIn(
    redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He,
    m_flow=0.2,
    T=1123.15,
    nPorts=1) annotation (Placement(transformation(extent={{114,36},{94,56}})));
  Modelica.Fluid.Fittings.TeeJunctionIdeal Split(redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-110,-80})));
  Modelica.Fluid.Fittings.TeeJunctionIdeal Combine(redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=270,
        origin={90,-74})));
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistance(redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He, R=1)
    annotation (Placement(transformation(extent={{-92,-66},{-72,-46}})));
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistance1(redeclare package Medium = Modelica.Media.IdealGases.SingleGases.He, R=1)
...
equation
  ...
  connect(ShellHeOut.ports[1], shell.port_b) annotation (Line(points={{-86,48},{-86,46},{-10,46}}, color={0,127,255}));
  connect(shell.port_a, ShellHeIn.ports[1]) annotation (Line(points={{10,46},{94,46}}, color={0,127,255}));
  connect(TubeHeIn.ports[1], Split.port_3) annotation (Line(points={{-134,-38},{-128,-38},{-128,-80},{-120,-80}}, color={0,127,255}));
  connect(Split.port_2, resistance.port_a) annotation (Line(points={{-110,-70},{-110,-56},{-89,-56}}, color={0,127,255}));
  connect(Split.port_1, resistance1.port_a) annotation (Line(points={{-110,-90},{-110,-110},{-89,-110}}, color={0,127,255}));
  connect(resistance.port_b, tube_one.port_a) annotation (Line(points={{-75,-56},{-56,-56},{-56,-80},{-50,-80}}, color={0,127,255}));
  connect(resistance1.port_b, tube_two.port_a) annotation (Line(points={{-75,-110},{16,-110},{16,-80},{22,-80}}, color={0,127,255}));
  connect(tube_one.port_b, Combine.port_1)
    annotation (Line(points={{-30,-80},{-12,-80},{-12,-60},{44,-60},{44,-22},{90,-22},{90,-64}}, color={0,127,255}));
  connect(tube_two.port_b, Combine.port_2) annotation (Line(points={{42,-80},{74,-80},{74,-88},{90,-88},{90,-84}}, color={0,127,255}));
  connect(Combine.port_3, TubeHeOut.ports[1]) annotation (Line(points={{100,-74},{108,-74},{108,-40},{116,-40}}, color={0,127,255}));
  annotation (
