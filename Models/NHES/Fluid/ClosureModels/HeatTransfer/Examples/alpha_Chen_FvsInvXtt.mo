within NHES.Fluid.ClosureModels.HeatTransfer.Examples;
model alpha_Chen_FvsInvXtt
  ...
  parameter SIadd.MassFlux G_start=0 "Total mass flow rate";
  parameter SIadd.MassFlux G_end=5000 "Total mass flow rate";
  parameter SI.Temperature Twall = 400 "Wall temperature";

  SI.SpecificEnthalpy dh "Enthalpy range";
  SI.SpecificEnthalpy h "Enthalpy";
  SIadd.MassFlux G "Total mass flow rate";

  SIadd.nonDim x_th "Thermodynmic quality";
  SIadd.nonDim x_abs "Steam quality (0<x<1)";
