...
function alpha_Chen_TwoPhase "Chen's correlation for two-phase flow in a tube"
...
Saturated fluid properties are based on the bulk fluid temperature and pressure.
  ...
  */
  ...
  input SIadd.nonDim x(min=0.0, max=1.0)
    "Absolute Steam quality";
...
algorithm
  ...
  x_limit := NHES.Math.spliceSigmoid(
            x,
            0.98,
            x,
            0.96);
