within NHES.Nuclear.ReactorKinetics;
model PointKinetics
  ...
  parameter SItf.nonDim[nI] beta_i={0.000169,0.000832,0.00264,0.00122,0.00138,0.000247}
    "Delayed neutron precursor fractions"
     annotation (Dialog(tab="Kinetics", group="Neutron Kinetics Parameters"));
  parameter SItf.inverseTime[nI] lambda_i = {3.87,1.40,0.311,0.115,0.0317,0.0127}
  ...
  parameter SItf.TempFeedbackCoeff alpha_fuel=-2.5e-5
    "Doppler feedback coefficient"
    annotation (Dialog(tab="Kinetics", group="Reactivity Feedback Parameters"));
  parameter SItf.TempFeedbackCoeff alpha_coolant=-20e-5
  ...
  SItf.nonDim Reactivity_Fuel "Fuel reactivity feedback";
  SItf.nonDim Reactivity_Coolant "Coolant reactivity feedback";
  SItf.nonDim Reactivity_Total "Total reactivity feedback";

  SI.Power Q_fission "Total fission power";
  SI.Power Q_decay "Decay heat";

  SItf.nonDim Beta=sum(beta_i) "Sum of delayed neutron precursor fractions";
  SI.Power[nI] C_i(start=C_i_start)
    "Power of the delayed-neutron precursor concentration in group i";

  SItf.nonDim Reactivity_CR "Control rod reactivity";
  SItf.nonDim Reactivity_Other "Alternative Sources of Reactivity";
