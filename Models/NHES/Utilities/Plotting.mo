...
package Plotting "Contains Model scripts to export variables to plot in matlab"
  ...
  input String varOrigNames[:]={"Time","sensorW.W","demand_BOP2.y[1]",
    "intermediate_Rankine_Cycle_TESUC_1_Independent_SmallCycle.sensorW.y","intermediate_Rankine_Cycle_TESUC.sensorW.W",
    ...
    "two_Tank_SHS_System_NTU.hot_tank.T","two_Tank_SHS_System_NTU.cold_tank.T","intermediate_Rankine_Cycle_TESUC.sensor_T1.T","intermediate_Rankine_Cycle_TESUC.sensor_T2.T", "eta_main.y", "eta_dedic.y"} "Variable names/headers in the file in modelica syntax";
    input String varReNames[:]={"Time","Power", "DemandedPower", "TESBOP", "MainBOP","ReactorPower","hotlevel","coldlevel","hotTemp","coldTemp","SGoutTemp","SGinTemp", "MainEff","DedicEff"} "Variable names which will appear in the MAT results file";
