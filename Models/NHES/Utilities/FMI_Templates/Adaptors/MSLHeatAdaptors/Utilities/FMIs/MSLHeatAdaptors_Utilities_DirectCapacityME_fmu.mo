...
model MSLHeatAdaptors_Utilities_DirectCapacityME_fmu
...
public
  ...
  parameter Modelica.Units.SI.HeatCapacity C(min=0.0) = 1 "HeatCapacity";
protected
  record heatCapacitor_rec
    ...
    Modelica.Units.SI.Temperature T(start=_T_start, fixed=true)
...
public
  heatFlowToTemperature_rec heatFlowToTemperature annotation(Dialog);
  ...
  parameter Real _Q_flow_start = 0.0
  annotation (Dialog( group="Start values for inputs "));
  Modelica.Blocks.Interfaces.RealInput Q_flow(unit = "W", start = _Q_flow_start) "Heat flow to the heat capacity"
...
public
  parameter String fmi_instanceName="MSLHeatAdaptors_Utilities_DirectCapacityME_fmu"
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://MSLHeatAdaptors_Utilities_DirectCapacityME_fmu/Resources/Library/FMU/MSLHeatAdaptors_Utilities_DirectCapacityME/resources")
...
package fmi_Functions
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_Instantiate_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
    if (!(res->hInst=LoadLibraryW(L\"MSLHeatAdaptors_Utilities_DirectCapacityME.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (MSLHeatAdaptors_Utilities_DirectCapacityME.dll) failed!\");
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2ModelExchange, \"{7b94ac8d-f2c6-46f7-ae2b-1f2be1651a2e}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="MSLHeatAdaptors_Utilities_DirectCapacityME", LibraryDirectory="modelica://MSLHeatAdaptors_Utilities_DirectCapacityME_fmu/Resources/Library/FMU/MSLHeatAdaptors_Utilities_DirectCapacityME/binaries", __Dymola_CriticalRegion="MSLHeatAdaptors_Utilities_DirectCapacityME");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
        ...
        input fmiModel fmi;
        external"C"
                   MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiFreeModelInstance2(fmi);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_Free_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    input fmiModel fmi;
    input Real ti;
    external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetTime2(fmi, ti);
    annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetTime_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetTime_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetTime2(void*m, double ti) {
  struct dy_fmi2Extended*a=m;
...
#endif", Library="MSLHeatAdaptors_Utilities_DirectCapacityME", LibraryDirectory="modelica://MSLHeatAdaptors_Utilities_DirectCapacityME_fmu/Resources/Library/FMU/MSLHeatAdaptors_Utilities_DirectCapacityME/binaries", __Dymola_CriticalRegion="MSLHeatAdaptors_Utilities_DirectCapacityME",__Dymola_IdemPotent=true);
    end fmiSetTime;

    function fmiSetContinuousStates
    input fmiModel fmi;
    input Real x[:];
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetContinuousStates2(
       fmi,
       x,
       size(x, 1));
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetContinuousStates_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetContinuousStates_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetContinuousStates2(void*m, const double*x, size_t nx) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetContinuousStates failed\");
    ...
    input Real preAvailable;
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetContinuousStates2(
        fmi,
        x,
        nx);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetContinuousStates_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetContinuousStates_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetContinuousStates2(void*m, double*x, int nx) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetContinuousStates failed\");
    ...
    output Real crossing;
      external"C" crossing = MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiCompletedIntegratorStep2(fmi);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_CompletedIntegratorStep_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_CompletedIntegratorStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiCompletedIntegratorStep2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status = fmi2Fatal;
  ...
  return a->dyTriggered && a->dyTime>=a->dyLastTime;
    ...
    external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiEnterModelInitialization2(fmi, startTime);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiEnterModelInitialization_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiEnterModelInitialization_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiEnterModelInitialization2(void*m, double startTime) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"Initialize failed\");
    ...
    external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiExitModelInitializationMode2(fmi);
    annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiExitModelInitializationMode_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    external"C" nextMode = MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiUpdateDiscreteStates2(fmi, tNext, stateValuesChanged);
      annotation(Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_UpdateDiscreteStates_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_UpdateDiscreteStates_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
int MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiUpdateDiscreteStates2(void*m, double* tNext, int* stateValuesChanged){
  struct dy_fmi2Extended*a=m;
  fmi2EventInfo ev;
  fmi2Status status=fmi2Fatal;
  ...
  *stateValuesChanged = ev.valuesOfContinuousStatesChanged;
  return ev.newDiscreteStatesNeeded;
    ...
    input Integer nx;
    output Real dx[nx];
    external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetDerivatives2(
    fmi,
      dx,
      nx);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetDerivatives_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetDerivatives_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetDerivatives2(void*m,double*dx,int nx) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetDerivatives failed\");
    ...
    input Integer nz;
    output Real z[nz];
    external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetEventIndicators2(
      fmi,
      z,
      nz);
    annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetEventIndicators_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetEventIndicators_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetEventIndicators2(void*m,double*z,int nz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
;  }
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetEventIndicators failed\");
    ...
    function fmiReset
      ...
      external"C" resetOK = MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiReset2(fmi);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_Reset_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetReal_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetReal_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
#endif", Library="MSLHeatAdaptors_Utilities_DirectCapacityME", LibraryDirectory="modelica://MSLHeatAdaptors_Utilities_DirectCapacityME_fmu/Resources/Library/FMU/MSLHeatAdaptors_Utilities_DirectCapacityME/binaries", __Dymola_CriticalRegion="MSLHeatAdaptors_Utilities_DirectCapacityME",__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    end fmiSetReal;
...
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetReal failed\");
    ...
    function fmiGetInteger
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetInteger_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetInteger_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetBoolean_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetBoolean_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetString_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetDirectionalDerivative2_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiCheckIfDiscreteValueSet
      input fmiModel fmi;
      output Real DiscreteInputSet;
      external "C" DiscreteInputSet = MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiCheckIfDiscreteValueSet2(fmi);
      annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiCheckIfDiscreteValueSet_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiCheckIfDiscreteValueSet_C 1
#include \"FMI/fmi2Import.h\"
double MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiCheckIfDiscreteValueSet2(void*m) {
  struct dy_fmi2Extended*a=m;
  if (a) {
  ...
  return 0;
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSaveFMUState2(fmi);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSaveFMUState_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiRestoreFMUState2(fmi);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiRestoreFMUState_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSerializeFMUstate2(fmi);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSerializeFMUstate_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiDeSerializeFMUstate2(fmi);
        annotation (Header="
#ifndef MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiDeSerializeFMUstate_C
#define MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void MSLHeatAdaptors_Utilities_DirectCapacityME79482646721216512_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
initial algorithm
  ...
  fmi_Functions.fmiSetReal(fmi, {16777216, 16777217, 16777218}, {C, forceSource.T_ref, forceSource.alpha});
  fmi_Functions.fmiSetReal(fmi, {33554432}, {heatCapacitor._T_start});
  fmi_Functions.fmiSetReal(fmi, {352321536, 352321537}, {_Q_flowDrive_start, _Q_flow_start});
...
equation
  ...
  {heatCapacitor.C} = fmi_Functions.fmiGetRealwf(fmi, {100663296}, fmi_dummy);
  end when;
  myTime = fmi_Functions.setTimeAndStates(fmi, time, {heatCapacitor.T}, fmi_dummy);
  fmi_StepEvent = fmi_Functions.fmiCompletedIntegratorStep(fmi, myTime)>0.5;
  fmi_DiscreteInputChanged= fmi_Functions.CheckIfDiscreteValueSet(fmi, myTime, {Q_flowDrive, Q_flow}, fill(false,0), fill(0,0), {352321536, 352321537}, fill(0,0), fill(0,0), {T, derT}, fill(false,0), fill(0,0))  > 0.5;
  ...
  if initial() then
    der(heatCapacitor.T) = fmi_Functions.GetRealVariable(fmi, myTimeStart, {C, heatCapacitor.T, forceSource.T_ref, forceSource.alpha, Q_flowDrive, Q_flow}, fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), {16777216, 33554432, 16777217, 16777218, 352321536, 352321537}, fill(0,0), fill(0,0), fill(0,0), fill(0,0), {587202560});
  else
    der(heatCapacitor.T) = fmi_Functions.GetRealVariable(fmi, myTime, {Q_flowDrive, Q_flow}, fill(0.0,0), {heatCapacitor.T}, fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), {352321536, 352321537}, fill(0,0), {33554432}, fill(0,0), fill(0,0), {587202560});
  end if;
  if initial() then
    T = fmi_Functions.GetRealVariable(fmi, myTimeStart, {heatCapacitor.T}, fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), {33554432}, fill(0,0), fill(0,0), fill(0,0), fill(0,0), {335544320});
  else
    T = fmi_Functions.GetRealVariable(fmi, myTime, fill(0.0,0), fill(0.0,0), {heatCapacitor.T}, fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), fill(0,0), fill(0,0), {33554432}, fill(0,0), fill(0,0), {335544320});
  end if;
  if initial() then
    derT = fmi_Functions.GetRealVariable(fmi, myTimeStart, {C, heatCapacitor.T, forceSource.T_ref, forceSource.alpha, Q_flowDrive, Q_flow}, fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), {16777216, 33554432, 16777217, 16777218, 352321536, 352321537}, fill(0,0), fill(0,0), fill(0,0), fill(0,0), {335544321});
  else
    derT = fmi_Functions.GetRealVariable(fmi, myTime, {Q_flowDrive, Q_flow}, fill(0.0,0), {heatCapacitor.T}, fill(0.0,0), zeroOffset, fill(false,0), fill(0,0), {352321536, 352321537}, fill(0,0), {33554432}, fill(0,0), fill(0,0), {335544321});
  end if;
{heatCapacitor.der_T, heatCapacitor.port.Q_flow, forceSource.Q_flow, forceSource.port.Q_flow, heatFlowToTemperature.f} = fmi_Functions.fmiGetRealwf(fmi, {587202560, 369098753, 436207616, 369098754, 436207617}, if initial() then myTimeStart else myTime);
//alias Declarations
  ...
  heatFlowToTemperature.heatPort.Q_flow = heatFlowToTemperature.f;
  annotation (__Dymola_FMUImportVersion="Dymola 2021", __Dymola_FMUImportPath="C:/Users/FRICKL/Desktop/TESsystem/MSLHeatAdaptors_Utilities_DirectCapacityME.fmu", __Dymola_FMUImportIncludeAllVariables="true", __Dymola_FMUImportIntegrate="true", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>modelName = MSLHeatAdaptors_Utilities_DirectCapacityME</li>
<li>generationTool = Dymola Version 2021 (64-bit), 2020-05-13</li>
<li>generationDateAndTime = 2020-10-27T03:15:25Z</li>
</ul>
...
end MSLHeatAdaptors_Utilities_DirectCapacityME_fmu;
