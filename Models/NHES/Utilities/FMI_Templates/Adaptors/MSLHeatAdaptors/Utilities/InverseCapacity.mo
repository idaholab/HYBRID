...
model InverseCapacity
  ...
  parameter Modelica.Units.SI.HeatCapacity C(min=0) = 1 "HeatCapacity";
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor mass(C=C, T(start=
          293.15)) annotation (Placement(transformation(extent={{-10,0},{10,20}})));
