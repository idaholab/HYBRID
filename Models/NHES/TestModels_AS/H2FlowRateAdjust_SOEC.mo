...
model H2FlowRateAdjust_SOEC
  ...
  Modelica.Blocks.Sources.Constant CathodeFlowControl2(k=10)         annotation (Placement(transformation(extent={{-112,-40},{-92,-20}})));
  ...
  Modelica.Fluid.Sources.MassFlowSource_T H2_feed(
    ...
    T=414.15)  annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-86,14})));
  NHES.Electrolysis.Separator.Combiner_H2_CathodeGas combiner_FinalV2_1 annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  ...
  Modelica.Fluid.Sensors.MassFlowRate CatGasMassFlow(redeclare package Medium = NHES.Electrolysis.Media.Electrolysis.CathodeGas)
