...
model check_Alphas_TwoPhase_3Region_F1D_condensation
  extends TRANSFORM.Icons.Example;
  package Medium = Modelica.Media.Water.StandardWater;
  parameter Integer nHT=2;
  parameter SI.Pressure p[nHT]={1.2e5,1.2e5};
  ...
  TRANSFORM.Fluid.ClosureRelations.HeatTransfer.Models.DistributedPipe_1D_MultiTransferSurface.Alphas_TwoPhase_3Region_Condensation_AS2022
    heatTransfer(
  ...
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature boundary[nHT,nSurfaces]
...
end check_Alphas_TwoPhase_3Region_F1D_condensation;
