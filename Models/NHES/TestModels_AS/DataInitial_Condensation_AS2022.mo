...
record DataInitial_Condensation_AS2022
...
//STHX.tube
parameter SI.Density d_start_STHX_tube[:] = {0.55296,0.57808,0.60576,0.63646,0.67087,0.70010,954.86,958.36,971.80,983.20};
parameter SI.Pressure p_start_STHX_tube[:] = {120000,120000,120000,120000,120000,120000,120000,120000,120000,120000};
parameter SI.Temperature T_start_STHX_tube[:] = {473.15,453.15,433.15,413.15,393.15,377.93,377.93,373.15,353.15,333.15};
parameter SI.SpecificEnthalpy h_start_STHX_tube[:] = {2874500,2834900,2795100,2755100,2714600,2683100,1561230,439360,419180,251260};
...
end DataInitial_Condensation_AS2022;
