...
block RealExpression_Vector "Set output signal to a time varying Real expression"

  Modelica.Blocks.Interfaces.RealOutput y[:]={0.0,0.0} "Value of Real output"
