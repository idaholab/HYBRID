...
model IdealCondenser_AS2022 "Ideal condenser with fixed pressure"
  ...
  TRANSFORM.Fluid.Interfaces.FluidPort_State port_a(redeclare package Medium = Medium) "Steam port"
    annotation (Placement(transformation(extent={{-90,80},{-50,120}}, rotation=0), iconTransformation(extent={{-80,60},{-60,80}})));
  TRANSFORM.Fluid.Interfaces.FluidPort_State port_b(redeclare package Medium = Medium) "Condensed liquid port"
    annotation (Placement(transformation(extent={{-20,-120},{20,-80}}, rotation=0), iconTransformation(extent={{-10,-90},{10,-70}})));
  /* Parameters */
  ...
  TRANSFORM.HeatAndMassTransfer.Interfaces.HeatPort_Flow HeatPort annotation (Placement(transformation(extent={{86,-10},{106,10}})));
initial equation
