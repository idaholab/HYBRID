...
model SwitchYard_vessel
  import      Modelica.Units.SI;

  SI.Power totalLoad_elecHeaters;
  SI.Power powerConsumption_SOEC(start=45.53125e6, min = 16.596350e6, max=45.53125e6*1.05);
  ...
  Electrolysis.Interfaces.ElectricalPowerPort_b load_catElecHeater
    annotation (Placement(transformation(extent={{-90,70},{-70,90}})));
  Electrolysis.Interfaces.ElectricalPowerPort_b load_anElecHeater
...
equation
  ...
  connect(load_catElecHeater, catElec_sink.port_a) annotation (Line(
