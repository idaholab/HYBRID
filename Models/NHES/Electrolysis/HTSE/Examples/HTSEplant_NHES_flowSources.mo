...
model HTSEplant_NHES_flowSources
  ...
  Modelica.Blocks.Continuous.FirstOrder actuator_TNOut_cathodeGas(
    k=1,
    y_start=hEX_nuclearHeatCathodeGasRecup_ROM.wShell_start,
    initType=Modelica.Blocks.Types.Init.SteadyState,
    T=4)                                                     annotation (
  ...
  Modelica.Fluid.Sources.MassFlowSource_T steamNukeFeed_anodeGas(
    ...
    use_m_flow_in=true,
    T=574.698)
              annotation (Placement(transformation(extent={{-128,-90},{
            -108,-70}})));
  ...
  Modelica.Blocks.Continuous.PI FBctrl_TNOut_cathodeGas(
    y_start=hEX_nuclearHeatCathodeGasRecup_ROM.wShell_start,
    y(start=hEX_nuclearHeatCathodeGasRecup_ROM.wShell_start),
    x_start=hEX_nuclearHeatCathodeGasRecup_ROM.wShell_start/
        FBctrl_TNOut_cathodeGas.k,
    initType=Modelica.Blocks.Types.Init.SteadyState,
...
equation
  ...
  connect(feedCathodeGas.ports[1], hEX_nuclearHeatCathodeGasRecup_ROM.tube_in)
    annotation (Line(points={{-92,54},{-78,54}}, color={0,127,255}));
  connect(steamNukeFeed_cathodeGas.ports[1],
    hEX_nuclearHeatCathodeGasRecup_ROM.shell_in) annotation (Line(points={{-108,84},
          {-70,84},{-70,62}},     color={0,127,255}));
  connect(actuator_TNOut_cathodeGas.y, steamNukeFeed_cathodeGas.m_flow_in)
    annotation (Line(points={{-130.8,120},{-140,120},{-140,92},{-128,92}},
        color={0,0,127}));
  ...
  connect(feedAnodeGas.ports[1],hEX_nuclearHeatAnodeGasRecup_ROM. tube_in)
    annotation (Line(points={{-92,-52},{-85,-52},{-78,-52}},
                                                       color={0,127,255}));
  connect(hEX_nuclearHeatAnodeGasRecup_ROM.shell_in,steamNukeFeed_anodeGas.
                           ports[1]) annotation (Line(points={{-70,-60},{
          -70,-80},{-108,-80}},
                              color={0,127,255}));
  connect(actuator_TNOut_anodeGas.y,steamNukeFeed_anodeGas. m_flow_in)
    annotation (Line(points={{-100.8,-110},{-140,-110},{-140,-72},{-128,
          -72}},
        color={0,0,127}));
  ...
  connect(actuator_TNOut_anodeGas.u, FBctrl_TNOut_anodeGas.y) annotation (
     Line(points={{-82.4,-110},{-56.8,-110}}, color={0,0,127}));
  connect(power_set.y, prescribedPowerFlow.P_flow) annotation (Line(
        points={{40.8,110},{50,110},{62,110}},
                                             color={0,0,127}));
...
end HTSEplant_NHES_flowSources;
