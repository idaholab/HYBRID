...
model SteamSplit_test_sourcePressure_sinkPressure_closeLoop
...
equation
  ...
  connect(steamNukeSink.ports[1], flowJoin.port_2)
    annotation (Line(points={{60,4},{50,4},{40,4}},
                                             color={0,127,255}));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            ...
            {120,120}})));
end SteamSplit_test_sourcePressure_sinkPressure_closeLoop;
