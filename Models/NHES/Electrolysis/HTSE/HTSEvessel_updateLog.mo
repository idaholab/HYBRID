...
model HTSEvessel_updateLog "HTSE vessel"
  ...
  parameter Real capacityScaler=1
    "Scaler that sizes the capacity of the overall system";
  ...
  Modelica.Blocks.Interfaces.RealOutput c_wAnode annotation (Placement(
        ...
        rotation=90,
        origin={30,-104})));
  Electrolysis.Electrical.SwitchYard_vessel SY_vessel(
      powerConsumption_SOEC(fixed=true))
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  Sensors.PowerSensorScalable      W_SOEC(capacityScaler=capacityScaler)
  ...
  Electrolyzers.ControlledSOEC_integratedWithHTSEplant_updateLogTerm_FY17
    controlledSOEC(
  ...
  Electrolysis.HeatExchangers.HEX_cathodeGasRecupVessel_ROM
    ...
    initOpt=Electrolysis.Utilities.OptionsInit.noInit)
...
equation
  ...
  connect(controlledSOEC.ctrlElectricalLoad, W_SOEC.port_b) annotation (
      Line(
      points={{57.84,0.4},{40,0.4},{40,-0.16}},
      color={255,0,0},
      thickness=0.5));
