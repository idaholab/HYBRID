...
equation
  ...
  connect(temperature.T, H2_feed.T_in)
    annotation (Line(points={{-3,10},{6,10},{6,60}}, color={0,0,127}));
  ...
  connect(vaporOutlet, H2_feed.ports[1])
    annotation (Line(points={{0,90},{0,82},{2.5,82}},
                                             color={0,127,255}));
  connect(H2_feed.m_flow_in, mH2_sep_out.y) annotation (Line(points={{10,62},{10,54},{17,54},{17,50.9}},
                                     color={0,0,127}));
  ...
  connect(vaporOutlet, H2_feed.ports[2]) annotation (Line(points={{0,90},{0,86},{1.5,86},{1.5,82}}, color={0,127,255}));
