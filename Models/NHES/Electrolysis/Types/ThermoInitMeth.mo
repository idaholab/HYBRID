...
type ThermoInitMeth = enumeration(
    ...
    MassFraction "Initialize the mass fraction.",
    PressureSS "Initialize w/ steady-state pressure.",
    TemperatureSS "Initialize w/ steady-state temperature.",
    SpecificEnthalpySS "Initialize w/ steady-state specific enthalpy.",
    MassFractionSS "Initialize w/ steady-state mass fraction.")
