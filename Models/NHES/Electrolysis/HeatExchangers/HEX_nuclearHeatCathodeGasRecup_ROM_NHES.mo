...
model HEX_nuclearHeatCathodeGasRecup_ROM_NHES
  ...
  parameter SI.ThermalConductance AhTube = 236916
    "Thermal conductance in tube side [W/K]";
  parameter SI.ThermalConductance AhShell = 236916
  ...
  parameter SI.Pressure pShell_in_start = 4.40804*1e6
  ...
  parameter SI.Temperature TShell_in_start = 302.241 + 273.15
  ...
  parameter SI.Temperature TShell_out_start = 224.02 + 273.15
  ...
  parameter SI.MassFlowRate wTube_start = 4.48466
    "Start value of mass flow rate of the medium in tube side [kg/s]"
    annotation (Dialog(tab="Initialisation"));
  parameter SI.MassFlowRate wShell_start = 6.47973
  ...
  SI.Temperature TTube_in(min=273.15,nominal=298.15,start=TTube_in_start)
  ...
  SI.Temperature TShell_in(min=273.15+283.4,nominal=575.391,start=TShell_in_start)
  ...
  SI.Temperature TTube_mean(min=273.15,nominal=427.35,start = TTube_mean_start)
    "Average temperature in tube side [K]";
  SI.Temperature TShell_mean(min=273.15,nominal=536.2705,start = TShell_mean_start)
...
end HEX_nuclearHeatCathodeGasRecup_ROM_NHES;
