...
model HEX_anodeGasRecup_ROM_nom_NHES
  "Nominal condition for heat recuperation via anode gas"
...
equation
  ...
  TTube_in = 273.15 + 25;
  TShell_in = 273.15 + 749.492;

  QTube_gained = 1.2156e7;
  ...
  0 = (wTube_in*hTube_in - wTube_out*hTube_out) + (wShell_in*hShell_in - wShell_out*hShell_out);
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Line(
          ...
          origin={0,0},
          rotation=90)}));
end HEX_anodeGasRecup_ROM_nom_NHES;
