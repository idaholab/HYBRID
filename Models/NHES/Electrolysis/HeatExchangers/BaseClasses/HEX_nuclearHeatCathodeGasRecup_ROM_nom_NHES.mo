...
model HEX_nuclearHeatCathodeGasRecup_ROM_nom_NHES
...
equation
  ...
  pTube_in = 2.142991584168141e6 "[Pa]";
  ...
  0 = (wTube_in*hTube_in - wTube_out*hTube_out) + (wShell_in*hShell_in - wShell_out*hShell_out);
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Line(
          ...
          origin={0,0},
          rotation=90)}));
end HEX_nuclearHeatCathodeGasRecup_ROM_nom_NHES;
