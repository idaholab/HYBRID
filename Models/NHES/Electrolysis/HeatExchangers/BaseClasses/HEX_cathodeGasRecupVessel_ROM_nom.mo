...
model HEX_cathodeGasRecupVessel_ROM_nom
  ...
  final parameter SI.MoleFraction yTube_start[:]={yH2Tube_start,1 -
      yH2Tube_start}
    "Start value of mole fractions in tube side {H2, H2O}";
  ...
  final parameter SI.MassFraction XShell_start[:]=
      ...
      mwH2O*1000})
    "Start value of mass fractions in shell side {H2, H2O}";
  ...
  0 = (wTube_in*hTube_in - wTube_out*hTube_out) + (wShell_in*hShell_in - wShell_out*hShell_out);
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Line(
          ...
          origin={0,0},
          rotation=90)}));
end HEX_cathodeGasRecupVessel_ROM_nom;
