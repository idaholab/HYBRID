...
model HEX_nuclearHeatAnodeGasRecupVessel_ROM_nom_NHES
...
equation
  ...
  pTube_in = 23.7020628982604*1e5 "[Pa]";
  //pShell_in = 4.35*1e6 "[Pa]";
  pShell_out = 51.3042*1e5 "[Pa]";
  ...
  TTube_in = 273.15 + 188.778;
  TShell_in = 273.15 + 310.79;
  ...
  0 = (wTube_in*hTube_in - wTube_out*hTube_out) + (wShell_in*hShell_in - wShell_out*hShell_out);
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Line(
          ...
          origin={0,0},
          rotation=90)}));
end HEX_nuclearHeatAnodeGasRecupVessel_ROM_nom_NHES;
