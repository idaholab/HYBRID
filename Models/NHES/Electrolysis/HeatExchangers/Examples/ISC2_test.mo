...
model ISC2_test
  ...
  Modelica.Fluid.Sources.MassFlowSource_T feed_chilledWater2(
  ...
  Modelica.Blocks.Sources.Ramp chilledWaterFeed_signal2(
    duration=0,
    startTime=200,
    height=-2*0,
    offset=44.581)
        ...
        origin={-70,50})));
equation
  connect(hEX_interStageCooler2_ROM.shell_in,feed_chilledWater2. ports[1])
  ...
  connect(feed_chilledWater2.m_flow_in,chilledWaterFeed_signal2. y)
