...
model ISC_anodeGas1 "Reduced order model (ROM) for the inter-stage cooler1"
  ...
  parameter SI.ThermalConductance AhTube = 33765.5
    "Thermal conductance in tube side [W/K]";
  parameter SI.ThermalConductance AhShell = 589508
  ...
  parameter Electrolysis.Types.HydraulicConductanceSquared coeff_dpShell=81.6321
    "Coefficient for the pressure drop in shell side [Pa.s2/(kg2)]";
  parameter SI.Pressure pTube_in_start = 3.08620402069623*1e5
  ...
  parameter SI.Temperature TTube_in_start = 139.671 + 273.15
...
/*      
  ...
  parameter SI.MassFlowRate wTube_start = 23.2785
    ...
    annotation (Dialog(tab="Initialisation"));
  parameter SI.MassFlowRate wShell_start = 31.3051
  ...
  SI.Temperature TTube_in(min=273.15,nominal=412.821,start=TTube_in_start)
  ...
  SI.Temperature TTube_mean(min=273.15,nominal=362.9855,start = TTube_mean_start)
