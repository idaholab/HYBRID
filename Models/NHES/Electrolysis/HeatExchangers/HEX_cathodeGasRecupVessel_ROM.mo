...
model HEX_cathodeGasRecupVessel_ROM
  "Reduced order model (ROM) for heat recuperation via cathode gas (within the vessel)"
  ...
  parameter SI.ThermalConductance AhTube = 75919.3
    "Thermal conductance in tube side [W/K]";
  parameter SI.ThermalConductance AhShell = 75919.3
  ...
  parameter SI.Temperature TTube_out_start = 626.584 + 273.15
  ...
  final parameter SI.MoleFraction yShell_start[:]={yH2Shell_start,1 -
      yH2Shell_start}
    "Start value of mole fractions in shell side {H2, H2O}";
...
/*
  ...
  parameter SI.MassFlowRate wTube_start = 4.540415
  ...
  elseif initOpt == Electrolysis.Utilities.OptionsInit.steadyState then
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
        ...
        Line(
          ...
          origin={0,0},
          rotation=90)}));
end HEX_cathodeGasRecupVessel_ROM;
