...
model HEX_anodeGasRecupVessel_ROM_NHES
  ...
  parameter SI.ThermalConductance AhTube = 548239
    "Thermal conductance in tube side [W/K]";
  parameter SI.ThermalConductance AhShell = 548239
...
//    "Start value of outlet temperature in shell side [K]" annotation (Dialog(tab="Initialisation"));
  parameter SI.Temperature TShell_out_start = 332.691 + 273.15
    "Start value of outlet temperature in shell side [K]" annotation (Dialog(tab="Initialisation"));
  ...
  parameter SI.MoleFraction yO2Tube_start = 0.21
    ...
    annotation (Dialog(tab="Initialisation"));
  parameter SI.MoleFraction yO2Shell_start = 0.296783
  ...
  parameter SI.MassFlowRate wTube_start = 23.27855
    "Start value of mass flow rate of the medium in tube side [kg/s]"
    annotation (Dialog(tab="Initialisation"));
  parameter SI.MassFlowRate wShell_start = 26.464815
  ...
  SI.Temperature TShell_out(min=273.15, nominal = 605.841, start=TShell_out_start)
  ...
  SI.Temperature TShell_mean(min=273.15, nominal = 814.2415, start = TShell_mean_start)
  ...
  elseif initOpt == Electrolysis.Utilities.OptionsInit.steadyState then
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
        ...
        Line(
          ...
          origin={0,0},
          rotation=90)}));
end HEX_anodeGasRecupVessel_ROM_NHES;
