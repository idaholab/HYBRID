...
model Model9_2
  ...
  Separator.Temp_flashDrumVessel
                           temp_flashDrumVessel(redeclare package Medium = Media.Electrolysis.CathodeGas)
  ...
  Modelica.Fluid.Sources.Boundary_pT Sink_H2(
    ...
    T=313.15,
    nPorts=1) annotation (Placement(transformation(extent={{-246,140},{-226,160}})));
  Modelica.Fluid.Sources.Boundary_pT Sink_H2O(
    redeclare package Medium = Media.Electrolysis.CathodeGas,
    p(displayUnit="Pa") = 103299.8,
    T=313.15,
    nPorts=1) annotation (Placement(transformation(extent={{-254,-40},{-234,-20}})));
equation
  ...
  connect(FuelHXOutTemp.port_b, temp_flashDrumVessel.feedInlet)
    annotation (Line(points={{-64,86},{-174,86},{-174,70},{-182,70}}, color={0,127,255}));
  connect(Sink_H2.ports[1], temp_flashDrumVessel.vaporOutlet) annotation (Line(points={{-226,150},{-190,150},{-190,79}}, color={0,127,255}));
  connect(temp_flashDrumVessel.liquidOutlet, Sink_H2O.ports[1]) annotation (Line(points={{-190,61},{-190,-30},{-234,-30}}, color={0,127,255}));
