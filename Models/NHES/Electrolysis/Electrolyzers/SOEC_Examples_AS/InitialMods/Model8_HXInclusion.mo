...
model Model8_HXInclusion
  ...
  Modelica.Fluid.Sources.Boundary_pT cathodeSink1(
    ...
    T=423.65,
    nPorts=1)
    annotation (Placement(transformation(extent={{-110,106},{-90,126}})));
...
equation
  ...
  connect(FuelHXOutTemp.port_b, cathodeSink1.ports[1]) annotation (Line(points={{-64,86},{-80,86},{-80,116},{-90,116}}, color={0,127,255}));
