...
model SOEC_AS2022_OxV1 "Solid Oxide Electrolysis Cell (SOEC) stack model"
  ...
  parameter SI.Length Wcell = 0.12 "Stack cell width [m]" annotation (Dialog(group="SOEC stack"));
  parameter SI.Length Lcell = 0.12 "Stack cell length [m]" annotation (Dialog(group="SOEC stack"));
  ...
  parameter SI.MassFlowRate wstartCathodeIn = 0.00908085
  ...
  parameter SI.MassFlowRate wstartCathodeOut = 0.270831
    ...
    annotation (Dialog(tab="Initialisation"));
  parameter SI.MassFlowRate wstartAnodeIn = 0.0465587
...
equation
  ...
  Integral_y_H2_1 = (-(1 - yH2_cathodeOut)*log(1 - yH2_cathodeOut) - yH2_cathodeOut) - (-(1 - yH2_cathodeIn)*log(1 - yH2_cathodeIn) - yH2_cathodeIn); //this is integral of ln(1-yH2)dyH2 with limits of cathodeOut and cathodeIn. The additional negative sign comes from equation 32 of Dominion report

  Integral_y_H2_2 = (yH2_cathodeOut*log(yH2_cathodeOut) - yH2_cathodeOut) - (yH2_cathodeIn*log(yH2_cathodeIn) - yH2_cathodeIn); //this is integral of ln(yH2)dyH2 with limits of cathodeOut and cathodeIn. Refer to equaitons 32 and 33 from Dominion report.

  Integral_ya = (yaOut*log(yaOut) - yaOut) - (yaIn*log(yaIn) - yaIn); //This is the O2 term from Dominion report equation 38 without the dyH2/2 term. It is included in the next equation
