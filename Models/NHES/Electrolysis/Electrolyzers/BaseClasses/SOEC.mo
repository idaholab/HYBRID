...
model SOEC "Solid Oxide Electrolysis Cell (SOEC) stack model"
...
equation
  ...
  Integral_y_H2_1 = (-(1 - yH2_cathodeOut)*log(1 - yH2_cathodeOut) -
    yH2_cathodeOut) - (-(1 - yH2_cathodeIn)*log(1 - yH2_cathodeIn) -
    yH2_cathodeIn);
  Integral_y_H2_2 = (yH2_cathodeOut*log(yH2_cathodeOut) - yH2_cathodeOut) - (
    yH2_cathodeIn*log(yH2_cathodeIn) - yH2_cathodeIn);
  Integral_ya = (yaOut*log(yaOut) - yaOut) - (yaIn*log(yaIn) - yaIn);
