...
model ControlledSOEC_integratedWithHTSEplant_updateLogTerm_FY17
  ...
  parameter Modelica.Units.SI.Time
                    FBctrl_SUfactor_T(start=1) = 1.168021981 "Time constant"  annotation (Dialog(tab="General", group="SU factor controller"));
  parameter Real FBctrl_TC_out_k(unit="1") = (1/36.8)*4 "Gain"  annotation (Dialog(tab="General", group="TC_out controller"));
  parameter Modelica.Units.SI.Time
                    FBctrl_TC_out_T(start=1) = 228 "Time constant"  annotation (Dialog(tab="General", group="TC_out controller"));
  parameter Real FBctrl_pCathode_k(unit="1") = (1/277000)*5 "Gain" annotation (Dialog(tab="General", group="pCathode controller"));
  parameter Modelica.Units.SI.Time
                    FBctrl_pCathode_T(start=1) = 2.028030065 "Time constant"  annotation (Dialog(tab="General", group="pCathode controller"));
  parameter Real FBctrl_pAnode_k(unit="1") = 0.000010539629 "Gain" annotation (Dialog(tab="General", group="pAnode controller"));
  parameter Modelica.Units.SI.Time
                    FBctrl_pAnode_T(start=1) = 3.44 "Time constant"  annotation (Dialog(tab="General", group="pAnode controller"));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Line(
          ...
          color={0,0,0},
          arrow={Arrow.Open,Arrow.None})}));
end ControlledSOEC_integratedWithHTSEplant_updateLogTerm_FY17;
