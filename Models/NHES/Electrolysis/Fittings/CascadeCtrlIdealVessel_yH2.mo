...
model CascadeCtrlIdealVessel_yH2 "Joins two gas flows"
  ...
  parameter SI.AbsolutePressure pSteam_start = 2.272222*1e6
...
//    annotation (Dialog(tab="Initialization"));
  parameter SI.MassFlowRate wH2_start = 0.0557585664075
  ...
  Electrolysis.Fittings.BaseClasses.TeeJunction mixer_H2Recycled(
    ...
    V=V,
    yH2_start=yH2_set.k,
    p_start=mediumConverter.p_start,
    T_start=mediumConverter.T_start)
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
          ...
          fillPattern=FillPattern.Solid),
                   Text(extent={{-92,-66},{112,-108}}, textString="%name",lineColor={0,0,255})}),
    experiment(StopTime=360, Interval=0.1));
end CascadeCtrlIdealVessel_yH2;
