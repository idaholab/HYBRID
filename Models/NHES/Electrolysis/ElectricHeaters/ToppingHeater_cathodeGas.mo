...
model ToppingHeater_cathodeGas "Electrical topping heater"
  ...
  Modelica.Electrical.Analog.Basic.Resistor heatingResistor(
    ...
    alpha=0.00017,
    T_ref=293.15,
    i(start=i_start)) annotation (Placement(transformation(
        origin={-40,48},
        extent={{-10,10},{10,-10}},
        rotation=180)));
  Modelica.Electrical.Analog.Sources.SignalCurrent signalCurrent
    annotation (Placement(transformation(extent={{-50,64},{-30,84}})));
  HeatedPipe_cathodeGas heatedPipe(
  ...
  Modelica.Blocks.Sources.Constant thermalConductance(k=Gc)
    annotation (Placement(transformation(extent={{20,-20},{0,0}},
          rotation=0)));
  parameter Modelica.Units.SI.Current i_start=381.231 "Start value of current"
  ...
  parameter Modelica.Units.SI.Temperature T_in_start=626.583 + 273.15
  ...
  parameter Modelica.Units.SI.MoleFraction yH2_start=0.1
    ...
    annotation (Dialog(tab="Initialisation", group="Heated pipe"));
  parameter Modelica.Units.SI.MassFlowRate w_start=0.908085*5
