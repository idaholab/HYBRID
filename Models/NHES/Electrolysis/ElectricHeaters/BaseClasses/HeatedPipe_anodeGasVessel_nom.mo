...
model HeatedPipe_anodeGasVessel_nom
  "Nominal condition for a pipe with heat exchange carrying anode gas (within the vessel)"
  ...
  0 = (w_in*h_in - w_out*h_out) + Q_flow;
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Line(
          ...
          smooth=Smooth.None,
          visible=showDesignFlowDirection)}));
end HeatedPipe_anodeGasVessel_nom;
