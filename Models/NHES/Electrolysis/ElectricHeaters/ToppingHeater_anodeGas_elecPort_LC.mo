...
model ToppingHeater_anodeGas_elecPort_LC "Electrical topping heater"
  ...
  Modelica.Blocks.Sources.Constant thermalConductance(k=Gc)
    annotation (Placement(transformation(extent={{20,-20},{0,0}},
          rotation=0)));
  parameter Modelica.Units.SI.Current i_start=712.378 "Start value of current"
    annotation (Dialog(tab="Initialisation", group="Resistive heating coil"));

  parameter Modelica.Units.SI.Mass m_resistor=371.23*(50032.3/46088)
    "Mass of a resistor"
  ...
  parameter Modelica.Units.SI.Temperature T_in_start=522.254 + 273.15
  ...
  parameter Modelica.Units.SI.MoleFraction yO2_start=0.21
    ...
    annotation (Dialog(tab="Initialisation", group="Heated pipe"));
  parameter Modelica.Units.SI.MassFlowRate w_start=23.2785
    "Start value of mass flow rate [kg/s]"
    annotation (Dialog(tab="Initialisation", group="Heated pipe"));
  parameter Real Gc( unit="W/K")= 50032.3 "Convective thermal conductance [W/K]";
  ...
  parameter Modelica.Blocks.Types.Init initType=Modelica.Blocks.Types.Init.NoInit
    "Type of initialization for TA_in control (1: no init, 2: steady state, 3: initial state, 4: initial output)" annotation (Dialog(tab="Initialisation"));
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
        ...
        Line(
          ...
          color={0,0,255},
          thickness=0.5)}));
end ToppingHeater_anodeGas_elecPort_LC;
