...
model HeatedPipe_cathodeGasVessel "Pipe with heat exchange"
...
//    annotation(Dialog(tab="General", group="Geometry", enable=not isCircular));
  ...
  parameter SI.ThermalConductance Ah = 20469.9 "Thermal conductance [W/K]";
  ...
  parameter SI.Temperature T_in_start = 626.584 + 273.15
...
end HeatedPipe_cathodeGasVessel;
