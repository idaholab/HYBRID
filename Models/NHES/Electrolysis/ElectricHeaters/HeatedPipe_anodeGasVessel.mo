...
model HeatedPipe_anodeGasVessel "Pipe with heat exchange"
...
//    annotation(Dialog(tab="General", group="Geometry", enable=not isCircular));
  ...
  parameter SI.ThermalConductance Ah = 46086.4 "Thermal conductance [W/K]";
  ...
  parameter SI.MoleFraction yO2_start = 0.21
    "Start value of O2 mole fraction"
  ...
  parameter SI.MassFlowRate w_start= 23.27855
  ...
  SI.Temperature T_out(min=273.15,start=T_out_start)
