...
model ToppingHeater_anodeGasVessel_elecPort "Electrical topping heater"
  ...
  parameter Modelica.Units.SI.Current i_start=426.799 "Start value of current"
  ...
  parameter Modelica.Units.SI.MoleFraction yO2_start=0.21
    ...
    annotation (Dialog(tab="Initialisation", group="Heated pipe"));
  parameter Modelica.Units.SI.MassFlowRate w_start=23.27855
    "Start value of mass flow rate [kg/s]"
    annotation (Dialog(tab="Initialisation", group="Heated pipe"));
  parameter Real Gc( unit="W/K")= 46086.4
  ...
  HeatedPipe_anodeGasVessel heatedPipe(
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection convection
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-40,-10})));
  Modelica.Blocks.Sources.Constant TA_in_set(k=TA_set, y(displayUnit="degC",
...
equation
  ...
  connect(loadElecHeater, loadElecHeater) annotation (Line(points={{0,-100},
          {0,-100}},          color={0,127,255}));
  connect(load_elecHeater.load, loadElecHeater)
    annotation (Line(points={{0,-80},{0,-90},{0,-100}}, color={255,0,0}));
  connect(load_elecHeaterSingal.y, load_elecHeater.powerConsumption)
    annotation (Line(points={{19,-72},{3,-72}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
        ...
        Line(
          ...
          color={0,0,255},
          thickness=0.5)}));
end ToppingHeater_anodeGasVessel_elecPort;
