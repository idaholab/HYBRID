...
equation
  ...
  connect(ISC_2nd.shell_in, TCV_ISC_2nd.port_b)
    annotation (Line(points={{20,8},{20,40}},         color={0,127,255}));
  ...
  connect(FBctrl_pout.u, pout_pu.y)
    annotation (Line(points={{-38,-80},{-38,-80},{-20.6,-80}},
     ...
     connect(TCV_ISC_1st_signal.y, TCV_ISC_1st.opening)
       annotation (Line(points={{-79,50},{-62,50}}, color={0,0,127}));
     connect(TCV_ISC_2nd.opening, TCV_ISC_2nd_signal.y)
       annotation (Line(points={{28,50},{45,50}}, color={0,0,127}));
     connect(source_chilledWater.ports[1], flowSplit.port_2)
       annotation (Line(points={{-80,90},{-64,90}}, color={0,127,255}));
     connect(flowSplit.port_3, TCV_ISC_1st.port_a) annotation (Line(points={{
             -54,80},{-54,70},{-54,60}}, color={0,127,255}));
     connect(flowSplit.port_1, TCV_ISC_2nd.port_a) annotation (Line(points={{
             -44,90},{20,90},{20,60}}, color={0,127,255}));
