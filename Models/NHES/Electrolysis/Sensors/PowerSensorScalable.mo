...
model PowerSensorScalable "Measures power flow through the component"
  parameter Real capacityScaler = 1 "Scaler that sizes the capacity of the overall system";

  Interfaces.ElectricalPowerPort_a port_a annotation (Placement(transformation(
