...
model PumpControlledFlow "This pump ideally controls the discharge pressure."
...
equation
  ...
  connect(port_a, pump.port_a)
    annotation (Line(points={{-100,0},{-40,0},{20,0}}, color={0,127,255}));
