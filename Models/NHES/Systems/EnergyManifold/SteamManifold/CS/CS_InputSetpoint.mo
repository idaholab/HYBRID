...
equation
  ...
  connect(TDV_openingNominal.y, TDV_opening.u2) annotation (Line(points={{-121,10},
  ...
  connect(BPDV_openingNominal.y, switch_BPDV.u3)
    annotation (Line(points={{-105,-50},{118,-50}},         color={0,0,127}));
  ...
  connect(sensorBus.h_toIP, h_to_IP.u) annotation (Line(
      points={{-29.9,-99.9},{-30,-99.9},{-30,-100},{-180,-100},{-180,-36},{-172,
          -36}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.p_toIP, p_to_IP.u) annotation (Line(
      points={{-29.9,-99.9},{-29.9,-100},{-180,-100},{-180,-22},{-172,-22}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.m_flow_toIP, m_flow_to_IP.u) annotation (Line(
      points={{-29.9,-99.9},{-30,-99.9},{-30,-100},{-180,-100},{-180,-8},{-172,
          -8}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.W_signal, switch_W_setpoint.u1) annotation (Line(
      points={{-30,-100},{-180,-100},{-180,86},{-112,86},{-112,58},{-102,58}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.W_setpoint, switch_W_setpoint.u3) annotation (Line(
      points={{-30,-100},{-180,-100},{-180,86},{-112,86},{-112,42},{-102,42}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.W_setpoint, W_normal_gain_setpoint.u) annotation (Line(
      points={{-30,-100},{-180,-100},{-180,86},{-112,86},{-112,80},{-62,80}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
