within NHES.Systems.EnergyManifold.SteamManifold.Components;
model SteamManifold
  extends BaseClasses.Partial_SubSystem_A(
    redeclare replaceable NHES.Systems.EnergyManifold.SteamManifold.CS.CS_Dummy
      CS,
    port_a1_nominal(
      p=5.8e6,
      T=591,
  ...
  Modelica.Blocks.Sources.RealExpression W_total_setpoint_signal
    annotation (Placement(transformation(extent={{-116,98},{-96,118}})));
  Modelica.Blocks.Sources.RealExpression w_total_signal
...
equation
  ...
  connect(pipe_From_PHS.port_b, splitter.ports[1]) annotation (Line(points={{-60,40},
          {-44,40},{-40.3333,40},{-40.3333,50}},         color={0,127,255}));
  ...
  connect(massFlowRate_From_BOP1.port_a, mixer.ports[1]) annotation (Line(
        points={{-18,-30},{-18,-26},{-11.5,-26},{-11.5,-20}},
                                                          color={0,127,255}));
  connect(massFlowRate_From_IP.port_b, mixer.ports[2]) annotation (Line(points={{-10,-46},
          {-10,-20},{-10.5,-20}},          color={0,127,255}));
  connect(massFlowRate_From_BOP.port_b, mixer.ports[3]) annotation (Line(points={{
          4.44089e-16,-30},{4.44089e-16,-26},{-9.5,-26},{-9.5,-20}},color={0,
          127,255}));
  ...
  connect(TDV.port_a, splitter.ports[3]) annotation (Line(points={{20,40},{
          -37.6667,40},{-37.6667,50}}, color={0,127,255}));
  ...
  connect(sensorBus.W_setpoint, W_total_setpoint_signal.y) annotation (Line(
      points={{-30,100},{-92,100},{-92,108},{-95,108}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.W_signal, w_total_signal.y) annotation (Line(
      points={{-30,100},{-92,100},{-92,94},{-95,94}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  annotation (
