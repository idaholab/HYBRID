...
model SteamManifold_L1_FWH_Cond
  ...
  extends BaseClasses.Partial_SubSystem_B(
    redeclare replaceable NHES.Systems.EnergyManifold.SteamManifold.CS.CS_Dummy
      CS(nPorts_a3=nPorts_a3, nPorts_b3=nPorts_b3),
  ...
  Modelica.Blocks.Sources.RealExpression W_total_setpoint_signal
    annotation (Placement(transformation(extent={{-82,96},{-62,116}})));
...
for i in 1:nPorts_a3 loop
  ...
  connect(condenserSmall.port_b, multiPort.ports_b[1]) annotation (Line(points={{0,-48},
          {0,-54},{-12,-54},{-12,-8},{-29,-8},{-29,-16}},              color={0,
          127,255}));
  connect(moistureSeperator.port_Liquid, multiPort.ports_b[2]) annotation (Line(
        points={{44,-44},{44,-56},{-16,-56},{-16,-12},{-31,-12},{-31,-16}},
        color={0,127,255}));
  ...
  connect(sensorBus.W_setpoint, W_total_setpoint_signal.y) annotation (Line(
      points={{-30,100},{-56,100},{-56,106},{-61,106}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.W_signal, w_total_signal.y) annotation (Line(
      points={{-30,100},{-56,100},{-56,92},{-61,92}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  annotation (
