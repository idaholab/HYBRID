...
<p><br>The model backbone is the Schumann equations with additional terms incorporated for thermal conduction when in standby mode. </p>
  ...
  model Thermocline_fluidprops_heaters_newHC
...
<p><br>The model backbone is the Schumann equations with additional terms incorporated for thermal conduction when in standby mode. </p>
  ...
  end Thermocline_fluidprops_heaters_newHC;
...
Thermocline System"),
  ...
  model Thermocline_fluidprops_heaters_newHC_70C
    "Base Thermocline Using the new updated heat transfer correlation to allow for stagnant flow conditions"
    import TRANSFORM;
...
<p><br>The model backbone is the Schumann equations with additional terms incorporated for thermal conduction when in standby mode. </p>
  ...
  end Thermocline_fluidprops_heaters_newHC_70C;

  model Thermocline_Insulation_test_porosity
...
Thermocline System"),
      ...
      experiment(
        ...
        Interval=10.000008,
        __Dymola_Algorithm="Esdirk45a"));
  end Thermocline_Insulation_test_porosity;

  model Thermocline_fluidprops_heaters_newHC_20C
    "Base Thermocline Using the new updated heat transfer correlation to allow for stagnant flow conditions"
    import TRANSFORM;
...
<p><br>The model backbone is the Schumann equations with additional terms incorporated for thermal conduction when in standby mode. </p>
  ...
  end Thermocline_fluidprops_heaters_newHC_20C;
