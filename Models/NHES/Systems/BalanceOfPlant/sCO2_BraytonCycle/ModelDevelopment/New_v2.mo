...
model New_v2
  ...
  Components.Compressor_v2 Comp2(
    ...
    w0=operatingConditions.Comp2_NominalMassFlowRate) annotation (Placement(transformation(extent={{-218,-17},{-192,5}})));
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T Comp1In(
    ...
    m_flow=1783,
    T=309.15,
    nPorts=1) annotation (Placement(transformation(extent={{-240,-4},{-226,10}})));
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT Comp1Out(
    ...
    p=20130000,
    T=347.8,
    nPorts=1) annotation (Placement(transformation(extent={{-162,-3},{-174,9}})));
  ...
  TRANSFORM.Fluid.Volumes.SimpleVolume Cooler(
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-190,-106})));
  Modelica.Thermal.HeatTransfer.Sources.FixedHeatFlow fixedHeatFlow1(Q_flow=operatingConditions.Cooler_HeatOut)
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT CoolerOut(
    ...
    p=8411000,
    T=309.15,
    nPorts=1) annotation (Placement(transformation(extent={{-126,-105},{-138,-93}})));
...
equation
  ...
  connect(Comp2.inlet, Comp1In.ports[1])
    annotation (Line(points={{-212.8,2.8},{-220,2.8},{-220,3},{-226,3}}, color={0,127,255}));
  connect(Comp2.outlet, Comp1Out.ports[1])
    annotation (Line(points={{-197.2,2.8},{-186,2.8},{-186,3},{-174,3}}, color={0,127,255}));
  ...
  connect(fixedHeatFlow1.port, Cooler.heatPort) annotation (Line(points={{-190,-82},{-190,-100}},
                                                                                               color={191,0,0}));
  ...
  connect(Cooler.port_b, CoolerOut.ports[1])
    annotation (Line(points={{-184,-106},{-154,-106},{-154,-99},{-138,-99}},
                                                                       color={0,127,255}));
