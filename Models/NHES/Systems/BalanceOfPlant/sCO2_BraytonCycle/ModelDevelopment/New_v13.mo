...
model New_v13
  ...
  Components.Compressor_v2 Comp2(
    ...
    w0=operatingConditions.Comp2_NominalMassFlowRate) annotation (Placement(transformation(extent={{-126,-17},{-100,5}})));
  Components.Compressor_v2 Comp1(
    ...
    w0=operatingConditions.Comp1_NominalMassFlowRate) annotation (Placement(transformation(extent={{82,-71},{108,-49}})));
...
equation
  ...
  connect(realExpression.y, PID.u_m) annotation (Line(points={{179,76},{160,76},{160,106},{136,106}},
                                                                                                    color={0,0,127}));
  connect(Sink.ports[1], valveLinear.port_b) annotation (Line(points={{85,145},{84,145},{84,128}},    color={0,127,255}));
  ...
  connect(Cooler.port_a, FlowResistance1.port_b) annotation (Line(points={{-124,-52},{-124,-86},{-33,-86}}, color={0,127,255}));
  connect(FlowResistance2.port_b, Comp1.inlet) annotation (Line(points={{45,-86},{66,-86},{66,-51.2},{87.2,-51.2}}, color={0,127,255}));
  annotation (
