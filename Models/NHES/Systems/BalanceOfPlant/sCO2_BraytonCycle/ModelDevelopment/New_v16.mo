...
model New_v16
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT BoundaryOut(
    ...
    p=19860000,
    T=857.05,
    nPorts=1) annotation (Placement(transformation(extent={{-102,12},{-90,24}})));
  Fluid.HeatExchangers.Generic_HXs.NTU_HX_SinglePhase_New
                     HX2(
...
equation
  ...
  connect(HX2.Shell_out, HX2_sensor_ShellOut.port_a)
    annotation (Line(points={{2,-24.4},{-2,-24.4},{-2,-36},{-4,-36}},
                                                                 color={0,127,255}));
  connect(BoundaryIn.ports[1], Turbine.inlet) annotation (Line(points={{-92,62},{-84.8,62},{-84.8,61.2}}, color={0,127,255}));
  ...
  connect(HX1_sensor_ShellOut.port_b, BoundaryOut.ports[1]) annotation (Line(points={{-32,18},{-90,18}}, color={0,127,255}));
