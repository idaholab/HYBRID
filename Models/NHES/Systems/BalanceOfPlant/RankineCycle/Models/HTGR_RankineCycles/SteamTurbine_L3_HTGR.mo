...
model SteamTurbine_L3_HTGR
  extends
    ...
    redeclare replaceable ControlSystems.CS_threeStagedTurbine_HTGR CS(
        trap_LTV1bypass_power(
    ...
    redeclare NHES.Systems.BalanceOfPlant.RankineCycle.Data.IdealTurbine data);
  Real time_altered;
  Real time_initialization = 7e4;
  Real electricity_generation_Norm;
  Real electricity_demand_Norm;
  NHES.Systems.BalanceOfPlant.RankineCycle.Data.DataInitial_HTGR_Pebble dataInitial(
  ...
  TRANSFORM.Fluid.Valves.ValveLinear LPT2_Bypass(
    ...
    m_flow_nominal=5) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={178,16})));
  NHES.Systems.BalanceOfPlant.RankineCycle.Data.DataInitial_HTGR_BoP_3stage dataInitial_HTGR_BoP_3stage(
      LPT1_T_outlet=473.15, LPT2_T_inlet=473.15)
