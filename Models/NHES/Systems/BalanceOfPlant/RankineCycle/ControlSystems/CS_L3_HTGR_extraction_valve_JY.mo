...
model CS_L3_HTGR_extraction_valve_JY
  ...
  Modelica.Blocks.Sources.RealExpression setpoint_dp(y=0.5*100000)
    ...
    annotation (Placement(transformation(extent={{230,-86},{218,-74}})));
  TRANSFORM.Controls.LimPID PA_LPT(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=-3e-5,
    Ti=100,
    yMax=1,
    yMin=0) annotation (Placement(transformation(extent={{192,-86},{172,-66}})));
equation
  ...
  connect(setpoint_dp.y,PA_LPT. u_s) annotation (Line(points={{217.4,-80},{204,
          -80},{204,-76},{194,-76}},color={0,0,127}));
  connect(sensorBus.Actual_dp, PA_LPT.u_m) annotation (Line(
      points={{-30,-100},{-30,-106},{182,-106},{182,-88}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(actuatorBus.LPT1_bypass_valve2_opening, PA_LPT.y) annotation (Line(
      points={{30,-100},{166,-100},{166,-76},{171,-76}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
...
end CS_L3_HTGR_extraction_valve_JY;
