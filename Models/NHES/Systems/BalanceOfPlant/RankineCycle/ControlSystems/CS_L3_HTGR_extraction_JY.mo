...
model CS_L3_HTGR_extraction_JY
  ...
  Modelica.Blocks.Sources.RealExpression setpoint_dp(y=0.5*100000)
    ...
    annotation (Placement(transformation(extent={{240,-118},{200,-98}})));
  TRANSFORM.Controls.LimPID PA_LPT(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=-3e-5,
    Ti=100,
    yMax=1,
    yMin=0) annotation (Placement(transformation(extent={{182,-118},{162,-98}})));
equation
  ...
  connect(setpoint_dp.y,PA_LPT. u_s) annotation (Line(points={{198,-108},{184,
          -108}},                   color={0,0,127}));
  connect(actuatorBus.PartialAdmission_LPT, PA_LPT.y) annotation (Line(
      points={{30,-100},{156,-100},{156,-108},{161,-108}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.Actual_dP, PA_LPT.u_m) annotation (Line(
      points={{-30,-100},{8,-100},{8,-122},{156,-122},{156,-128},{172,-128},{
          172,-120}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
