...
package HeatRecoverySteamGenerator
  model HRSG

    extends BaseClasses.Partial_SubSystem_A(
      redeclare replaceable
        NHES.Systems.BalanceOfPlant.HeatRecoverySteamGenerator.CS.CS_TEC CS,
      redeclare replaceable
        NHES.Systems.BalanceOfPlant.HeatRecoverySteamGenerator.CS.ED_Dummy ED,
  ...
  annotation (Dialog(tab="Superheater Dimensions",
    ...
    Modelica.Fluid.Interfaces.FluidPort_a Feed_port(redeclare package Medium =
      ...
      annotation (Placement(transformation(extent={{-10,-110},{10,-90}}),   iconTransformation(extent={{-10,
              -110},{10,-90}})));
    Modelica.Fluid.Interfaces.FluidPort_a Gas_Inlet_Port(redeclare package Medium =
          NHES.Media.FlueGas)
      annotation (Placement(transformation(extent={{90,-10},{110,10}}),  iconTransformation(extent={{90,-10},
              {110,10}})));
    Modelica.Fluid.Interfaces.FluidPort_b Gas_Outlet_Port(redeclare package
        Medium =
          NHES.Media.FlueGas)
      annotation (Placement(transformation(extent={{-108,-8},{-88,12}}),   iconTransformation(extent={{-108,-8},
              {-88,12}})));
    Modelica.Fluid.Interfaces.FluidPort_b Steam_Outlet_port(redeclare package
        Medium =
          Modelica.Media.Water.StandardWater) annotation (Placement(transformation(extent={{90,50},
              {110,70}}),                                                                                        iconTransformation(extent={{90,50},
              {110,70}})));
  ...
  equation
    ...
    connect(Feed_Resistance.port_a, steam_Drum.feed_port) annotation (Line(
          points={{-47,40},{16,40}},                   color={0,127,255}));
    ...
    connect(valveLinear.port_b,massFlowRate. port_a)
      annotation (Line(points={{-120,60},{-108,60},{-108,40},{-102,40}},
                                                     color={0,127,255}));
    ...
    connect(Evaporator.port_a_shell,Gas_Resistance_2. port_b)
      annotation (Line(points={{30.6,-34},{30.6,-24},{40,-24},{40,-82},{60,-82},{60,-112},{119,-112}},
                                                                                  color={0,140,72}));
    connect(Gas_Inlet_Port, Superheater.port_a_shell) annotation (Line(points={{100,0},
            {154,0},{154,-20},{86.6,-20},{86.6,-26}},                                                              color={0,140,72}));
    connect(Gas_Outlet_Port, Economizer.port_b_shell)
      annotation (Line(points={{-98,2},{-118,2},{-118,-72},{-51.4,-72},{-51.4,-46}},    color={0,140,72}));
    connect(Feed_port, Booster_Pump.port_a) annotation (Line(points={{0,-100},{0,-148},
            {-148,-148},{-148,20},{-138,20}},                                                        color={0,127,255}));
    connect(Feed_port, valveLinear.port_a) annotation (Line(points={{0,-100},{0,-148},
            {-148,-148},{-148,60},{-140,60}},                                                                           color={0,127,255}));
    connect(Booster_Pump.port_b, massFlowRate.port_a) annotation (Line(points={{-118,20},
            {-108,20},{-108,40},{-102,40}},                                                                              color={0,127,255}));
    connect(SH_Downcomer.port_a, steam_Drum.steam_port)
      annotation (Line(points={{54,-28},{54,50},{26,50}}, color={238,46,47}));
    connect(massFlowRate.port_b, ECON_Downcomer.port_a) annotation (Line(points={{-82,40},
    ...
    connect(massFlowRate.port_b, Feed_Resistance.port_b) annotation (Line(points={{-82,40},
            {-61,40}},                                                                                color={0,127,255}));
    ...
    connect(Economizer.port_b_tube, steam_Drum.feed_port) annotation (Line(
          points={{-56,-26},{-56,8},{-28,8},{-28,40},{16,40}},
                                               color={0,127,255}));
    connect(Gas_Resistance.port_b, Gas_Outlet_Port) annotation (Line(points={{-83,
            -110},{-118,-110},{-118,2},{-98,2}},                                                                            color={0,140,72}));
    ...
    connect(Gas_Resistance_2.port_a, Gas_Inlet_Port) annotation (Line(points={{133,
            -112},{154,-112},{154,0},{100,0}},                                                                            color={0,140,72}));
    connect(massFlowRate1.port_b, pressure_Control_Valve_Simple.port_a)
      annotation (Line(points={{82,80},{82,150},{60,150}}, color={238,46,47}));
    connect(pressure_Control_Valve_Simple.port_b, Steam_Outlet_port)
      annotation (Line(points={{40,150},{100,150},{100,60}},
                                                          color={238,46,47}));
    ...
    connect(sensorBus.m_dot_feed, massFlowRate.m_flow) annotation (Line(
        points={{-30,100},{-30,56},{-92,56},{-92,51}},
        color={239,82,82},
    ...
    connect(sensorBus.m_dot_steam, massFlowRate1.m_flow) annotation (Line(
        points={{-30,100},{-30,70},{71,70}},
        color={239,82,82},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
    ...
    connect(sensorBus.drum_lvl, steam_Drum.RelLevel) annotation (Line(
        points={{-30,100},{-30,70},{46,70},{46,40},{36.2,40}},
        color={239,82,82},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(actuatorBus.feed_control, valveLinear.opening) annotation (Line(
        points={{30,100},{30,80},{-130,80},{-130,68}},
        color={111,216,99},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
        ...
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
    connect(actuatorBus.feed_control, Booster_Pump.in_m_flow) annotation (Line(
        points={{30,100},{30,80},{-116,80},{-116,40},{-128,40},{-128,27.3}},
        color={111,216,99},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
  ...
  annotation (Dialog(tab="Superheater Dimensions",
    ...
    Modelica.Fluid.Interfaces.FluidPort_b Gas_Outlet_Port(redeclare package
        Medium =
          NHES.Media.FlueGas)
      annotation (Placement(transformation(extent={{-110,-10},{-90,10}}),  iconTransformation(extent={{-110,
              -10},{-90,10}})));
    Modelica.Fluid.Interfaces.FluidPort_b Steam_Outlet_port(redeclare package
        Medium =
          Modelica.Media.Water.StandardWater) annotation (Placement(transformation(extent={{90,50},
  ...
  equation
    ...
    connect(valveLinear.port_b,massFlowRate. port_a)
      annotation (Line(points={{-90,78},{-84,78},{-84,62},{-108,62},{-108,40},{-104,
            40}},                                    color={0,127,255}));
    connect(Feed_port, Booster_Pump.port_a) annotation (Line(points={{0,-100},{0,-148},
            {-148,-148},{-148,50},{-134,50}},                                                        color={0,127,255}));
    connect(Feed_port, valveLinear.port_a) annotation (Line(points={{0,-100},{0,-148},
            {-148,-148},{-148,78},{-110,78}},                                                                           color={0,127,255}));
    ...
    connect(Steam_Resistance.port_a, massFlowRate1.port_a) annotation (Line(points={{73,50},
            {82,50},{82,60}},                                                                           color={238,46,47}));
    connect(Gas_Resistance.port_b, Gas_Outlet_Port) annotation (Line(points={{-83,
            -108},{-118,-108},{-118,0},{-100,0}},                                                                           color={0,140,72}));
    connect(Gas_Resistance_2.port_a, Gas_Inlet_Port) annotation (Line(points={{133,
            -112},{154,-112},{154,0},{100,0}},                                                                            color={0,140,72}));
    connect(massFlowRate1.port_b, pressure_Control_Valve_Simple.port_a)
      annotation (Line(points={{82,80},{82,130},{48,130}}, color={238,46,47}));
    connect(pressure_Control_Valve_Simple.port_b, Steam_Outlet_port)
      annotation (Line(points={{28,130},{100,130},{100,60}},
                                                          color={238,46,47}));
    connect(steam_Drum.downcomer_port, DowncomerResistance.port_b) annotation (
        Line(points={{22,30},{22,4},{-14,4},{-14,-7}}, color={244,125,35}));
    connect(Downcomer.port_b, RecircPump.port_a) annotation (Line(points={{-14,-52},{-14,-84},{-6,-84}}, color={0,127,255}));
    ...
    connect(Econimizer.Shell_in, Gas_Outlet_Port)
      annotation (Line(points={{-54,-30},{-54,0},{-100,0}}, color={0,140,72}));
    ...
    connect(Gas_Inlet_Port, Superheater.Shell_in)
      annotation (Line(points={{100,0},{84,0},{84,-32}}, color={0,127,255}));
    ...
    connect(sensorBus.m_dot_feed, massFlowRate.m_flow) annotation (Line(
        points={{-30,100},{-30,56},{-94,56},{-94,51}},
        color={239,82,82},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
    ...
    connect(sensorBus.m_dot_steam, massFlowRate1.m_flow) annotation (Line(
        ...
        horizontalAlignment=TextAlignment.Right));
    connect(sensorBus.drum_lvl, steam_Drum.RelLevel) annotation (Line(
        points={{-30,100},{4,100},{4,44},{36.2,44},{36.2,40}},
        color={239,82,82},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
    ...
    connect(actuatorBus.feed_control, valveLinear.opening) annotation (Line(
        ...
        horizontalAlignment=TextAlignment.Left));
    connect(actuatorBus.feed_control, Booster_Pump.in_m_flow) annotation (Line(
        points={{30,100},{-120,100},{-120,64},{-124,64},{-124,57.3}},
        color={111,216,99},
        pattern=LinePattern.Dash,
        thickness=0.5), Text(
        string="%first",
  ...
  package Examples
    ...
    Modelica.Fluid.Sources.Boundary_pT SinkExhaustGas(
        ...
        use_p_in=false,
        nPorts=1)               annotation (Placement(transformation(extent={{56,42},
                {72,58}}, rotation=0)));
        ...
        use_p_in=false,
        T=313.15,
        nPorts=1)     annotation (Placement(transformation(extent={{60,-72},{44,
                -56}},                                                                   rotation=0)));
          Modelica.Fluid.Sources.Boundary_pT SteamSink(
        p=100000,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        use_p_in=false,
        nPorts=1)     annotation (Placement(transformation(extent={{-92,46},{
                -76,62}},                                                              rotation=0)));
    ...
    equation
          connect(heatRecoverySteamGenerator.Steam_Outlet_port,SteamSink. ports[1])
            annotation (Line(points={{-40,24},{-70,24},{-70,54},{-76,54}},
                                                                color={0,127,255}));
          connect(heatRecoverySteamGenerator.Gas_Outlet_Port,SinkExhaustGas. ports[1]) annotation (Line(points={{39.2,
              0.8},{78,0.8},{78,50},{72,50}},                                                                                       color={0,127,255}));
          connect(heatRecoverySteamGenerator.Feed_port,FeedSource. ports[1])
            annotation (Line(points={{0,-40},{0,-64},{44,-64}},           color={0,127,255}));
          connect(boundary.ports[1],heatRecoverySteamGenerator. Gas_Inlet_Port)
            annotation (Line(points={{-70,0},{-56,0},{-56,0},{-40,0}},
                                                       color={0,127,255}));
      connect(sensor_T.port,heatRecoverySteamGenerator. Gas_Outlet_Port)
        annotation (Line(points={{52,20},{52,0.8},{39.2,0.8}},
                                                         color={0,127,255}));
      annotation (
    ...
    Modelica.Fluid.Sources.Boundary_pT SinkExhaustGas(
        ...
        redeclare package Medium = Media.FlueGas,
        use_p_in=false,
        nPorts=1)               annotation (Placement(transformation(extent={{138,-8},
                {122,8}}, rotation=0)));
          Modelica.Fluid.Sources.Boundary_pT FeedSource(
        p=500000,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        use_p_in=false,
        T=333.15,
        nPorts=1)     annotation (Placement(transformation(extent={{100,-60},{
                84,-44}},                                                                rotation=0)));
          Modelica.Fluid.Sources.Boundary_pT SteamSink(
        p=100000,
        redeclare package Medium = Modelica.Media.Water.StandardWater,
        use_p_in=false,
        nPorts=1)     annotation (Placement(transformation(extent={{-18,62},{-2,
                78}},                                                                  rotation=0)));
    ...
    equation
      connect(SES.portElec_b,elecLoad. portElec_a)
        annotation (Line(points={{-20,0},{-8,0},{-8,-26},{-2,-26}},
                                                              color={255,0,0}));
          connect(heatRecoverySteamGenerator.Steam_Outlet_port,SteamSink. ports[1])
            annotation (Line(points={{20,24},{2,24},{2,70},{-2,70}},
                                                                color={0,127,255}));
          connect(heatRecoverySteamGenerator.Gas_Outlet_Port,SinkExhaustGas. ports[1]) annotation (Line(points={{100,0},
              {122,0}},                                                                                                             color={0,127,255}));
          connect(heatRecoverySteamGenerator.Feed_port,FeedSource. ports[1])
            annotation (Line(points={{60,-40},{60,-52},{84,-52}},         color={0,127,255}));
      connect(sensor_T1.port,heatRecoverySteamGenerator. Gas_Outlet_Port)
        annotation (Line(points={{112,18},{112,0},{100,0}},color={0,127,255}));
      connect(heatRecoverySteamGenerator.Gas_Inlet_Port, sensor_T.port)
        annotation (Line(points={{20,0},{6,0}}, color={0,127,255}));
      connect(sensor_T.port, SES.FlueGas_b) annotation (Line(points={{6,0},{-6,
              0},{-6,24},{-20,24}}, color={0,127,255}));
      annotation (
        Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}})),
        experiment(
    ...
    model CombinedCycle_Test
      extends Modelica.Icons.Example;

      SecondaryEnergySupply.NaturalGasFiredTurbine.GTPP_PowerCtrl_GasExit
                     SES(capacity=35000000, redeclare
          SecondaryEnergySupply.NaturalGasFiredTurbine.CS_GTPP_ss CS(Power_nom=
              35000000))
    ...
    Modelica.Fluid.Sources.Boundary_pT SinkExhaustGas(
        ...
        redeclare package Medium = Media.FlueGas,
        use_p_in=false,
        nPorts=1)               annotation (Placement(transformation(extent={{22,42},
                {38,58}}, rotation=0)));
          HRSG_NTU                              heatRecoverySteamGenerator(
        redeclare replaceable
          NHES.Systems.BalanceOfPlant.HeatRecoverySteamGenerator.CS.CS_TEC CS(
      ...
      Turbine.SteamTurbine_L3_HPOFWH_HRSG                             BOP(
          redeclare replaceable Turbine.ControlSystems.CS_L3 CS(
          redeclare Turbine.Data.Data_L3 data(
            HPT_p_in=850000,
            p_dump=1200000,
            p_i1=400000,
            p_i2=250000,
          ...
          FeedPump_PID(yMax=20)), redeclare replaceable Turbine.Data.Data_L3
          data(
          HPT_p_in=850000,
          p_dump=1200000,
          p_i1=400000,
    ...
    equation
      connect(SES.portElec_b,elecLoad. portElec_a)
        annotation (Line(points={{-100,0},{-98,0},{-98,8},{-94,8}},
                                                              color={255,0,0}));
      connect(sensor_T.port,SES. FlueGas_b) annotation (Line(points={{-94,44},{
              -94,24},{-100,24}},   color={0,127,255}));
          connect(heatRecoverySteamGenerator.Gas_Outlet_Port,SinkExhaustGas. ports[1]) annotation (Line(points={{40,0},{
              60,0},{60,50},{38,50}},                                                                                               color={0,127,255}));
      connect(sensor_T1.port,heatRecoverySteamGenerator. Gas_Outlet_Port)
        annotation (Line(points={{46,16},{46,0},{40,0}},   color={0,127,255}));
      connect(SES.FlueGas_b,heatRecoverySteamGenerator. Gas_Inlet_Port)
        annotation (Line(points={{-100,24},{-50,24},{-50,0},{-40,0}},     color=
             {0,127,255}));
      ...
      connect(boundary.port,BOP. port_a_elec)
        annotation (Line(points={{200,0},{180,0}}, color={255,0,0}));
      ...
      connect(heatRecoverySteamGenerator.Steam_Outlet_port,BOP. port_a_steam)
        annotation (Line(points={{-40,24},{-40,66},{66,66},{66,24},{100,24}},
            color={0,127,255}));
      connect(BOP.port_b_feed,heatRecoverySteamGenerator. Feed_port)
        annotation (Line(points={{100,-24},{60,-24},{60,-60},{0,-60},{0,-40}},
            color={0,127,255}));
      annotation (
        Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}})),
  ...
  package CS "Control systems package"
    ...
    model CS_TEC
      ...
      Components.ThreeElementContoller         threeElementContoller(
        FlowErrorGain=FlowErrorGain,
        LevelErrorGain=LevelErrorGain,
        k=k,
        yMax=yMax,
        yMin=yMin,
        kp=kp,
      ...
      parameter Real FlowErrorGain=0.01 "Gain of Flow Error";
      parameter Real LevelErrorGain=1 "Gain of Level Error";
      parameter Real k=100 "Gain of controller";
      parameter Real yMax=1;
      parameter Real yMin=0 "Lower limit of output";
      parameter Real kp=250 "Proportional Gain";
      parameter Real DelayTime=2 "Time Delay for start of controller";
      parameter Real SS_guess=0 "Init Guess for SS before start of controller";
      parameter Real LevelSet=0.5 "Relative set point for level";
      parameter Real xi_start=0
        "Initial or guess value for integrator output (= integrator state)";
    ...
    equation
      ...
      connect(sensorBus.drum_lvl, threeElementContoller.Level) annotation (Line(
          points={{-30,-100},{-30,0},{-24,0}},
          color={239,82,82},
          pattern=LinePattern.Dash,
          thickness=0.5), Text(
          string="%first",
          ...
          extent={{-6,3},{-6,3}},
          horizontalAlignment=TextAlignment.Right));
      connect(sensorBus.m_dot_feed, threeElementContoller.FeedFlow) annotation (
          Line(
          points={{-30,-100},{-30,-40},{-10,-40},{-10,-24}},
          color={239,82,82},
          pattern=LinePattern.Dash,
          thickness=0.5), Text(
          string="%first",
          ...
          extent={{-6,3},{-6,3}},
          horizontalAlignment=TextAlignment.Right));
      connect(sensorBus.m_dot_steam, threeElementContoller.SteamFlow) annotation (
          Line(
          points={{-30,-100},{-30,-40},{10,-40},{10,-24}},
          color={239,82,82},
          pattern=LinePattern.Dash,
          ...
          extent={{-6,3},{-6,3}},
          horizontalAlignment=TextAlignment.Right));
      connect(actuatorBus.feed_control, threeElementContoller.y) annotation (Line(
          points={{30,-100},{30,0},{22,0}},
          color={111,216,99},
          pattern=LinePattern.Dash,
          thickness=0.5), Text(
          string="%first",
  ...
  package BaseClasses
    ...
    partial model Partial_SubSystem
      ...
      replaceable Record_Data data
        annotation (Placement(transformation(extent={{-58,122},{-42,138}})));
      ...
      annotation (
        ...
        Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
            ...
            Text(
              ...
              fillPattern=FillPattern.Solid,
              textString="Change Me"),
            Bitmap(extent={{96,-94},{-94,94}}, fileName=
                  "modelica://NHES/Icons/BalanceOfPlantPackage/HRSG.png"),
            Rectangle(
              extent={{-94,94},{94,-94}},
              lineColor={0,0,0},
              fillPattern=FillPattern.None,
...
end HeatRecoverySteamGenerator;
