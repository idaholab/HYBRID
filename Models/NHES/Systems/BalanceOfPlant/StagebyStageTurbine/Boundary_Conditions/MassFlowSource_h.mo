within NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Boundary_Conditions;
model MassFlowSource_h
  ...
  extends
    NHES.Systems.BalanceOfPlant.StagebyStageTurbine.BaseClasses.CylindricalSupport.PartialFlowSource;
