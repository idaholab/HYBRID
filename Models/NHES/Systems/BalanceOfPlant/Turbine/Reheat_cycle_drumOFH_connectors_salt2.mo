...
model Reheat_cycle_drumOFH_connectors_salt2
...
equation
  ...
  connect(pump2.port_b, DHX2.Shell_in) annotation (Line(points={{-82,95},{-80,
  ...
  connect(sensor_pT4.port, DHX1.Shell_in) annotation (Line(points={{-62,-2},{
          -64,-2},{-64,-22},{-38,-22}}, color={0,127,255}));
  connect(DHX1.Tube_out, steam_Drum.riser_port) annotation (Line(points={{-32,
          -22},{0,-22},{0,4},{6.6,4}}, color={0,127,255}));
  connect(sensor_pT3.port, DHX1.Tube_out) annotation (Line(points={{-16,-8},{
          -24,-8},{-24,-22},{-32,-22}}, color={0,127,255}));
  ...
  connect(DHX.Tube_in, pump_SimpleMassFlow1.port_b) annotation (Line(points={{
          -32,-86},{-32,-104},{152,-104},{152,-93},{170,-93}}, color={0,127,255}));
  ...
  connect(sensor_pT6.port, DHX.Shell_out) annotation (Line(points={{-82,-106},{
          -84,-106},{-84,-116},{-38,-116},{-38,-86}}, color={0,127,255}));
  connect(valveLinear.port_b, LT_out) annotation (Line(points={{-68,-82},{-68,
  ...
  connect(sensor_pT5.port, DHX1.Shell_out) annotation (Line(points={{-66,-52},{
          -38,-52},{-38,-42}}, color={0,127,255}));
  connect(const1.y, valveLinear.opening) annotation (Line(points={{-219,-70},{
          -219,-72},{-76,-72}}, color={0,0,127}));
  ...
  connect(clock.y,greater5. u1) annotation (Line(points={{62.6,-20},{64.7,-20},
          {64.7,-22},{66.8,-22}},
                       color={0,0,127}));
  connect(const2.y,greater5. u2) annotation (Line(points={{64.6,4},{64.6,-8},{
          66.8,-8},{66.8,-17.2}},
                                color={0,0,127}));
  connect(const3.y,switch_P_setpoint_TCV. u3) annotation (Line(points={{102.6,
          -10},{102.6,-17.2},{110.8,-17.2}},
                                      color={0,0,127}));
  connect(Tsat5.y,switch_P_setpoint_TCV. u1) annotation (Line(points={{86.6,-48},
          {110.8,-48},{110.8,-26.8}},                      color={0,0,127}));
  connect(switch_P_setpoint_TCV.y,delay3. u) annotation (Line(points={{124.6,
          -22},{124.6,-24},{132,-24},{132,-56},{96,-56},{96,-64},{83.4,-64}},
                                        color={0,0,127}));
  connect(delay3.y, pump.in_m_flow) annotation (Line(points={{67.02,-64},{48,
          -64},{48,-36},{32,-36},{32,-26},{21.3,-26}},
                                     color={0,0,127}));
...
end Reheat_cycle_drumOFH_connectors_salt2;
