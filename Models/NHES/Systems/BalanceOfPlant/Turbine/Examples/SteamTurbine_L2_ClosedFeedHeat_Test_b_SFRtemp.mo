...
model SteamTurbine_L2_ClosedFeedHeat_Test_b_SFRtemp
  import NHES;
  ...
  NHES.Systems.BalanceOfPlant.Turbine.SteamTurbine_L2_ClosedFeedHeat BOP(
    redeclare
      ...
      CS(data(
        p_steam(displayUnit="MPa") = 13700000,
        T_Steam_Ref=763.15,
        Q_Nom=60e6,
        T_Feedwater=483.15,
    ...
    redeclare replaceable Data.Turbine_2 data(
      ...
      HPT_T_in_nominal=763.15,
      HPT_nominal_mflow=110,
      LPT_p_in_nominal=1200000,
      LPT_T_in_nominal=548.15,
      LPT_nominal_mflow=110,
    ...
    port_a_nominal(
      m_flow=90,
      p(displayUnit="MPa") = 13700000,
      h=3e6),
    port_b_nominal(p(displayUnit="MPa") = 13700000, h=1e6),
    init(
      tee_p_start=800000,
...
end SteamTurbine_L2_ClosedFeedHeat_Test_b_SFRtemp;
