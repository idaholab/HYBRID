...
model SteamTurbine_L2_ClosedFeedHeat_Test_VN
  import NHES;

  extends Modelica.Icons.Example;
  NHES.Systems.BalanceOfPlant.Turbine.SteamTurbine_L2_ClosedFeedHeat_VN
                                                                     BOP(
    redeclare
...
end SteamTurbine_L2_ClosedFeedHeat_Test_VN;
