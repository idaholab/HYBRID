...
model ReheatCycle_Test_a1
  import NHES;
  extends Modelica.Icons.Example;
  NHES.Systems.BalanceOfPlant.Turbine.Reheat_cycle_drumOFH_connectors_salt
    reheat_cycle_drumOFH_connectors_salt(
...
equation
  ...
  connect(reheat_cycle_drumOFH_connectors_salt.HT_SH_out, boundary6.ports[1])
    annotation (Line(points={{12,2.47059},{10,2.47059},{10,4},{-78,4}}, color={
          0,127,255}));
  connect(reheat_cycle_drumOFH_connectors_salt.HT_RH_out, boundary7.ports[1])
    annotation (Line(points={{12.4667,23.1765},{-20,23.1765},{-20,70},{-78,70}},
        color={0,127,255}));
  connect(boundary1.ports[1], reheat_cycle_drumOFH_connectors_salt.HT_RH_in)
    annotation (Line(points={{-80,98},{4,98},{4,39.1765},{12.9333,39.1765}},
        color={0,127,255}));
  connect(boundary3.ports[1], reheat_cycle_drumOFH_connectors_salt.HT_SH_in)
  ...
  connect(add2.y,boundary2. m_flow_in) annotation (Line(points={{-231,16},{-154,
          16},{-154,-7.8},{-148,-7.8}},
                                   color={0,0,127}));
  connect(boundary2.ports[1], reheat_cycle_drumOFH_connectors_salt.LT_in)
    annotation (Line(points={{-130,-15},{-130,-16},{4,-16},{4,-17.7647},{
          12.4667,-17.7647}}, color={0,127,255}));
  connect(boundary4.ports[1], reheat_cycle_drumOFH_connectors_salt.LT_out)
