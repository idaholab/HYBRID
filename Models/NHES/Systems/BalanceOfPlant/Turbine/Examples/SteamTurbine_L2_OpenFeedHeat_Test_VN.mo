...
model SteamTurbine_L2_OpenFeedHeat_Test_VN
  import NHES;

  extends Modelica.Icons.Example;
  NHES.Systems.BalanceOfPlant.Turbine.SteamTurbine_L2_OpenFeedHeat_VN BOP(
    redeclare
      NHES.Systems.BalanceOfPlant.Turbine.ControlSystems.CS_SteamTurbine_L2_OFWH_VN
      CS(data(Q_Nom=45e6)),
...
end SteamTurbine_L2_OpenFeedHeat_Test_VN;
