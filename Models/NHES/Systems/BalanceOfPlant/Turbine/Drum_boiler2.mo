...
model Drum_boiler2
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary1(
    ...
    p=5000,
    T=343.15,
    nPorts=1) annotation (Placement(transformation(extent={{254,30},{274,50}})));
  ...
  TRANSFORM.Fluid.Sensors.PressureTemperature sensor_pT14(redeclare package
      Medium = Modelica.Media.Water.StandardWater)
    annotation (Placement(transformation(extent={{46,172},{66,192}})));
...
equation
  ...
  connect(steamTurbine.portHP, DHX2.Tube_out) annotation (Line(points={{100,70},
          {42,70},{42,72},{-30,72},{-30,62}}, color={0,127,255}));
  connect(powerSensor.flange_b,generator1. shaft_a)
    annotation (Line(points={{178,62},{188,62}},
                                               color={0,0,0}));
  connect(steamTurbine.shaft_b, powerSensor.flange_a) annotation (Line(points={
          {120,64},{122,64},{122,62},{158,62}}, color={0,0,0}));
  connect(PID1.y, boundary5.m_flow_in) annotation (Line(points={{-143,98},{
          -122.5,98},{-122.5,98.2},{-102,98.2}}, color={0,0,127}));
  connect(steamTurbine.portLP, DHX3.Tube_in) annotation (Line(points={{120,70},
          {126,70},{126,172},{16,172},{16,178}}, color={0,127,255}));
  ...
  connect(steamTurbine.portLP, sensor_pT14.port) annotation (Line(points={{120,
          70},{126,70},{126,172},{56,172}}, color={0,127,255}));
  ...
  connect(steamTurbine1.shaft_b, steamTurbine.shaft_a)
    annotation (Line(points={{92,242},{100,242},{100,64}}, color={0,0,0}));
  ...
  connect(pump_SimpleMassFlow1.port_b, boundary1.ports[1]) annotation (Line(
        points={{290,39},{282,39},{282,40},{274,40}}, color={0,127,255}));
