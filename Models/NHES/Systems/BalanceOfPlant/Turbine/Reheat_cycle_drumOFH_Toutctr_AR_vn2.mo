...
model Reheat_cycle_drumOFH_Toutctr_AR_vn2
...
replaceable package Medium = Modelica.Media.Water.StandardWater annotation (__Dymola_choicesAllMatching=true);
  ...
  Modelica.Blocks.Sources.Constant const7(k=8.5e5)
    annotation (Placement(transformation(extent={{104,206},{124,226}})));
...
equation
  ...
  connect(actuatorBus.PartialAdmission, steamTurbine.partialArc) annotation (
      Line(
      points={{2,236},{-162,236},{-162,114},{34,114},{34,80},{65,80}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
  ...
  connect(delay3.y, pump.in_m_flow) annotation (Line(points={{67.02,-64},{48,-64},
          {48,-36},{32,-36},{32,-26},{21.3,-26}},
                                     color={0,0,127}));
  connect(const7.y,PartialAdmission. u_s) annotation (Line(points={{125,216},{
          125,213},{132.6,213}},   color={0,0,127}));
  ...
  connect(actuatorBus.CondPump_m, pump_SimpleMassFlow2.inputSignal) annotation (
     Line(
      points={{2,236},{-98,236},{-98,210},{-162,210},{-162,-162},{267,-162},{
          267,-19.03}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
  ...
  connect(nonLinear_Break.port_a, tee1.port_3) annotation (Line(points={{124,40},
          {120,40},{120,54},{114,54}}, color={0,127,255}));
...
end Reheat_cycle_drumOFH_Toutctr_AR_vn2;
