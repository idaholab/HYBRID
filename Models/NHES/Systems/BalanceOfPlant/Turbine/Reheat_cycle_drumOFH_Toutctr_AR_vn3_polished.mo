...
equation
  ...
  connect(sensorBus.P_LPT_in, sensor_pT15.p) annotation (Line(
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(actuatorBus.PartialAdmission_LPT, steamTurbine1.partialArc)
    annotation (Line(
      points={{2,236},{-162,236},{-162,114},{134,114},{134,72},{153,72}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
...
end Reheat_cycle_drumOFH_Toutctr_AR_vn3_polished;
