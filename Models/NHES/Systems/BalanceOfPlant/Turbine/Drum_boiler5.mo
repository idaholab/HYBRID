...
model Drum_boiler5
  ...
  StagebyStageTurbineSecondary.Control_and_Distribution.Delay delay3(Ti=20)
...
equation
  ...
  connect(ramp1.y, steamTurbine.partialArc)
    annotation (Line(points={{90.7,21},{127,21},{127,58}}, color={0,0,127}));
