...
model CS_L3inout
  ...
  Data.Data_L3_in paraData;
  Modelica.Blocks.Sources.RealExpression T_in_set(y=paraData.Tin)
    annotation (Placement(transformation(extent={{-100,80},{-80,100}})));
  Modelica.Blocks.Sources.RealExpression T_feed_set(y=paraData.Tfeed)
    annotation (Placement(transformation(extent={{-100,40},{-80,60}})));
  Modelica.Blocks.Sources.RealExpression P_in_set(y=paraData.HPT_p_in)
    annotation (Placement(transformation(extent={{-100,0},{-80,20}})));
  TRANSFORM.Controls.LimPID FeedPump_PID(controllerType=Modelica.Blocks.Types.SimpleController.PI,
    k=-5e-1,
    Ti=30,
    yMax=2*paraData.mdot_hpt,
    yMin=paraData.mdot_hpt*0.1)
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis(uLow=paraData.HPT_p_in, uHigh=
        paraData.p_dump)
  ...
  Modelica.Blocks.Sources.RealExpression T_in_set1(y=paraData.mdot_hpt)
