...
model CS_Rankine_Xe100_Based_Secondary_TransientControl_Training
...
equation
  ...
  connect(sensorBus.Q_balance, TCV_Position.u_s) annotation (Line(
      points={{-29.9,-99.9},{-104,-99.9},{-104,-28},{-58,-28}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
annotation(defaultComponentName="changeMe_CS", Icon(graphics));
end CS_Rankine_Xe100_Based_Secondary_TransientControl_Training;
