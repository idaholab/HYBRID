...
model CS_SmallCycle_NoFeedHeat_AR1
...
equation
  connect(sensorBus.Steam_Pressure,FWCP_Speed. u_m) annotation (Line(
      points={{-30,-100},{-118,-100},{-118,40},{-48,40},{-48,62}},
      color={239,82,82},
  ...
  connect(const3.y,FWCP_Speed. u_s)
    annotation (Line(points={{-69,72},{-64,72},{-64,74},{-60,74}},
                                                 color={0,0,127}));
  connect(FWCP_Speed.y,add. u2)
    annotation (Line(points={{-37,74},{-28,74},{-28,72},{-18,72}},
                                               color={0,0,127}));
...
end CS_SmallCycle_NoFeedHeat_AR1;
