...
equation
  ...
  connect(LPT2_BV_PID1.y, min1.u2) annotation (Line(points={{-39,-60},{-20,-60},
          {-20,-56},{-12,-56}}, color={0,0,127}));
  connect(LPT2_BV_PID1.y, max1.u1) annotation (Line(points={{-39,-60},{-20,-60},
          {-20,-64},{-12,-64}}, color={0,0,127}));
  connect(Zero.y, max1.u2) annotation (Line(points={{-39,-84},{-20,-84},{-20,
          -76},{-12,-76}}, color={0,0,127}));
  connect(One.y, min1.u1) annotation (Line(points={{-39,-38},{-20,-38},{-20,-44},
          {-12,-44}}, color={0,0,127}));
  connect(sensorBus.DH_re_T, LPT2_BV_PID1.u_m) annotation (Line(
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(actuatorBus.LPT1_BV, min1.y) annotation (Line(
      ...
      extent={{-3,-6},{-3,-6}},
      horizontalAlignment=TextAlignment.Right));
  connect(actuatorBus.TBV, max1.y) annotation (Line(
