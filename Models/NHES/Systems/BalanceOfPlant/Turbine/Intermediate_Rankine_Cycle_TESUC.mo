...
model Intermediate_Rankine_Cycle_TESUC "Two stage BOP model"
  extends BaseClasses.Partial_SubSystem_C(
    ...
    redeclare Data.IntermediateTurbine data(
      ...
      InternalBypassValve_K=50,
      HPT_nominal_mflow=20,
  ...
  TRANSFORM.Fluid.Machines.SteamTurbine steamTurbine(
    ...
    p_inlet_nominal=port_a_nominal.p - TCV.dp_nominal)
...
equation
  ...
  connect(steamTurbine.portLP, R_InternalBypass1.port_a)
    annotation (Line(points={{58,38},{64,38},{64,-15}}, color={0,127,255}));
  connect(steamTurbine.portHP, sensor_T1.port_b)
    annotation (Line(points={{38,38},{34,38},{34,40},{28,40}},
                                               color={0,127,255}));
  connect(steamTurbine.shaft_b, powerSensor.flange_a)
    annotation (Line(points={{58,32},{68,32},{68,34},{78,34}},
                                               color={0,0,0}));
