...
equation
  ...
  connect(PID.y, pump_SimpleMassFlow1.in_m_flow)
    annotation (Line(points={{169,-8},{379,-8},{379,22.97}}, color={0,0,127}));
  ...
  connect(steamTurbine.portLP, DHX3.Tube_in) annotation (Line(points={{142,68},
          {148,68},{148,160},{16,160},{16,178}}, color={0,127,255}));
  connect(pump_SimpleMassFlow1.port_b, boundary1.ports[1]) annotation (Line(
        points={{368,31},{216,31},{216,36},{210,36}}, color={0,127,255}));
