...
model New_v14
  ...
  inner Modelica.Fluid.System system annotation (Placement(transformation(extent={{88,196},{108,216}})));
  ...
  GasTurbine.Compressor.Compressor_v2   Comp2(
    ...
    w0=operatingConditions.Comp2_NominalMassFlowRate)
             annotation (Placement(transformation(extent={{-100,-33},{-74,-11}})));
  GasTurbine.Compressor.Compressor_v2   Comp1(
    ...
    w0=operatingConditions.Comp1_NominalMassFlowRate)
             annotation (Placement(transformation(extent={{30,-108},{56,-86}})));
  ...
  InitialConditions initialConditions annotation (Placement(transformation(extent={{122,198},{142,218}})));
  OperatingConditions operatingConditions annotation (Placement(transformation(extent={{154,198},{174,218}})));
