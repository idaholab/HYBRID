...
model New_v6
  ...
  Modelica.Fluid.Fittings.TeeJunctionVolume Split(redeclare package Medium = Medium,
    p_start=8431000,
    T_start=372.25,
    V=0.1)
...
equation
  ...
  connect(HX1_sensor_ShellIn.port_a, Merge.port_3)
    annotation (Line(points={{-52,63},{-56,63},{-56,32},{116,32},{116,-11},{155,-11}}, color={0,127,255}));
end New_v6;
