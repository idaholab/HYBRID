...
model New_v4
  ...
  GasTurbine.Compressor.Compressor_v2   Comp1(
    ...
    w0=operatingConditions.Comp1_NominalMassFlowRate)
             annotation (Placement(transformation(extent={{148,-129},{174,-107}})));
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T Comp2In(
    redeclare package Medium = Medium,
    m_flow=1084,
    T=372.25,
    nPorts=1) annotation (Placement(transformation(extent={{122,-116},{136,-102}})));
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T MergeFromHX(
    ...
    m_flow=1783,
    T=458.05,
    nPorts=1) annotation (Placement(transformation(extent={{96,-26},{110,-12}})));
  ...
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT MergeIn(
    ...
    p=20100000,
    T=458.15,
    nPorts=1) annotation (Placement(transformation(extent={{178,3},{164,17}})));
...
equation
  ...
  connect(Comp1.inlet, Comp2In.ports[1])
    annotation (Line(points={{153.2,-109.2},{144,-109.2},{144,-109},{136,-109}},
                                                                             color={0,127,255}));
  ...
  connect(MergeFromHX.ports[1], Merge.port_1) annotation (Line(points={{110,-19},{148,-18}},   color={0,127,255}));
  connect(MergeIn.ports[1], Merge.port_3)
    annotation (Line(points={{164,10},{154,10},{154,-11},{155,-11}},       color={0,127,255}));
  ...
  connect(Comp1.outlet, Merge.port_2) annotation (Line(points={{168.8,-109.2},{202,-109.2},{202,-18},{162,-18}}, color={0,127,255}));
end New_v4;
