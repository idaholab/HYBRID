...
model Mass_Controlled_System
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.MS MoistSep3(V_MS=0.6, eta=0.227)
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor8(
    m_flow_nom=54.86,
    ref_Eperkg=1.245e5,
    alpha=alphar8,
    A_flow=Ar8,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator8(
    isenthalpic=true,
    alpha=alphas8,
    A_flow=As8,
    ro=ros8,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor7(
    m_flow_nom=55.13,
    ref_Eperkg=7.919e4,
    alpha=alphar7,
    A_flow=Ar7,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator7(
    isenthalpic=true,
    alpha=alphas7,
    A_flow=As7,
    ro=ros7,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.MS MoistSep2(V_MS=0.25, eta=0.19)
    annotation (Placement(transformation(extent={{46,18},{58,30}})));
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor6(
    m_flow_nom=56.18,
    ref_Eperkg=2.55e4,
    alpha=alphar6,
    A_flow=Ar6,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator6(
    v_the_init=vthes6,
    isenthalpic=true,
    alpha=alphas6,
    A_flow=As6,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Turbine_Tap turbine_Tap2
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor5(
    m_flow_nom=59.78,
    ref_Eperkg=1.045e5,
    alpha=alphar5,
    A_flow=Ar5,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.MS MoistSep1(V_MS=25, eta=0.17) annotation (
      Placement(transformation(
        extent={{-4,-6},{4,6}},
        rotation=0,
        origin={-88,22})));
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor4(
    m_flow_nom=60.76,
    ref_Eperkg=8.622e4,
    alpha=alphar4,
    A_flow=Ar4,
    ...
    annotation (Placement(transformation(extent={{-38,14},{-30,34}})));
     ...
     NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator4(
    v_the_init=vthes4,
    isenthalpic=true,
    alpha=alphas4,
    A_flow=As4,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Turbine_Tap turbine_Tap1
    annotation (Placement(transformation(extent={{-58,16},{-52,30}})));
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor3(
    m_flow_nom=64.31,
    ref_Eperkg=1.12e5,
    alpha=alphar3,
    A_flow=Ar3,
    ...
    annotation (Placement(transformation(extent={{-74,12},{-66,32}})));
     ...
     NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator3(
    v_the_init=vthes3,
    isenthalpic=true,
    alpha=alphas3,
    A_flow=As3,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Turbine_Tap turbine_Tap(Tap_flow(m_flow(start=-5.237983241487215)))
    annotation (Placement(transformation(extent={{-24,18},{-18,32}})));
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor2(
    m_flow_nom=68.22,
    ref_Eperkg=2.934e5,
    alpha=alphar2,
    A_flow=Ar2,
    ...
    annotation (Placement(transformation(extent={{-102,10},{-94,30}})));
     ...
     NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator2(
    v_the_init=vthes2,
    isenthalpic=true,
    alpha=alphas2,
    A_flow=As2,
  ...
  NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Rotor_Stage Rotor1(
    m_flow_nom=68.22,
    ref_Eperkg=3.493e4,
    alpha=alphar1,
    A_flow=Ar1,
    ...
    annotation (Placement(transformation(extent={{-128,12},{-120,32}})));
     ...
     NHES.Systems.BalanceOfPlant.StagebyStageTurbine.Stator_Stage Stator1(
    v_the_init=vthes1,
    isenthalpic=true,
    alpha=alphas1,
    A_flow=As1,
  ...
  NHES.Systems.BalanceOfPlant.Complete_Secondary.Components.NTU_HX LP(
    NTU=LP_NTU,
    K_tube=17000,
    K_shell=5,
    V_Tube=4.,
  ...
  NHES.Systems.BalanceOfPlant.Complete_Secondary.Components.NTU_HX IP(
    NTU=IP_NTU,
    K_tube=17000,
    K_shell=500,
    V_Tube=5,
  ...
  NHES.Systems.BalanceOfPlant.Complete_Secondary.Components.NTU_HX HP(
    NTU=HP_NTU,
    K_tube=16500,
    K_shell=50,
    V_Tube=5,
  ...
  TRANSFORM.Controls.PI_Control PI6
    annotation (Placement(transformation(extent={{-3,3},{3,-3}},
        rotation=270,
        origin={67,5})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh valveLineartanh3(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=10,
    m_flow_nominal=40)
  ...
  TRANSFORM.Controls.PI_Control PI7 annotation (Placement(transformation(
        ...
        rotation=180,
        origin={61,-19})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh valveLineartanh4(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=10,
    m_flow_nominal=40)
    annotation (Placement(transformation(extent={{80,-6},{86,-12}})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh valveLineartanh5(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=10,
    m_flow_nominal=40) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={121,-25})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh valveLineartanh6(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=10,
    m_flow_nominal=40) annotation (Placement(transformation(
        extent={{-3,-3},{3,3}},
  ...
  TRANSFORM.Fluid.Volumes.MixingVolume volume4(
    ...
    annotation (Placement(transformation(extent={{-6,-6},{6,6}},
        rotation=270,
        origin={52,6})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.SpringBallValve LPTapValve(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    p_spring=pr8out,
    K=500,
    opening_init=0.01,
    tau=0.1) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={21,3})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.SpringBallValve IPTapValve(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    p_spring=pr6out,
    K=4250,
    tau=0.1) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-53,5})));
  Control_and_Distribution.SpringBallValve                            LPTapValveUpper(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    p_spring=pr5out,
    K=2300,
    tau=0.1) annotation (Placement(transformation(
  ...
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance resistance5(R=50000)
    annotation (Placement(transformation(extent={{-4,-6},{4,6}},
        rotation=270,
        origin={52,16})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh TCV(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=450000,
  ...
  TRANSFORM.Fluid.FittingsAndResistances.PressureLoss resistance10(dp0=-2000)
        ...
        rotation=180,
        origin={141,-8})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh TBV(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=10000,
    m_flow_nominal=68.404,
    opening_actual(start=1)) annotation (Placement(transformation(
  ...
  Modelica.Blocks.Sources.Constant const4(k=3.72e6)
    annotation (Placement(transformation(extent={{-4,4},{4,-4}},
        rotation=0,
        origin={-176,4})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLineartanh FCV(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=200000,
    m_flow_nominal=63.5,
    opening_actual(start=1)) annotation (Placement(transformation(
  ...
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLinearTotal DFV(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=250000,
    m_flow_nominal=20,
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a(redeclare package Medium =
        ...
        transformation(extent={{-110,40},{-90,60}}), iconTransformation(extent={
            {-110,40},{-90,60}})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.ValveLinearTotal DFV1(
    redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater,
    dp_nominal=250000,
    m_flow_nominal=20,
    opening_actual(start=0)) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={85,61})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.TemperatureTwoPort_Superheat sensor_T(
      redeclare package Medium = Modelica.Media.Examples.TwoPhaseWater)
  ...
  Modelica.Blocks.Math.Add     add1     annotation (Placement(transformation(
        ...
        rotation=90,
        origin={87,95})));
  NHES.Systems.BalanceOfPlant.Control_and_Distribution.Delay delay1(Ti=10) annotation (
      Placement(transformation(
        extent={{3,-3},{-3,3}},
        rotation=90,
        origin={85,71})));
