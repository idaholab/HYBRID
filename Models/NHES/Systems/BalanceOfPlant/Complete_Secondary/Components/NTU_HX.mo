...
model NTU_HX
  ...
  replaceable package Tube_medium = Modelica.Media.Water.StandardWater annotation(Dialog(tab="General", group="Mediums"));
  replaceable package Shell_medium = Modelica.Media.Water.StandardWater annotation(Dialog(tab="General", group="Mediums"));
  ...
  parameter Modelica.Units.SI.Length dh_Shell=0.0
    ...
    annotation (Dialog(tab="General", group="Sizing"));
  parameter Modelica.Units.SI.Pressure p_start_tube=101325
    annotation (Dialog(tab="Initialization", group="Tube"));
  parameter Modelica.Units.SI.SpecificEnthalpy h_start_tube_inlet=200e3
    annotation (Dialog(tab="Initialization", group="Tube"));
  parameter Modelica.Units.SI.SpecificEnthalpy h_start_tube_outlet=500e3
    annotation (Dialog(tab="Initialization", group="Tube"));
  parameter Modelica.Units.SI.Pressure p_start_shell=1013250
    annotation (Dialog(tab="Initialization", group="Shell"));
  parameter Modelica.Units.SI.SpecificEnthalpy h_start_shell_inlet=1600e3
    annotation (Dialog(tab="Initialization", group="Shell"));
  parameter Modelica.Units.SI.SpecificEnthalpy h_start_shell_outlet=600e3
    annotation (Dialog(tab="Initialization", group="Shell"));
  parameter Modelica.Units.SI.Pressure dp_init_tube=500000
    annotation (Dialog(tab="Initialization", group="Tube"));
  parameter Modelica.Units.SI.Pressure dp_init_shell=10000
    annotation (Dialog(tab="Initialization", group="Shell"));
  parameter Modelica.Units.SI.Pressure dp_general=100
    annotation (Dialog(tab="Initialization", group="Both"));
  parameter Modelica.Units.SI.Power Q_init=0;
  parameter Real Cr_init = 0.0 annotation(Dialog(tab = "Initialization", group = "Heat Transfer"));
  parameter Real deltaX_t_init = 0.0 annotation(Dialog(tab = "Initialization", group = "Heat Transfer"));
  parameter Real deltaX_s_init = 0.5 annotation(Dialog(tab = "Initialization", group = "Heat Transfer"));
  parameter Modelica.Units.SI.Time tau=1;

  parameter Modelica.Units.SI.MassFlowRate m_start_tube=66.3
    annotation (Dialog(tab="Initialization", group="Tube"));
  parameter Modelica.Units.SI.MassFlowRate m_start_shell=10
    annotation (Dialog(tab="Initialization", group="Shell"));
...
public
  ...
  BalanceOfPlant.Control_and_Distribution.LossResistance Tube_dp(K=K_tube,
      dp_init=dp_init_tube)
    annotation (Placement(transformation(extent={{-16,30},{-36,50}})));
  BalanceOfPlant.Control_and_Distribution.LossResistance Shell_dp(K=K_shell,
      dp_init=dp_init_shell)
