...
equation
 ...
 //   reinit(Price,PriceList[value]);
  ...
  connect(SecSide.port_b, Reactor.port_a) annotation (Line(points={{72.88,-25.6},
          {48,-25.6},{48,-26},{-34.9091,-26},{-34.9091,-24.8308}},
                                                             color={0,127,255}));
  connect(SecSide.port_a, Reactor.port_b) annotation (Line(points={{72.88,4.1},
          {44,4.1},{44,19.8462},{-34.9091,19.8462}},
                                                 color={0,127,255}));
  annotation (
