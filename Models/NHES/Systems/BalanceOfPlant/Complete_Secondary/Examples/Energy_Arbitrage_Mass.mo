...
protected
  ...
  Mass_Controlled_System_CS_ED_Enabled                      SecSide(
    ...
    annotation (Placement(transformation(extent={{62,-74},{240,64}})));
equation
  ...
  connect(SecSide.port_b, Reactor.port_a) annotation (Line(points={{62,-39.5},{
          24,-39.5},{24,-10.8308},{13.0909,-10.8308}},color={0,127,255}));
  connect(SecSide.port_a, Reactor.port_b) annotation (Line(points={{62,29.5},{
          24,29.5},{24,33.8462},{13.0909,33.8462}},color={0,127,255}));
  annotation (
