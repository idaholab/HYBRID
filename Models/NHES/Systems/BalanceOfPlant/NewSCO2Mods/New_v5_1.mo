...
model New_v5_1
  ...
  GasTurbine.Compressor.Compressor_v2   Comp2(
    ...
    eta0=0.9,
    PR0=2.39,
    w0=1783) annotation (Placement(transformation(extent={{-192,11},{-166,33}})));
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T Comp1In(
    ...
    m_flow=1084,
    T=372.25,
    nPorts=1) annotation (Placement(transformation(extent={{136,-98},{150,-84}})));
...
equation
  ...
  connect(Comp1.inlet, Comp1In.ports[1])
    annotation (Line(points={{173.2,-91.2},{164,-91.2},{164,-91},{150,-91}}, color={0,127,255}));
  ...
  connect(Comp2.inlet, Cooler.port_b) annotation (Line(points={{-186.8,30.8},{-208,30.8},{-208,-44}}, color={0,127,255}));
  ...
  connect(Comp2.outlet, HX2_sensor_TubeIn.port_a)
    annotation (Line(points={{-171.2,30.8},{-48,30.8},{-48,34},{60,34},{60,21},{56,21}}, color={0,127,255}));
