within NHES.Systems.PrimaryHeatSystem.Westinghouse4LoopPWR.BaseClasses;
partial model Partial_SubSystem
  import NHES;

  extends NHES.Systems.PrimaryHeatSystem.BaseClasses.Partial_SubSystem;
  ...
  Modelica.Blocks.Sources.RealExpression FuelConsumption
...
equation
  ...
  connect(sensorBus.m_flow_fuelConsumption, FuelConsumption.y)
      annotation (Line(
      points={{-29.9,100.1},{-29.9,100.1},{-80,100.1},{-80,114},{-83.4,114}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
