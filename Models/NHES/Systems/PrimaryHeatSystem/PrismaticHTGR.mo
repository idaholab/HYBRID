...
package PrismaticHTGR
  ...
  package Examples
    ...
    model Reactor_Test
      ...
      Reactor RX(redeclare replaceable
          PrismaticHTGR.CS.CS_Texit_rhoInset                        CS)
        annotation (Placement(transformation(extent={{-40,-40},{40,40}})));
    equation
    ...
    model TES_Test
       extends Modelica.Icons.Example;
        ...
        redeclare PrismaticHTGR.Examples.CS_TES
                                        CS,
        ...
        redeclare package Storage_Medium =
            NHES.Media.SolarSaltSS60.ConstantPropertyLiquidSolarSalt,
    ...
    model Reactor_Testspeed
      ...
      ReactorCRspeed
          ...
          PrismaticHTGR.CS.CS_Texitspeed                        CS, controlRod(
  ...
  package Components
    ...
    model Core
      ...
      Fluid.Utilities.FlowMultiplier       flowMultiplierCoout(redeclare
          package Medium = Medium, capacityScaler=geometry.nChannels[3])
        annotation (Placement(transformation(extent={{26,-70},{46,-50}})));
      Fluid.Utilities.FlowMultiplier       flowMultiplierCeout(redeclare
          package Medium = Medium, capacityScaler=geometry.nChannels[1])
  ...
  model Reactor
    ...
    extends BaseClasses.Partial_SubSystem_A(
      redeclare replaceable PrismaticHTGR.CS.CS_Texit CS,
