...
model SMR_Test
  ...
  Components.SMR_Tave_enthalpy nuScale_Tave_enthalpy(
    ...
    port_b_nominal(
      ...
      h=2997670))
    annotation (Placement(transformation(extent={{-64,-52},{32,64}})));
...
equation
  connect(boundary2.ports[1],nuScale_Tave_enthalpy. port_a) annotation (
      Line(points={{52,-2},{36,-2},{36,-1.13846},{33.7455,-1.13846}}, color=
         {0,127,255}));
  connect(boundary3.ports[1],nuScale_Tave_enthalpy. port_b) annotation (
      Line(points={{50,29},{36,29},{36,28.3077},{33.7455,28.3077}}, color={
          0,127,255}));
  annotation (
