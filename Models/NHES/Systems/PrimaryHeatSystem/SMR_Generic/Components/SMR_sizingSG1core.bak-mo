...
extends BaseClasses.Partial_SubSystem_A(
    ...
    port_b(redeclare package Medium = ThermoPower.Water.StandardWater),
    port_a(redeclare package Medium = ThermoPower.Water.StandardWater));
  ...
  Modelica.Fluid.Sensors.Temperature Tcore_exit(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{-106,-74},{-94,-62}})));
  ...
  Modelica.Fluid.Sensors.Temperature Tcore_inlet(redeclare package Medium =
        ThermoPower.Water.StandardWater)
    annotation (Placement(transformation(extent={{-106,-110},{-92,-122}})));
  TRANSFORM.Fluid.FittingsAndResistances.PipeLoss pipeLoss(
    ...
    redeclare model Geometry =
        ...
        (dimension_avg=0.4),
    K_ab=650.0) annotation (Placement(transformation(extent={{-14,26},{6,46}})));
  ...
  Modelica.Fluid.Sensors.Temperature temperature2(redeclare package Medium =
        ThermoPower.Water.StandardWater)
    annotation (Placement(transformation(extent={{40,-38},{54,-50}})));
...
equation
  ...
  connect(DownComer.port_a, STHX.port_b_shell)
    annotation (Line(points={{22,-42},{22,-18},{21.94,-18}},
                                                           color={0,127,255}));
  connect(pipeLoss.port_b, STHX.port_a_shell) annotation (Line(points={{6,36},{
          21.94,36},{21.94,6}},   color={0,127,255}));
  connect(temperature2.port, STHX.port_a_tube) annotation (Line(points={{47,-38},
          {46,-38},{46,-30},{32,-30},{32,-18},{27,-18}},
                                                     color={0,127,255}));
  connect(temperature3.port, STHX.port_b_tube)
    annotation (Line(points={{42,52},{27,52},{27,6}},  color={0,127,255}));
  ...
  connect(massFlowRate1.port_b, STHX.port_a_tube)
    annotation (Line(points={{48,-73},{27,-73},{27,-18}},color={0,127,255}));

  connect(STHX.port_b_tube, port_b) annotation (Line(points={{27,6},{27,20},{
  ...
  connect(actuatorBus.reactivity_ControlRod, CR_reactivity.u) annotation (
      ...
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(Tcore_inlet.port, core.port_a) annotation (Line(points={{-99,-110},
          {-100,-110},{-100,-104},{-76,-104},{-76,-100}}, color={0,127,255}));
  connect(Tcore_exit.port, Lower_Riser.port_a) annotation (Line(points={{-100,
          -74},{-76,-74},{-76,-64}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{100,140}}),
                         graphics={Bitmap(extent={{-114,-90},{110,90}},
            fileName=
