...
<span style=\"color: #006400;\">&nbsp;&nbsp;&nbsp;&nbsp;System&nbsp;Transient&nbsp;Analysis,&rdquo;&nbsp;STD-AR-06-04,&nbsp;2007.</span></pre>
  ...
  model Data_GenericModule_NuScale
    ...
    parameter SI.MassFlowRate m_flow_secondary = 84.0 "Secondary Side Flow";
    ...
    //Pressurizer Data
    parameter SI.Pressure P_setpoint_pressurizer=127.5e5;
  ...
  end Data_GenericModule_NuScale;

  record DataInitial_NS
