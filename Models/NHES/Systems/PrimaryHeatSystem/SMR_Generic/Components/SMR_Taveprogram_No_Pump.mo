...
equation
  ...
  connect(STHX.port_a_tube, Feed_Enthalpy.port) annotation (Line(points={{27,
          -12},{40,-12},{40,-26},{55,-26}}, color={0,127,255}));
  connect(massFlowRate1.port_a, port_a) annotation (Line(points={{66,-73},{74,
          -73},{74,-72},{78,-72},{78,-6},{104,-6}}, color={0,127,255}));
  connect(sensorBus.T_exit_SG, temperature3.T) annotation (Line(
      points={{-30,100},{-30,88},{54,88},{54,44},{47.6,44},{47.6,45}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
