...
model CS_SMR_Tave_0721
 ...
 input SI.Power W_Setpoint "Turbine Setpoint" annotation(Dialog(group="Inputs"));
  ...
  Modelica.Blocks.Sources.Constant S_external(k=0)
    annotation (Placement(transformation(extent={{152,-114},{132,-94}})));
  Modelica.Blocks.Sources.Constant speedPump(k=1500)
    annotation (Placement(transformation(extent={{152,-144},{132,-124}})));
...
equation
  ...
  connect(actuatorBus.Q_S_External, Q_flow_liquidHeater.y) annotation (Line(
      points={{30.1,-99.9},{30.1,-164},{131,-164}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(actuatorBus.Q_flow_liquidHeater, S_external.y) annotation (Line(
      points={{30.1,-99.9},{32,-99.9},{32,-104},{131,-104}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(actuatorBus.reactivity_Other, Other_Reactivity.y) annotation (Line(
      points={{30.1,-99.9},{28,-99.9},{28,-70},{131,-70},{131,-74}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(actuatorBus.speedPump, speedPump.y) annotation (Line(
      points={{30.1,-99.9},{30.1,-134},{131,-134}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
