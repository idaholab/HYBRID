...
model CS_SMR_highfidelity "Primary System Control System."
 ...
 input Real demand "Demand Change from nominal 1.0=nominal power" annotation(Dialog(group="Inputs"));
  ...
  SupportComponent.Control_Rod_Model control_Rod_Model_Simple(rho_Boron=-1000,
  ...
  TRANSFORM.Blocks.RealExpression W_balance
    annotation (Placement(transformation(extent={{-224,74},{-204,94}})));
  TRANSFORM.Blocks.RealExpression m_flowconsumption
    annotation (Placement(transformation(extent={{-224,60},{-204,80}})));
  TRANSFORM.Blocks.RealExpression SG_Inlet_enthalpy
    annotation (Placement(transformation(extent={{-224,-22},{-204,-2}})));
  TRANSFORM.Blocks.RealExpression p_pressurizer
    annotation (Placement(transformation(extent={{-224,-6},{-204,14}})));
  ...
  TRANSFORM.Blocks.RealExpression SG_Outlet_Enthalpy
    annotation (Placement(transformation(extent={{-224,-38},{-204,-18}})));
  TRANSFORM.Blocks.RealExpression T_SG_Exit
    annotation (Placement(transformation(extent={{-224,-52},{-204,-32}})));
equation
