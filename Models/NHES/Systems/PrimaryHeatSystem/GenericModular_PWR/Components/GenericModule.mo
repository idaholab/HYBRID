within NHES.Systems.PrimaryHeatSystem.GenericModular_PWR.Components;
model GenericModule

  extends BaseClasses.Partial_SubSystem_A(
    redeclare replaceable
      NHES.Systems.PrimaryHeatSystem.GenericModular_PWR.CS.CS_Dummy CS,
    redeclare Data.Data_GenericModule data,
    replaceable package Medium = Modelica.Media.Water.StandardWater,
    port_a_nominal(
      p=data.p_start_STHX_tube[1],
      h=data.h_steam_cold,
      m_flow=data.m_flow_steam),
    port_b_nominal(p=data.p_steam, h=data.h_start_STHX_tube[end]));
  ...
  TRANSFORM.Fluid.Volumes.SimpleVolume inletPlenum(redeclare package Medium =
    ...
    p_start=data.p_start_inletPlenum,
    T_start=data.T_start_inletPlenum)
  ...
  TRANSFORM.Fluid.Pipes.GenericPipe_MultiTransferSurface hotLeg(exposeState_a=false,
    ...
    redeclare model Geometry =
        ...
        nV=2,
        angle=1.5707963267949),
    ps_start=data.p_start_hotLeg,
    Ts_start=data.T_start_hotLeg,
  ...
  TRANSFORM.Nuclear.CoreSubchannels.Regions_3 core(
    ...
    exposeState_a=false,
    exposeState_b=false,
    Ts_start(displayUnit="degC") = data.T_start_core_coolantSubchannel,
    ps_start=data.p_start_core_coolantSubchannel,
    Ts_start_1(displayUnit="K") = data.Ts_start_core_fuelModel_region_1,
    Ts_start_2(displayUnit="K") = data.Ts_start_core_fuelModel_region_2,
    Ts_start_3(displayUnit="K") = data.Ts_start_core_fuelModel_region_3,
  ...
  TRANSFORM.Fluid.Volumes.SimpleVolume outletPlenum(
    ...
    redeclare model Geometry =
        ...
        angle=1.5707963267949),
    p_start=data.p_start_outletPlenum,
    T_start=data.T_start_outletPlenum)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-40,-10})));
  TRANSFORM.Fluid.Pipes.GenericPipe_MultiTransferSurface coldLeg(
    ...
    redeclare model Geometry =
        ...
        angle=-1.5707963267949,
        nSurfaces=2),
    ps_start=data.p_start_coldLeg,
    Ts_start=data.T_start_coldLeg,
  ...
  TRANSFORM.HeatExchangers.GenericDistributed_HX STHX(
    ...
    Ts_wall_start=data.T_start_STHX_tubeWall)              annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={24,2})));
