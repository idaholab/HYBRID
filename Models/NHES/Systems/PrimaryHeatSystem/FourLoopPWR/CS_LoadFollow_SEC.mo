...
model CS_LoadFollow_SEC "Core: Tavg | Boiler Level: dT_avg"
  ...
  extends
    NHES.Systems.PrimaryHeatSystem.FourLoopPWR.BaseClasses.Partial_ControlSystem;

  parameter Modelica.Units.SI.Time delayStart_SGpump=0
    "Delay SG recirc pump control";
  parameter Modelica.Units.SI.Time delayStart_CR=0
    "Delay control rod reactivity control";
  parameter Modelica.Units.SI.Time delayStart_PZRheater=0
    "Delay pressurizer heater control";
  ...
  NHES.Systems.PrimaryHeatSystem.FourLoopPWR.Data.Data_Basic data(Q_total_th=
        3100e6)
