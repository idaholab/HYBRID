...
model NSSS_SEC_LoadFollow
  import TRANSFORM;
  extends
    NHES.Systems.PrimaryHeatSystem.FourLoopPWR.BaseClasses.Partial_SubSystem_A(
    replaceable package Medium = Modelica.Media.Water.StandardWater,
    allowFlowReversal=system.allowFlowReversal,
    redeclare replaceable
      NHES.Systems.PrimaryHeatSystem.FourLoopPWR.CS_LoadFollow_SEC CS,
    redeclare replaceable NHES.Systems.PrimaryHeatSystem.FourLoopPWR.ED_Default
      ED,
    port_a_nominal(
      p=data.p_shellSide,
...
protected
  final parameter Modelica.Units.SI.Pressure p_units=1;
...
public
  ...
  TRANSFORM.Fluid.Sensors.Temperature T_Steam_Inlet(redeclare package Medium =
        Modelica.Media.Water.StandardWater)
    annotation (Placement(transformation(extent={{94,60},{86,68}})));
  TRANSFORM.Fluid.Sensors.Pressure sensor_p(redeclare package Medium = Medium)
    annotation (Placement(transformation(extent={{106,56},{126,76}})));
equation
  ...
  connect(T_Steam_Inlet.port, port_b) annotation (Line(points={{90,60},{90,54},
          {92,54},{92,40},{100,40}}, color={0,127,255}));
  connect(sensor_p.port, port_b) annotation (Line(points={{116,56},{104,56},{
          104,54},{92,54},{92,40},{100,40}}, color={0,127,255}));
  annotation (
