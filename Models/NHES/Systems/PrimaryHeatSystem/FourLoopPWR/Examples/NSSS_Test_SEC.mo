...
model NSSS_Test_SEC
  ...
  NHES.Systems.PrimaryHeatSystem.FourLoopPWR.Components.NSSS_SEC_LoadFollow PHS(
      redeclare NHES.Systems.PrimaryHeatSystem.FourLoopPWR.CS_LoadFollow_SEC CS)
