...
model CS_SteadyNominalPower "Core: Tavg | Boiler Level: dT_avg | Steady State"
  ...
  Modelica.Blocks.Sources.Constant T_avg_nominal(k=data.T_core_avg) "576"
  ...
  TRANSFORM.Controls.LimPID PID_CR(
    ...
    Ti=5) annotation (Placement(transformation(extent={{30,130},{50,110}})));
...
equation
  ...
  connect(sensorBus.T_Core_Inlet, add.u1) annotation (Line(
      points={{-29.9,-99.9},{-29.9,-99.9},{-180,-99.9},{-180,186},{-92,186}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorBus.T_Core_Outlet, add.u2) annotation (Line(
      points={{-29.9,-99.9},{-29.9,-99.9},{-180,-99.9},{-180,174},{-92,174}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
