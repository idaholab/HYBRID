...
model Pebble_Bed_CC_Test_IAEA_Demonstration
  ...
  TRANSFORM.Fluid.Machines.SteamTurbine steamTurbine(
    ...
    T_nominal=433.15)
    annotation (Placement(transformation(extent={{-60,-58},{-32,-30}})));
  ...
  TRANSFORM.Electrical.PowerConverters.Generator_Basic generator
    annotation (Placement(transformation(extent={{-16,-56},{10,-30}})));
...
equation
  ...
  connect(steamTurbine.shaft_b,generator. shaft) annotation (Line(points={{-32,-44},
          {-32,-43.13},{-16.13,-43.13}},                       color={0,0,0}));
  ...
  connect(Water_T3.port_a, Pebble_Bed_HTGR.combined_cycle_port_b) annotation (
      Line(points={{-92,-23},{-92,-28},{-64,-28},{-64,-24},{-33.04,-24},{-33.04,
          -20}},                                         color={0,127,255}));
  ...
  connect(steamTurbine.portHP, dual_Pipe_Model_Two_HTFs.Discharge_Outlet)
    annotation (Line(points={{-60,-35.6},{-66,-35.6},{-66,-16},{-65.76,-16},{
          -65.76,-11.6}},
                   color={0,127,255}));
...
end Pebble_Bed_CC_Test_IAEA_Demonstration;
