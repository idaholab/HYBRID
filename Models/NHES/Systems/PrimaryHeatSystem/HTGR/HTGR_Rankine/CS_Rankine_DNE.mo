...
model CS_Rankine_DNE
  ...
  BalanceOfPlant.Turbine.BaseClasses.StagebyStageTurbineSecondary.Control_and_Distribution.Timer
...
equation
  ...
  connect(sensorBus.thermal_power, CR1.u_m) annotation (Line(
      points={{-30,-100},{-30,-36},{-32,-36}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(const10.y, CR1.u_s)
    annotation (Line(points={{-57,-28},{-50,-28},{-50,-24},{-44,-24}},
                                                   color={0,0,127}));
  connect(actuatorBus.CR_Reactivity, add3.y) annotation (Line(
      points={{30,-100},{32,-100},{32,-46},{27,-46}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(add3.u2, CR.y) annotation (Line(points={{4,-52},{-14,-52},{-14,-46},{
          -19,-46}}, color={0,0,127}));
  connect(add3.u1, CR1.y) annotation (Line(points={{4,-40},{-14,-40},{-14,-24},
          {-21,-24}}, color={0,0,127}));
