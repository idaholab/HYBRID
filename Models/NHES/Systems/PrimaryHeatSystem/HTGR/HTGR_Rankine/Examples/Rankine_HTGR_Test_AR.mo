...
model Rankine_HTGR_Test_AR
  extends Modelica.Icons.Example;
  BalanceOfPlant.Turbine.HTGR_Rankine_Cycle_AR hTGR_Rankine_Cycle(redeclare
  ...
  Components.HTGR_PebbleBed_Primary_Loop_STHX hTGR_PebbleBed_Primary_Loop(
      redeclare
      NHES.Systems.PrimaryHeatSystem.HTGR.HTGR_Rankine.CS_Rankine_Primary_AR CS)
