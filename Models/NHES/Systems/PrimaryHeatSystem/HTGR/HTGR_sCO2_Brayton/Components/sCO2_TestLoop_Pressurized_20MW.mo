...
model sCO2_TestLoop_Pressurized_20MW
  extends BaseClasses.Partial_SubSystem_A(
    redeclare replaceable CS_sCO2_Brayton_20MW CS,
  ...
  Nuclear.CoreSubchannels.Pebble_Bed_New
    ...
    Q_fission_input(displayUnit="MW") = 20000000,
    alpha_fuel=-5e-5,
    alpha_coolant=0.0,
    p_b_start(displayUnit="bar") = 3915000,
    Q_nominal(displayUnit="MW") = 20000000,
    SigmaF_start=26,
...
end sCO2_TestLoop_Pressurized_20MW;
