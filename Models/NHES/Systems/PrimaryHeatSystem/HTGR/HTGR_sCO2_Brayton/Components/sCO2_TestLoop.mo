...
model sCO2_TestLoop
  ...
  Modelica.Blocks.Sources.RealExpression Thermal_Power1(y=1.0)
    annotation (Placement(transformation(extent={{-6,-7},{6,7}},
        rotation=180,
        origin={12,60})));
  Modelica.Blocks.Sources.RealExpression realExpression(y=core.Q_total.y) annotation (Placement(transformation(extent={{120,104},{140,124}})));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=Turbine.Wt) annotation (Placement(transformation(extent={{120,74},{140,94}})));
  Modelica.Blocks.Interfaces.RealOutput CorePower annotation (Placement(transformation(extent={{174,104},{194,124}})));
  Modelica.Blocks.Interfaces.RealOutput TurbinePower annotation (Placement(transformation(extent={{176,74},{196,94}})));
initial equation

equation
  eff = Turbine.Wt/core.Q_total.y; //This is not really the efficiency of the overall system.
  ...
  connect(CorePower, realExpression.y) annotation (Line(points={{184,114},{141,114}}, color={0,0,127}));
  connect(TurbinePower, realExpression1.y) annotation (Line(points={{186,84},{141,84}}, color={0,0,127}));
  connect(TurbinePower, TurbinePower) annotation (Line(points={{186,84},{186,84}}, color={0,0,127}));
