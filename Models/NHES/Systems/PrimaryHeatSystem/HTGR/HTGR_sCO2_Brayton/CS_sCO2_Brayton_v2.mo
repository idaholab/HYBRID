...
model CS_sCO2_Brayton_v2
  ...
  HTGR_sCO2_Brayton.Data.Data_CS data(T_Rx_Exit_Ref=1123.15, m_flow_nom=296) annotation (Placement(transformation(extent={{-86,50},{-66,70}})));
