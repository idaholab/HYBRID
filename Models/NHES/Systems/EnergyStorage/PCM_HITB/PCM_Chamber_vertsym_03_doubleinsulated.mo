...
model PCM_Chamber_vertsym_03_doubleinsulated "Contained PCM chamber generalizable interact with a heat pipe 
...
//  Real dAs_2[nR,nTheta,nZ];
  ...
  Modelica.Blocks.Interfaces.RealInput u annotation (Placement(transformation(
          extent={{100,-20},{60,20}}), iconTransformation(extent={{100,-20},{60,
            20}})));
initial equation
...
end PCM_Chamber_vertsym_03_doubleinsulated;
