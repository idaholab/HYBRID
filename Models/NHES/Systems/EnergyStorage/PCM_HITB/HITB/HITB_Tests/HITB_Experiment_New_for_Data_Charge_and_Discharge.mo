...
model HITB_Experiment_New_for_Data_Charge_and_Discharge
...
//  Modelica.Units.SI.Power Q_loss;
  ...
  Components.PCM_Volume.PCM_Chamber_vertsym_03_doubleinsulated PCM_Core(
    ...
    hc_air=hc_air,
    T_Init=714.15,
    Q_heat_trace=HT_Battery.y[1]*ones(11, nV_Z)/(11*nV_Z*2),
  ...
  Modelica.Blocks.Sources.CombiTimeTable signal_position_upper(table=[0,0.5;
        1.0,0.5; 121000,0.5; 125000,0.0; 432000,0.0])
    annotation (Placement(transformation(extent={{88,92},{108,112}})));
  Modelica.Blocks.Sources.CombiTimeTable HT_Upper(table=[0,0; 151000,0; 151400,
        1000; 171900,1000; 172300,0; 432000,0])
  ...
  Modelica.Blocks.Sources.CombiTimeTable signal_position_lower(table=[0,0.5;
        1.0,0.5; 121000,0.5; 125000,0.0; 432000,0.0])
    annotation (Placement(transformation(extent={{86,-54},{106,-34}})));
  Modelica.Blocks.Sources.CombiTimeTable HT_Lower(table=[0,0; 151000,0; 151400,
        1000; 271900,1000; 272300,0; 432000,0])
    annotation (Placement(transformation(extent={{88,-84},{108,-64}})));
  Modelica.Blocks.Sources.CombiTimeTable HT_Battery(table=[0,0; 151000,0;
        151400,750; 171900,750; 172300,0; 432000,0])
...
//  A_Cyl_HITB = HITB_Main.geometry.crossAreas_2[:,1];
  ...
  */
  ...
  connect(Upper_Guide_Tube.port_battery, PCM_Core.port_b[:, 1]) annotation (
      Line(points={{118.88,35.22},{135.44,35.22},{135.44,23.16},{150.14,23.16}},
        color={191,0,0}));
  connect(Lower_Guide_Tube.port_battery, PCM_Core.port_b[:, 2]) annotation (
      Line(points={{116.24,6.98},{133.12,6.98},{133.12,23.16},{150.14,23.16}},
        color={191,0,0}));
...
end HITB_Experiment_New_for_Data_Charge_and_Discharge;
