...
model HITB_Experiment_03_06 "Attempt 03 at HITB experiment."
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer hc_air = 0.00025;
  ...
  Modelica.Blocks.Sources.Trapezoid signal_Q_DHX1(
    ...
    period=86400,
    startTime=43000)
    annotation (Placement(transformation(extent={{230,28},{250,48}})));
  ...
  Components.PCM_Volume.PCM_Chamber_vertsym_03 PCM_Core(nZ=nV_Z, hc_air=hc_air)
...
equation
  ...
  */
  ...
  connect(signal_Position.u2, signal_Q_DHX1.y)
    annotation (Line(points={{258,38},{251,38}}, color={0,0,127}));
