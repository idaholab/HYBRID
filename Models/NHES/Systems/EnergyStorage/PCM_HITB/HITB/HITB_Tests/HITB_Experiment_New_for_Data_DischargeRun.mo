...
model HITB_Experiment_New_for_Data_DischargeRun
 ...
 // Modelica.Units.SI.Area A_Cyl_HITB[nV_Rh];
  ...
  parameter Modelica.Units.SI.Length t_insulation = 0.02 "Thickness of each layer of insulation.";
  parameter Real density_multiplier = 0.6;
...
//  Modelica.Units.SI.Power Q_loss;
  ...
  Components.PCM_Volume.PCM_Chamber_vertsym_03_doubleinsulated PCM_Core(
    ...
    T_Init=781.15,
    T_Init_Wall=773.15,
    T_Init_Insulation_Inner=523.15,
    T_Init_Insulation_Outer=423.15,
    T_Init_HT=773.15,
    Q_heat_trace=0*ones(11, nV_Z),
    redeclare package Insulation_Material_Inner =
        HITB.PCM_Materials.Insulator_aerogel,
    redeclare package Insulation_Material_Outer = HITB.PCM_Materials.Insulator,
    redeclare package PCM_Material =
        HITB.PCM_Materials.PCM_HITB_2_Sin_reduced_density_fix)
    annotation (Placement(transformation(extent={{48,-66},{-50,36}})));

  Modelica.Blocks.Sources.CombiTimeTable signal_position_upper(table=[0,1.0; 120000,
        1.0; 121000,1.0; 125000,1.0; 432000,1.0])
    annotation (Placement(transformation(extent={{-98,92},{-78,112}})));
  Modelica.Blocks.Sources.CombiTimeTable HT_Upper(table=[0,0; 105500,0; 105600,0;
        125000,0; 125500,0; 432000,0])
  ...
  Components.Guide_Tube Lower_Guide_Tube(
    ...
    annotation (Placement(transformation(extent={{-46,-58},{10,-16}})));
  ...
  Components.Guide_Tube Upper_Guide_Tube(
    ...
    annotation (Placement(transformation(extent={{-56,36},{16,-26}})));

  Components.Heat_Pipe_New heat_Pipe_New(
    nV_Z=nV_Zh,
    T_init=698.15,
    r_insulation=t_insulation,
  ...
  Modelica.Blocks.Sources.CombiTimeTable HT_Lower(table=[0,0; 105500,0; 105600,0;
        125000,0; 125500,0; 432000,0])
...
end HITB_Experiment_New_for_Data_DischargeRun;
