...
model HITB_Experiment_03_02
  "Attempt 02 at HITB experiment. Initially, the heat pipe will be assumed to be isothermal."
  import Unnamed;
  ...
  Components.PCM_Volume.PCM_Chamber_nosym PCM_Core(nZ=nV_Z, drs_one=1/1000*{25,
        25,23.66,142.26 - 73.66,27.76,25,25,25,25,35.287 - 12.538})
    annotation (Placement(transformation(extent={{130,-66},{228,36}})));
  ...
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder PCM_Pipe_Wall2
                                                                         [nV_Z](
    redeclare package Material = TRANSFORM.Media.Solids.SS316,
    T_start=723.15,
    length=l_HITB,
    ...
    exposeState_a=false,
    exposeState_b=false)
    annotation (Placement(transformation(extent={{86,-232},{106,-212}})));
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder HITB_Wick2[nV_Zh](
    length=l_HITB,
    r_inner=R_Na,
    r_outer=R_Wick,
    redeclare package Material = HITB.PCM_Materials.Lambda_wick_d_5000_cp_1000,
    exposeState_a=false,
    exposeState_b=true)
    annotation (Placement(transformation(extent={{-74,-232},{-54,-212}})));

  TRANSFORM.HeatAndMassTransfer.DiscritizedModels.Conduction_2D HITB_Main2(
    redeclare package Material = HITB.PCM_Materials.Sodium_New (k_eff_mult=60),
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    T_a1_start=723.15,
    T_b1_start=723.15,
  ...
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.HeatFlow CHX2
                                                                    [nV_Zh](use_port=
       true)
    annotation (Placement(transformation(extent={{38,-170},{18,-150}})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.HeatFlow DHX2
                                                                    [nV_Zh](use_port=
       true)
    annotation (Placement(transformation(extent={{44,-298},{24,-278}})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature Air_CHX_Side4
                                                                                [nV_Zh]
    annotation (Placement(transformation(extent={{76,-188},{56,-168}})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature Air_DHX_Side2
                                                                                [nV_Zh](T=293.15)
    annotation (Placement(transformation(extent={{78,-276},{58,-256}})));
  TRANSFORM.HeatAndMassTransfer.Resistances.Heat.Convection convection8
                                                                      [nV_Zh](
      surfaceArea=SA_DHX_Side, alpha=25e-4)
    annotation (Placement(transformation(extent={{42,-276},{22,-256}})));
  TRANSFORM.HeatAndMassTransfer.Resistances.Heat.Convection convection9[nV_Zh](
      surfaceArea=SA_CHX_Side, alpha=25e-4)
    annotation (Placement(transformation(extent={{36,-188},{16,-168}})));
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder HITB_Wall2
                                                                     [nV_Zh](
    length=l_HITB,
    r_inner=R_Wick,
    r_outer=R_HITB,
    exposeState_a=false,
    exposeState_b=true)
    annotation (Placement(transformation(extent={{-46,-232},{-26,-212}})));
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder HITB_PCM_Gap2
                                                                        [nV_Z,
    nV_Zh](
    redeclare package Material =
        TRANSFORM.Media.Solids.CustomSolids.Lambda_0_33_d_1200_cp_500,
  ...
  Modelica.Blocks.Sources.RealExpression Q_CHX_Input2
                                                    [nV_Zh](y=Q_CHX/nV_Zh)
    annotation (Placement(transformation(extent={{66,-170},{46,-150}})));
  Modelica.Blocks.Sources.RealExpression Q_DHX_Input2
                                                    [nV_Zh](y=Q_DHX/nV_Zh)
    annotation (Placement(transformation(extent={{74,-298},{54,-278}})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Collector collector4
                                                                           [nV_Zh](n=nV_Z
         + 4)
    annotation (Placement(transformation(extent={{2,-232},{-18,-212}})));
  TRANSFORM.HeatAndMassTransfer.Resistances.Heat.Convection Area_correction_convection2
                                                                                      [nV_Z,
    nV_Zh](surfaceArea=SA_PCM_HITB, alpha=1e10)
    annotation (Placement(transformation(extent={{34,-232},{14,-212}})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Collector collector5[nV_Z](n=nV_Zh)
               annotation (Placement(transformation(extent={{64,-232},{84,-212}})));
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall simpleWall5[nV_Rh](
    th=t_PCM_wall,
    surfaceArea=A_Cyl_HITB,
    T_start=723.15) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-100,-174})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature Air_PCM_Axial5[nV_Rh](T=293.15)
                annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={-100,-112})));
  TRANSFORM.HeatAndMassTransfer.Resistances.Heat.Convection convection10
                                                                       [nV_Rh](
      surfaceArea=A_Cyl_HITB, alpha=25e-4) annotation (Placement(transformation(
        extent={{10,10},{-10,-10}},
        rotation=90,
        origin={-100,-144})));
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall simpleWall6[nV_Rh](
    th=t_PCM_wall,
    surfaceArea=A_Cyl_HITB,
    T_start=723.15) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={-98,-254})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature Air_PCM_Axial6[nV_Rh](T=293.15)
                annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-98,-310})));
  TRANSFORM.HeatAndMassTransfer.Resistances.Heat.Convection convection11
                                                                       [nV_Rh](
      surfaceArea=A_Cyl_HITB, alpha=25e-4) annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={-98,-282})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Adiabatic Air_CHX_Side5[nV_Zh]
    annotation (Placement(transformation(extent={{-134,-232},{-114,-212}})));
protected
  ...
  */
  ...
  for i in 1:nV_Zh loop //i will indicate PCM location
    for j in 1:nV_Z loop //j will indicate HITB location
        connect(Area_correction_convection2[j, i].port_b, collector4[i].port_a[j + 2])
    annotation (Line(points={{17,-222},{2,-222}}, color={191,0,0}));
  ...
  connect(PCM_Core.port_b[:, 1], PCM_Pipe_Wall.port_b) annotation (Line(points={
          {185.86,-6.84},{185.86,34},{124,34},{124,-8},{106,-8}}, color={191,0,0}));
  ...
  connect(PCM_Core.port_b[:, 2], PCM_Pipe_Wall1.port_b) annotation (Line(points=
         {{185.86,-6.84},{185.86,206},{96,206}}, color={191,0,0}));

  connect(HITB_Wall2.port_a, HITB_Wick2.port_b)
    annotation (Line(points={{-46,-222},{-54,-222}}, color={191,0,0}));
  connect(HITB_Wall2.port_b, collector4.port_b)
    annotation (Line(points={{-26,-222},{-18,-222}}, color={191,0,0}));
  connect(HITB_PCM_Gap2.port_a, Area_correction_convection2.port_a)
    annotation (Line(points={{40,-222},{31,-222}}, color={191,0,0}));
  connect(collector4.port_a[1], CHX2.port) annotation (Line(points={{2,-222},{6,
          -222},{6,-160},{18,-160}}, color={191,0,0}));
  connect(Q_CHX_Input2.y, CHX2.Q_flow_ext)
    annotation (Line(points={{45,-160},{32,-160}}, color={0,0,127}));
  connect(convection9.port_b, collector4.port_a[2])
    annotation (Line(points={{19,-178},{2,-178},{2,-222}}, color={191,0,0}));
  connect(Air_CHX_Side4.port, convection9.port_a)
    annotation (Line(points={{56,-178},{33,-178}}, color={191,0,0}));
  connect(convection8.port_b, collector4.port_a[nV_Z + 3])
    annotation (Line(points={{25,-266},{2,-266},{2,-222}}, color={191,0,0}));
  connect(DHX2.port, collector4.port_a[nV_Z + 4]) annotation (Line(points={{24,-288},
          {12,-288},{12,-290},{2,-290},{2,-222}}, color={191,0,0}));
  connect(Air_DHX_Side2.port, convection8.port_a)
    annotation (Line(points={{58,-266},{39,-266}}, color={191,0,0}));
  connect(Q_DHX_Input2.y, DHX2.Q_flow_ext)
    annotation (Line(points={{53,-288},{38,-288}}, color={0,0,127}));
  connect(HITB_PCM_Gap2.port_b, collector5.port_a)
    annotation (Line(points={{60,-222},{64,-222}}, color={191,0,0}));
  connect(collector5.port_b, PCM_Pipe_Wall2.port_a)
    annotation (Line(points={{84,-222},{86,-222}}, color={191,0,0}));
  connect(Air_PCM_Axial5.port, convection10.port_a)
    annotation (Line(points={{-100,-122},{-100,-137}}, color={191,0,0}));
  connect(convection10.port_b, simpleWall5.port_b)
    annotation (Line(points={{-100,-151},{-100,-164}}, color={191,0,0}));
  connect(convection11.port_b, simpleWall6.port_b)
    annotation (Line(points={{-98,-275},{-98,-264}}, color={191,0,0}));
  connect(convection11.port_a, Air_PCM_Axial6.port)
    annotation (Line(points={{-98,-289},{-98,-300}}, color={191,0,0}));
  connect(HITB_Main2.port_b1, HITB_Wick2.port_a)
    annotation (Line(points={{-88,-222},{-74,-222}}, color={191,0,0}));
  connect(HITB_Main2.port_b2, simpleWall5.port_a) annotation (Line(points={{-98,
          -212},{-98,-190},{-100,-190},{-100,-184}}, color={191,0,0}));
  connect(HITB_Main2.port_a1, Air_CHX_Side5.port)
    annotation (Line(points={{-108,-222},{-114,-222}}, color={191,0,0}));
  connect(HITB_Main2.port_a2, simpleWall6.port_a)
    annotation (Line(points={{-98,-232},{-98,-244}}, color={191,0,0}));
  connect(PCM_Pipe_Wall2.port_b, PCM_Core.port_b[:, 3]) annotation (Line(points=
         {{106,-222},{190,-222},{190,-38},{185.86,-38},{185.86,-6.84}}, color={191,
          0,0}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-120,-100},
    ...
    experiment(StopTime=43200, __Dymola_Algorithm="Dassl"));
end HITB_Experiment_03_02;
