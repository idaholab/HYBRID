...
model HITB_Experiment_03_08 "Add in HITB control"
  ...
  Components.PCM_Volume.PCM_Chamber_vertsym_03 PCM_Core(
    ...
    hc_air=hc_air,
    T_Init=718.15,
    Q_heat_trace=(triggeredTrapezoid2.y/(nV_Z*11))*ones(11, nV_Z))
  ...
  Modelica.Blocks.Sources.CombiTimeTable charge_demand_table1(table=[0,0.0;
        3599,0; 3600,3000; 10799,3000; 10800,0; 21599,0; 21600,2000; 43199,2000;
        43200,1000; 57599,1000; 57600,0], extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation (Placement(transformation(extent={{58,236},{78,256}})));
  Modelica.Blocks.Sources.CombiTimeTable discharge_demand_table1(table=[0,0.0;
        3599,0; 3600,0; 10799,0; 10800,3000; 21599,3000; 21600,500; 43199,500;
        43200,1500; 57599,1500; 57600,0], extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation (Placement(transformation(extent={{52,306},{72,326}})));
  Controls_Construction controls_Construction
    annotation (Placement(transformation(extent={{124,278},{144,298}})));
  Modelica.Blocks.Logical.LessEqualThreshold    lessEqualThreshold1(threshold=443
         + 273.15 - 5)
    annotation (Placement(transformation(extent={{202,-126},{222,-106}})));
  Modelica.Blocks.Sources.RealExpression Q_CHX_Input4(y=PCM_Core.T_ave_r[
        PCM_Core.nR])
    annotation (Placement(transformation(extent={{154,-126},{174,-106}})));
  Modelica.Blocks.Logical.TriggeredTrapezoid triggeredTrapezoid2(
    amplitude=1e3,
    rising=100,
    falling=600,
    offset=0)
    annotation (Placement(transformation(extent={{250,-126},{270,-106}})));
protected
...
equation
  ...
  */
  ...
  connect(charge_demand_table1.y[1], controls_Construction.charge_demand)
    annotation (Line(points={{79,246},{112,246},{112,282},{122,282}}, color={0,
          0,127}));
  connect(controls_Construction.discharge_demand, discharge_demand_table1.y[1])
    annotation (Line(points={{122,292},{80,292},{80,316},{73,316}}, color={0,0,
          127}));
  connect(lessEqualThreshold1.y, triggeredTrapezoid2.u)
    annotation (Line(points={{223,-116},{248,-116}}, color={255,0,255}));
  connect(Q_CHX_Input4.y, lessEqualThreshold1.u)
    annotation (Line(points={{175,-116},{200,-116}}, color={0,0,127}));
