...
model HITB_Experiment_03_01
  ...
  Components.PCM_Volume.PCM_Chamber_onethirdsym PCM_Core(nZ=nV_Z, drs_one=1/
        1000*{25,25,23.66,142.26 - 73.66,27.76,25,25,25,25,35.287 - 12.538})
    annotation (Placement(transformation(extent={{106,-66},{204,36}})));
protected
...
equation
  ...
  */
  ...
  connect(PCM_Pipe_Wall.port_b, PCM_Core.port_b) annotation (Line(points={{106,-8},
          {160,-8},{160,-2},{161.86,-2},{161.86,-6.84}},          color={191,0,0}));
