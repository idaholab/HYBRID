...
//  Modelica.Units.SI.Power Q_loss;
  ...
  Components.PCM_Volume.PCM_StorageVessel_1D PCM_Core(
    nZ=nV_Z,
    n_HPs=2,
    HPFrac={0.5,1},
    hc_air=hc_air,
  ...
  */
  ...
  connect(thermalCollector1.port_a, Lower_Guide_Tube.port_battery) annotation (
      Line(points={{-30,-12},{-30,-6},{-12,-6},{-12,-68},{45,-68},{45,-48.22}},
        color={191,0,0}));
  connect(thermalCollector.port_a, Upper_Guide_Tube.port_battery) annotation (
      Line(points={{-140,12},{-140,52},{47.9429,52},{47.9429,25.6}}, color={191,
          0,0}));
