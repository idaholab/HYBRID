...
equation
 ...
 //Energy
 V_Boiler*der(rhou_boiler)=m_FDCV*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.hf(Pcond)-
  m_LPT*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.hg(P_Boiler)+Q_TES;

 rho_boiler=NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhof(P_Boiler)+alphag_boiler*
    (NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhog(P_Boiler)-
     NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhof(P_Boiler));    //State Equation for density

 rhou_boiler=NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhof(P_Boiler)*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.uf(P_Boiler)+
      alphag_boiler*(NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhog(P_Boiler)*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.ug(P_Boiler)-
      NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhof(P_Boiler)*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.uf(P_Boiler)); //State Equation for rhou
...
//   rhou_boiler=TESSystem.rhof(P_Boiler)*TESSystem.uf(P_Boiler)-alphag_boiler*(TESSystem.rhof(P_Boiler)*TESSystem.uf(P_Boiler)-TESSystem.rhog(P_Boiler)*TESSystem.ug(P_Boiler));
  ...
  //Momentum Equations
Pcond*conv1+dPumpFDCV=P_Boiler*conv1+((KFDCV+KFDCVline)*(m_FDCV^2)/(2*gc*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhof(Pcond)*(A_FDCV^2)));
P_Boiler*conv1=P_LPT*conv1+((K_TCV+K_TCVline)*(m_LPT^2)/(2*gc*NHES.Systems.EnergyStorage.SensibleHeatStorage.Components.rhog(P_Boiler)*(A_TCV^2)));
