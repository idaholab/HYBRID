...
<a href=\"modelica://Modelica.Math.Nonlinear.Examples\">Math.Nonlinear.Examples</a>.
  ...
  package ComponentsTwentyPercentNominalSteamFlow
    ...
    equation
      ...
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hf(
        P_IHX)*2326 = port_b.h_outflow;
     ...
     //Mass Equation
      ...
      //Energy Equation
      V_IHX*der(rhou) = m_tbv*hsg - m_prv*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hg(
        P_IHX) - m_ihx*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hf(
        P_IHX) - Q_IHX;

      rho =
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhof(
        P_IHX) + alphag*(
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhog(
        P_IHX) -
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhof(
        P_IHX));                                                                    //State Equation for density
      ...
      rhou =
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhof(
        P_IHX)*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.uf(
        P_IHX) + alphag*(
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhog(
        P_IHX)*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.ug(
        P_IHX) -
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhof(
        P_IHX)*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.uf(
    ...
    //Determination of Q_TES*******************************************************************************************************
      ...
      delTw := (-Chi/2.) + (0.5)*sqrt((Chi^2. + 4.*Chi*(TbarB -
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.Tsat(
        P_Boiler))));
    ...
    //Assume a constant enthalpy turbine
      x_exhturb := (
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.sg(
        P_Boiler) -
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.sf(
        Pcond))/
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.sfg(
        Pcond);

      h_exhturb :=
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hf(
        Pcond) + x_exhturb*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hfg(
        Pcond);
    ...
    Twmax:=TsatIHX - 0.0001;
      TwIHX := Modelica.Math.Nonlinear.solveOneNonlinearEquation(
            function
          NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.ho_IHX(
              P_IHX=P_IHX,
              ktube=ktube,
              ro_IHX=ro_IHX,
              ri_IHX=ri_IHX,
      ...
      AA :=
        ...
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.rhog(
        P_IHX))*g*(
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.kl(
        TsatIHX, P_IHX)^3);

      hfg1 :=
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hfg(
        P_IHX)*((1 + (0.68*
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.Cpl(
        TsatIHX, P_IHX)*(TsatIHX - TwIHX))/
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.hfg(
        P_IHX)));

      BB :=
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.Viscosity(
        TsatIHX, P_IHX)*dihx*(TsatIHX - TwIHX);
    ...
    algorithm
      ...
      rhog := 1./
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.vg(
        P);
    end rhog;
    ...
    algorithm
      ...
      rhof := 1./
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ComponentsTwentyPercentNominalSteamFlow.vf(
        P);
...
<a href=\"modelica://Modelica.Math.Nonlinear.Examples\">Math.Nonlinear.Examples</a>.
  ...
  equation
    ...
    NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hf(P_IHX)*
      2326 = port_b.h_outflow;
   ...
   //Mass Equation
    ...
    //Energy Equation
    V_IHX*der(rhou) = m_tbv*hsg - m_prv*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hg(P_IHX)
       - m_ihx*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hf(P_IHX)
       - Q_IHX;
    //TESSystem.hf(P_IHX);

    rho = NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_IHX) + alphag*(
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhog(
      P_IHX) -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_IHX));                                                                    //State Equation for density

    rhou = NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_IHX)*NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.uf(
      P_IHX) + alphag*(
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhog(
      P_IHX)*NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ug(
      P_IHX) -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_IHX)*NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.uf(
      P_IHX));                                                                                                                                      //State Equation for rhou
  ...
  m_teskghr:=m_tes*3600/2.2;
    TsatIHX :=
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.Tsat(
      P_IHX);
  Twmin:=(T_CT + T_IHXexit)/2;
  Twmax:=TsatIHX - 0.0001;
    TwIHX := Modelica.Math.Nonlinear.solveOneNonlinearEquation(
        function
        NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ho_IHX(
          P_IHX=P_IHX,
          ktube=ktube,
          ro_IHX=ro_IHX,
          ri_IHX=ri_IHX,
  ...
  //TwIHX:=500;
    ...
    AA := NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_IHX)*(
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_IHX) -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhog(
      P_IHX))*g*(
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.kl(
      TsatIHX, P_IHX)^3);

    hfg1 := NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hfg(
      P_IHX)*((1 + (0.68*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.Cpl(
      TsatIHX, P_IHX)*(TsatIHX - TwIHX))/
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hfg(P_IHX)));

    BB :=
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.Viscosity(
      TsatIHX, P_IHX)*dihx*(TsatIHX - TwIHX);
  ...
  //hsg=1244;
    m_tesref := m_bypassref*(hsg -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hf(700))/
      (cp_tes*(T_setpoint - T_CT));
  ...
  eff:=1.;//(Assumes a total cycle efficiency of "x"%
    ...
    Wturb := m_LPT*(
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hg(
      P_Boiler) -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hf(Pcond))
      *eff/947.817;                                                                 //MW
  ...
  equation
   ...
   //Energy
    ...
    rhou_boiler =
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_Boiler)*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.uf(
      P_Boiler) + alphag_boiler*(
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhog(
      P_Boiler)*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.ug(
      P_Boiler) -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.rhof(
      P_Boiler)*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.uf(
  ...
  //Assume a constant enthalpy turbine
    x_exhturb := (
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.sg(
      P_Boiler) -
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.sf(Pcond))
      /NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.sfg(
      Pcond);

    h_exhturb :=
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hf(Pcond)
       + x_exhturb*
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.hfg(Pcond);
  ...
  model DischargeforHookup_elecport
    ...
    Modelica.Blocks.Interfaces.RealInput Demand
      annotation (Placement(transformation(extent={{-126,-32},{-100,-6}})));
    Electrical.Interfaces.ElectricalPowerPort_b portElec_b annotation (Placement(
          transformation(extent={{94,-74},{114,-54}}), iconTransformation(extent=
              {{-168,-102},{-148,-82}})));
  equation
    connect(BoilerTubeSide.Q_TES, Boiler.Q_TES) annotation (Line(points={{3,4.6},
            {26,4.6},{26,8.9},{36.9,8.9}}, color={0,0,127}));
  ...
  algorithm
    DeltaT :=
      NHES.Systems.EnergyStorage.SensibleHeatStorage.SupportComponent.Tsat(P)
       - T;
    Ksat:=0;
