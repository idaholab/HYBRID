...
model SpeedControlCompressor "Gas compressor"
  extends NHES.Systems.EnergyStorage.CompressedAirEnergyStorage.BaseClasses.CompressorBase3;
  import NHES.Systems.EnergyStorage.CompressedAirEnergyStorage.Data.TableTypes;
  input SI.AngularVelocity Ndesign "Design velocity";
  //parameter SI.MassFlowRate m_max "Max Flow Rate";
