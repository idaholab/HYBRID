...
model MainCompressor_test "Gas compressor"
  extends NHES.Systems.EnergyStorage.CompressedAirEnergyStorage.BaseClasses.MainCompressorBase;
  ...
  //Real beta(start=integer(size(tablePhic, 1)/2), fixed = true) "Number of beta line";
  Real beta(start=11, fixed = true) "Number of beta line";
