...
partial model TurbineBase2 "Gas Turbine"
  extends NHES.GasTurbine.Icons.Turbine;
  ...
  SI.Power TurbPower "Turbine Power";
...
equation
  ...
  TurbPower = w*(gas_in.h - hout_iso) "Turbine Power";
