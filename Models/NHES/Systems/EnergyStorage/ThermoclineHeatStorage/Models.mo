...
package Models "Thermocline Base Classes"
...
<p><br>The model backbone is the Schumann equations with additional terms incorporated for thermal conduction when in standby mode. </p>
  ...
  model Thermocline_Insulation "Thermocline Insulation subpackage"
    Models.Thermocline_fluidprops_heaters_newHC thermocline_fluidprops_heaters_newHC(
    ...
    TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder simpleWall[
      ...
      length=fill(thermocline_fluidprops_heaters_newHC.Height_Tank/
          thermocline_fluidprops_heaters_newHC.nodes,
          thermocline_fluidprops_heaters_newHC.nodes),
  ...
  equation
    connect(simpleWall.port_b, thermocline_fluidprops_heaters_newHC.heatPorts[:,
    ...
    connect(thermocline_fluidprops_heaters_newHC.port_b, port_b) annotation (Line(
          points={{3.55271e-15,-24},{3.55271e-15,-62},{0,-62},{0,-100}}, color={0,
            127,255}));
    connect(thermocline_fluidprops_heaters_newHC.port_a, port_a)
...
Thermocline System"),
  ...
  model Thermocline_Insulation_mulitlayer "Thermocline Insulation subpackage"
    Models.Thermocline_fluidprops_heaters_newHC thermocline_fluidprops_heaters_newHC(
      redeclare package Medium = Medium,
      Radius_Tank=geometry.Radius_Tank,
      Porosity=geometry.Porosity,
    ...
    TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder Insulation1
      ...
      length=fill(thermocline_fluidprops_heaters_newHC.Height_Tank/
          thermocline_fluidprops_heaters_newHC.nodes,
          thermocline_fluidprops_heaters_newHC.nodes),
      r_inner=fill(Insulation[thermocline_fluidprops_heaters_newHC.nodes].r_outer,
          geometry.nodes),
    ...
    TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder Insulation2
      ...
      length=fill(thermocline_fluidprops_heaters_newHC.Height_Tank/
          thermocline_fluidprops_heaters_newHC.nodes,
          thermocline_fluidprops_heaters_newHC.nodes),
      r_inner=fill(Insulation1[thermocline_fluidprops_heaters_newHC.nodes].r_outer,
          geometry.nodes),
      r_outer=fill(0.004 + Insulation2[thermocline_fluidprops_heaters_newHC.nodes].r_inner,
          geometry.nodes),
  ...
  equation
    connect(simpleWall.port_b, thermocline_fluidprops_heaters_newHC.heatPorts[:,
      1]) annotation (Line(points={{-38,46},{-32,46},{-32,8},{-34,8},{-34,3},{
            -28.56,3}},                                 color={191,0,0}));
    connect(simpleWall.port_a, Insulation.port_b)
    ...
    connect(thermocline_fluidprops_heaters_newHC.port_a, port_a)
      annotation (Line(points={{0,30},{0,100}}, color={0,127,255}));
    connect(boundaryT.y, boundary2.T_ext)
      annotation (Line(points={{-88,-75},{-88,-58}}, color={0,0,127}));
    connect(boundary2.port, Insulation2.port_a) annotation (Line(points={{-88,
            -44},{-88,-32},{-90,-32},{-90,-28}}, color={191,0,0}));
    connect(Insulation2.port_b, Insulation1.port_a)
      annotation (Line(points={{-90,-8},{-90,8}}, color={191,0,0}));
    connect(Insulation1.port_b, Insulation.port_a) annotation (Line(points={{
            -90,28},{-92,28},{-92,46},{-90,46}}, color={191,0,0}));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
          Rectangle(
            extent={{-60,90},{60,0}},
            lineColor={0,0,0},
...
Thermocline System"),
      ...
      experiment(
        ...
        Interval=10.000008,
        __Dymola_Algorithm="Esdirk45a"));
  end Thermocline_Insulation_mulitlayer;
end Models;
