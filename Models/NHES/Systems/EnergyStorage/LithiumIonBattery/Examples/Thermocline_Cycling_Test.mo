...
model Thermocline_Cycling_Test
  ...
  NHES.Systems.EnergyStorage.LithiumIonBattery.ThermoclineModels.Thermocline_Insulation
...
<p>Assuming a Large tank as what would be seen in a power station style system. These are consistent with existing chilled water storage size tanks in commercial use. </p>
<p>Height = 14.6m</p>
<p>Radius = 0.436m </p>
<p>Insulation = 0.204m; ~8in</p>
<p>Wall thickness = 0.051 m</p>
</html>"));
end Thermocline_Cycling_Test;
