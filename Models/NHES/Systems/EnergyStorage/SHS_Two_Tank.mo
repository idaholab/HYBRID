...
package SHS_Two_Tank
  ...
  package Components
    ...
    model Two_Tank_SHS_System_dpPumps
      extends BaseClasses.Partial_SubSystem_A(
        redeclare replaceable ControlSystems.CS_Boiler_04 CS,
        redeclare replaceable ED_Dummy ED,
        redeclare replaceable Data.Data_SHS data(DHX_v_shell=1.0));
      ...
      Fluid.Machines.Pump_Pressure  discharge_pump(
        redeclare package Medium = Storage_Medium,
        p_nominal=150000,
        eta=0.8)      annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={68,-76})));
      Modelica.Blocks.Sources.RealExpression Discharge_Mass_Flow(y=
      ...
      BaseClasses.DumpTank_Init_T      cold_tank(
        ...
        T_start=data.cold_tank_init_temp)
        annotation (Placement(transformation(extent={{-52,22},{-32,42}})));
      Fluid.Machines.Pump_Pressure  charge_pump(
        redeclare package Medium = Storage_Medium,
        p_nominal=150000,
        eta=0.8)      annotation (Placement(transformation(
            extent={{-10,10},{10,-10}},
    ...
    equation
      ...
      connect(sensorBus.Hot_Tank_Temp, Hot_Tank_Temp.y) annotation (Line(
          ...
          extent={{6,3},{6,3}},
          horizontalAlignment=TextAlignment.Left));
      connect(sensorBus.HotTank_inlet_T, sensor_T.T) annotation (Line(
          points={{-30,100},{-30,42},{-24,42},{-24,-72.4}},
          color={239,82,82},
          pattern=LinePattern.Dash,
          thickness=0.5), Text(
          string="%first",
