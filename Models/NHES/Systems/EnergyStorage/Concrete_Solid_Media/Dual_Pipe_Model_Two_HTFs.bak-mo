...
public
 ...
 parameter Modelica.Units.SI.Time tau=0.250
  ...
  parameter Modelica.Units.SI.SpecificEnthalpy HTFC_h_start_hot=300e3 "Charging initial hot enthalpy" annotation(dialog(tab = "Initialization"));
  parameter Modelica.Units.SI.SpecificEnthalpy HTFC_h_start_cold=300e3 "Charging initial cold enthalpy" annotation(dialog(tab = "Initialization"));
  parameter Modelica.Units.SI.SpecificEnthalpy HTFD_h_start_hot=300e3 "Discharging initial hot enthalpy" annotation(dialog(tab = "Initialization"));
  parameter Modelica.Units.SI.SpecificEnthalpy HTFD_h_start_cold=300e3 "Discharging initial cold enthalpy" annotation(dialog(tab = "Initialization"));
  parameter Modelica.Units.SI.Temperature Hot_Con_Start=500 "Hot concrete start temperature" annotation(dialog(tab = "Initialization"));
  parameter Modelica.Units.SI.Temperature Cold_Con_Start=407 "Cold concrete start temperature" annotation(dialog(tab = "Initialization"));
