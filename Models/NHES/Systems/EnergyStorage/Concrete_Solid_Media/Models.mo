...
package Models
  ...
  model Dual_Pipe_CTES_Controlled
    ...
    SupportComponent.Dual_Pipe_Model CTES(
      nY=7,
      nX=9,
      tau=0.05,
      nPipes=250,
      dX=150,
      dY=0.3,
      redeclare package TES_Med = SupportComponent.HeatCrete,
    ...
    TRANSFORM.Fluid.Interfaces.FluidPort_Flow port_charge_a(redeclare package
        Medium = HTF) annotation (Placement(
          transformation(extent={{-112,32},{-92,52}}), iconTransformation(extent={
              {-112,32},{-92,52}})));
    TRANSFORM.Fluid.Interfaces.FluidPort_State port_discharge_b(redeclare
        package Medium =
                 HTF) annotation (Placement(transformation(extent={{-112,-66},{-92,
              -46}}), iconTransformation(extent={{-112,-66},{-92,-46}})));
    TRANSFORM.Fluid.Interfaces.FluidPort_Flow port_discharge_a(redeclare
        package Medium =
                 HTF) annotation (Placement(transformation(extent={{88,-62},{108,-42}}),
