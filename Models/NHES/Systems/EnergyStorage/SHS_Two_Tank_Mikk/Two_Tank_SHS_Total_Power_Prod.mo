...
equation
  ...
  connect(actuatorBus.Charge_Valve_Position, Charging_Valve.opening)
    annotation (Line(
      points={{30,100},{30,46},{-62,46},{-62,-36},{-56,-36}},
      color={111,216,99},
  ...
  connect(Charging_Valve.port_b, port_ch_b) annotation (Line(points={{-48,-46},{
          -48,-62},{-98,-62}}, color={0,127,255}));
  connect(sensor_T.port_a, port_ch_a) annotation (Line(points={{0,-78},{-58,-78},
          {-58,-76},{-116,-76},{-116,8},{-100,8},{-100,52},{-98,52}}, color={0,127,
          255}));
  annotation (experiment(
      ...
      __Dymola_Algorithm="Esdirk45a"), Icon(graphics={
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.HorizontalCylinder,
          lineThickness=1)}));
end Two_Tank_SHS_Total_Power_Prod;
