...
model Build_Test_NTU_SkidSizeShift_Bypass_Uncertainty
  "Using old model to start new one"
  extends Modelica.Icons.Example;

  Two_Tank_SHS_System_NewUpdate_Bypasses_Uncertainty
                          two_Tank_SHS_System_NewUpdate_Bypasses_Uncertainty(
    redeclare
      NHES.Systems.EnergyStorage.SHS_Two_Tank_Mikk.Controls.CS_Experimental_03_bypass
...
//  two_Tank_SHS_System_NTU.y = triggeredTrapezoid.u;
 // two_Tank_SHS_System.Produced_steam_flow = valveLinear.port_a.m_flow;
  ...
  connect(CHX_Inlet_T.port_b,
    two_Tank_SHS_System_NewUpdate_Bypasses_Uncertainty.port_ch_a) annotation (
      Line(points={{-72,-18},{-50,-18},{-50,-30.62},{-47.04,-30.62}}, color={0,
          127,255}));
  connect(CHX_Discharge_T.port_a,
    two_Tank_SHS_System_NewUpdate_Bypasses_Uncertainty.port_ch_b) annotation (
      Line(points={{-78,31},{-58,31},{-58,28.54},{-47.04,28.54}}, color={0,127,
          255}));
  ...
  connect(pump.port_b, two_Tank_SHS_System_NewUpdate_Bypasses_Uncertainty.port_dch_a)
    annotation (Line(points={{88,10},{56,10},{56,30.58},{47.04,30.58}}, color={
          0,127,255}));
  connect(boilerDrum.riserPort,
    two_Tank_SHS_System_NewUpdate_Bypasses_Uncertainty.port_dch_b) annotation (
      Line(points={{88.7,32.2},{80,32.2},{80,-30.62},{48,-30.62}}, color={0,127,
          255}));
...
end Build_Test_NTU_SkidSizeShift_Bypass_Uncertainty;
