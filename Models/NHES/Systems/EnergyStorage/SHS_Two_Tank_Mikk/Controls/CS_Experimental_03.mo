...
model CS_Experimental_03

  extends BaseClasses.Partial_ControlSystem;
  parameter Real T_steam = 273.15+240;
  ...
  Modelica.Blocks.Sources.Constant  const(k=T_steam)
  ...
  Modelica.Blocks.Sources.Constant one1(k=273.15 + 360)
  ...
  Modelica.Blocks.Sources.Constant one7(k=0.3)
...
equation
  ...
  connect(min2.y,add2. u2) annotation (Line(points={{-71.6,-28},{-60,-28},{-60,
          ...
          0,127}));
  connect(one4.y,min2. u2) annotation (Line(points={{-87.8,-30},{-88,-30},{-88,
  ...
  connect(sensorBus.cold_tank_level, min2.u1) annotation (Line(
      ...
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(const.y, PID3.u_s) annotation (Line(points={{-53.4,52},{-40,52},{-40,
          58},{-36.8,58}},
                       color={0,0,127}));
  connect(product1.y, Discharging_Valve_Position.u)
    annotation (Line(points={{-11.6,64},{0,64}}, color={0,0,127}));
  connect(PID3.y,product1. u2) annotation (Line(points={{-27.6,58},{-20.8,58},{
  ...
  connect(sensorBus.Charge_Temp, PID5.u_m) annotation (Line(
      points={{-30,-100},{-102,-100},{-102,-16},{-45,-16},{-45,-14.6}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
