...
model CS_Experimental_02
  ...
  Modelica.Blocks.Sources.Trapezoid trapezoid(
    amplitude=m_flow_rate_steam_trigger,
    rising=500,
    width=8500,
    falling=500,
    period=18000,
    offset=0.0,
    startTime=43200)
    annotation (Placement(transformation(extent={{-74,24},{-62,36}})));
  BalanceOfPlant.StagebyStageTurbineSecondary.Control_and_Distribution.MinMaxFilter
...
equation
  ...
  connect(sensorBus.Charging_HTF_Temp, PID5.u_m) annotation (Line(
      ...
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(trapezoid.y, PID3.u_s) annotation (Line(points={{-61.4,30},{-58,30},{
          -58,58},{-36.8,58}}, color={0,0,127}));
