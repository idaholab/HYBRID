...
model CS_Experimental_02_bypass
  ...
  Modelica.Blocks.Math.Add3 add3_1(k3=0.0)
    annotation (Placement(transformation(extent={{-172,-28},{-152,-8}})));
  Modelica.Blocks.Sources.Trapezoid trapezoid_with_sine(
    ...
    offset=0.0,
    startTime=34200)
    annotation (Placement(transformation(extent={{-178,-70},{-166,-58}})));
  ...
  Modelica.Blocks.Noise.NormalNoise normalNoise(
    samplePeriod=1800,
    mu=m_flow_rate_steam_trigger*0.5,
...
equation
  ...
  connect(sensorBus.hot_tank_level, hysteresis.u) annotation (Line(
      ...
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(switch2.y, add3_1.u2) annotation (Line(points={{-27,24},{-24,24},{-24,
          42},{-138,42},{-138,18},{-184,18},{-184,-18},{-174,-18}},
        color={0,0,127}));
  connect(trapezoid_with_sine.y, add3_1.u3) annotation (Line(points={{-165.4,
          -64},{-162,-64},{-162,-36},{-174,-36},{-174,-26}},            color={
          0,0,127}));
  connect(sine.y, add.u1) annotation (Line(points={{-129.5,63},{-118,63},{-118,
          52},{-176,52},{-176,42},{-166,42}}, color={0,0,127}));
  connect(ramp.y, add.u2) annotation (Line(points={{-165.5,75},{-158,75},{-158,
          62},{-192,62},{-192,30},{-166,30}}, color={0,0,127}));
  connect(add3_1.u1, add.y) annotation (Line(points={{-174,-10},{-174,22},{-140,
          22},{-140,36},{-143,36}},                color={0,0,127}));
  connect(normalNoise.y, switch3.u1) annotation (Line(points={{-137,114},{-94,
          114},{-94,132},{-84,132}}, color={0,0,127}));
  connect(one13.y, switch3.u3) annotation (Line(points={{-117.7,101},{-104,101},
          {-104,112},{-92,112},{-92,116},{-84,116}}, color={0,0,127}));
  connect(one14.y, greaterThreshold.u) annotation (Line(points={{-207.7,71},{
          -202,71},{-202,106},{-192,106}}, color={0,0,127}));
  connect(greaterThreshold.y, switch3.u2) annotation (Line(points={{-169,106},{
          -164,106},{-164,128},{-92,128},{-92,124},{-84,124}}, color={255,0,255}));
  connect(PID3.u_s, switch3.y) annotation (Line(points={{-34.8,54},{-60,54},{
          -60,110},{-58,110},{-58,124},{-61,124}}, color={0,0,127}));
