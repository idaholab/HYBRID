...
model HTGR_TES_RhC_6a4new_AR_vn1_uprate200MWth_176MWe___polished_PAstudy_1a
  ...
  BalanceOfPlant.Turbine.Reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA1
    ...
    steam_Drum(
      ...
      A_drum=15*2.8),
    CS(
      PartialAdmission(k=-2.0e-7, Ti=150),
      FWH_Valve(
        controllerType=Modelica.Blocks.Types.SimpleController.PI,
        k=-2,
        Ti=12000,
...
end HTGR_TES_RhC_6a4new_AR_vn1_uprate200MWth_176MWe___polished_PAstudy_1a;
