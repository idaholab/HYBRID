...
model HTGR_TES_RhC_6a4new_AR_vn1
...
equation
  ...
  connect(sHS2Tank_VN_SaltOut3_1.port_dch_b,
    reheat_cycle_drumOFH_Toutctr_AR_vn2_1.HT_RH_in) annotation (Line(points={{
          56,77.78},{56,76},{200,76},{200,70.6667},{253.71,70.6667}}, color={0,
          127,255}));
...
end HTGR_TES_RhC_6a4new_AR_vn1;
