...
model HTGR_Case_01_IndependentBOP_DM_VNa3dx
...
equation
  ...
  connect(product2.y,max1. u1)
    annotation (Line(points={{58.4,220},{58.4,222},{81,222}},
                                                            color={0,0,127}));
  connect(one2.y,product2. u2) annotation (Line(points={{-15.7,219},{-15.7,
  ...
  connect(one8.y,product1. u2) annotation (Line(points={{10.3,293},{50,293},{50,
          282.4},{55.2,282.4}},   color={0,0,127}));
...
end HTGR_Case_01_IndependentBOP_DM_VNa3dx;
