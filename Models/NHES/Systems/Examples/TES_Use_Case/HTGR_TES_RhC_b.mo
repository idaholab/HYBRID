...
model HTGR_TES_RhC_b
  EnergyStorage.SHS_Two_Tank.Components.SHS2Tank_VN_SaltOut
    ...
    redeclare EnergyStorage.SHS_Two_Tank.ControlSystems.CS_TES_VN2a
                         CS(
  ...
  TRANSFORM.Fluid.FittingsAndResistances.SpecifiedResistance R_entry2(R=1,
    ...
    annotation (Placement(transformation(
        ...
        rotation=180,
        origin={166,69})));
  Modelica.Blocks.Sources.RealExpression dLevel(y=-sHS2Tank_VN_SaltOut.hot_tank.level
  ...
  Modelica.Blocks.Sources.Trapezoid Wdemand(
    amplitude=-40000000,
    rising=1000,
    width=3000,
    falling=1000,
    ...
    offset=63000000,
    startTime=0)
    annotation (Placement(transformation(extent={{-2,176},{10,188}})));
equation
  ...
  connect(sHS2Tank_VN_SaltOut3_1.port_dch_b,
    reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_in) annotation (Line(points={{52,
          75.78},{52,76},{200,76},{200,85.1765},{228.933,85.1765}},     color={
          0,127,255}));
  ...
  connect(reheat_cycle_drumOFH_connectors_salt3_1.HT_SH_in,
    sHS2Tank_VN_SaltOut3_1.port_dch_b) annotation (Line(points={{228,60.2353},{
  ...
  connect(sHS2Tank_VN_SaltOut3_1.port_ch_b, resistance1.port_b) annotation (
      Line(points={{-15.32,111.74},{-22,111.74},{-22,98.6},{-42,98.6}}, color={
          0,127,255}));
  connect(resistance1.port_a, sHS2Tank_VN_SaltOut.port_ch_a) annotation (Line(
        points={{-42,87.4},{-42,-16.22},{-25.32,-16.22}}, color={0,127,255}));
  connect(Charging_bypass.port_b, sHS2Tank_VN_SaltOut.port_ch_a) annotation (
      Line(points={{-54,75},{-48,75},{-48,76},{-42,76},{-42,-16.22},{-25.32,
          -16.22}}, color={0,127,255}));
  connect(sensor_pT12.port, sHS2Tank_VN_SaltOut.port_ch_a) annotation (Line(
