...
model HTGR_Case_02_DirectCoupling
 ...
 parameter String fileName=Modelica.Utilities.Files.loadResource(
  ...
  EnergyStorage.SHS_Two_Tank_Mikk.Two_Tank_SHS_System_NTU_GMI_TempControl_SmallTanks_DirectCoupling_HTGR
    two_Tank_SHS_System_NTU(
    redeclare
      NHES.Systems.EnergyStorage.SHS_Two_Tank_Mikk.CS_Boiler_03_GMI_TempControl_SmallTanks_DirectCoupling_HTGR
      CS,
  ...
  PrimaryHeatSystem.HTGR.HTGR_Rankine.Components.HTGR_PebbleBed_Primary_Loop_TESUC_Direct
                                         hTGR_PebbleBed_Primary_Loop_TESUC_Direct(
      redeclare
      NHES.Systems.PrimaryHeatSystem.HTGR.HTGR_Rankine.CS_Rankine_Primary_Direct
      CS(data(P_Steam_Ref=14000000)))
    annotation (Placement(transformation(extent={{-94,-20},{-50,22}})));
  BalanceOfPlant.Turbine.SteamTurbine_Basic_DirectCoupling_HTGR
