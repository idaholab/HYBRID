...
model HTGR_TES_RhC_6a3
  ...
  BalanceOfPlant.Turbine.Reheat_cycle_drumOFH_connectors_salt3_DrumNHES
    reheat_cycle_drumOFH_connectors_salt3_DrumNHES(
    ...
    ramp(height=-0.2,
         offset=0.2),
    steamTurbine(p_outlet_nominal=900000))
  ...
  EnergyStorage.SHS_Two_Tank.Components.SHS2Tank_VN_SaltOut3
    ...
    annotation (Placement(transformation(extent={{-14,64},{54,126}})));
  ...
  Modelica.Blocks.Sources.RealExpression Cycle_Q_in(y=
        reheat_cycle_drumOFH_connectors_salt3_DrumNHES.Q_in.y)
    "Heat loss/gain not accounted for in connections (e.g., energy vented to atmosphere) [W]"
  ...
  Modelica.Blocks.Sources.RealExpression Power(y=
        reheat_cycle_drumOFH_connectors_salt3_DrumNHES.powerSensor.power)
  ...
  Modelica.Blocks.Sources.CombiTimeTable demand_BOP(
    ...
    shiftTime=0)
    annotation (Placement(transformation(extent={{-180,196},{-160,216}})));
...
equation
  ...
  connect(sHS2Tank_VN_SaltOuta.port_dch_b,
    reheat_cycle_drumOFH_connectors_salt3_DrumNHES.LT_in) annotation (Line(
        points={{42,-18.22},{88,-18.22},{88,18},{218,18},{218,26.2353},{222.467,
          26.2353}}, color={0,127,255}));
  connect(reheat_cycle_drumOFH_connectors_salt3_DrumNHES.LT_out,
    sHS2Tank_VN_SaltOuta.port_dch_a) annotation (Line(points={{222.467,8.82353},
          {52,8.82353},{52,18.98},{41.32,18.98}}, color={0,127,255}));
  ...
  connect(sHS2Tank_VN_SaltOut3_1.port_dch_b,
    reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_RH_in) annotation (Line(
        points={{54,75.78},{54,76},{200,76},{200,83.1765},{222.933,83.1765}},
        color={0,127,255}));
  ...
  connect(reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_SH_in,
    sHS2Tank_VN_SaltOut3_1.port_dch_b) annotation (Line(points={{222,58.2353},{
          200,58.2353},{200,76},{54,76},{54,75.78}}, color={0,127,255}));
  connect(sHS2Tank_VN_SaltOut3_1.port_ch_b, sensor_pT3.port) annotation (Line(
        points={{-13.32,111.74},{-21.66,111.74},{-21.66,112},{-28,112}}, color=
          {0,127,255}));
  ...
  connect(sensor_pT8.port, reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_RH_in)
    annotation (Line(points={{220,106},{220,94},{222.933,94},{222.933,83.1765}},
        color={0,127,255}));
  connect(sensor_pT9.port, reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_SH_in)
    annotation (Line(points={{206,104},{208,104},{208,94},{210,94},{210,58.2353},
          {222,58.2353}}, color={0,127,255}));
  connect(sensor_pT10.port, reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_RH_out)
    annotation (Line(points={{184,132},{184,67.1765},{222.467,67.1765}}, color=
          {0,127,255}));
  connect(sensor_pT11.port, reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_SH_out)
  ...
  connect(volume.port_a, R_entry2.port_a) annotation (Line(points={{136,114},{
          ...
          255}));
  connect(R_entry2.port_b, reheat_cycle_drumOFH_connectors_salt3_DrumNHES.HT_RH_out)
  ...
  connect(resistance2.port_b, sHS2Tank_VN_SaltOut3_1.port_ch_a) annotation (
      Line(points={{-54.4,47},{-24,47},{-24,66.48},{-14.68,66.48}}, color={0,
          127,255}));
  connect(sHS2Tank_VN_SaltOut3_1.port_ch_b, resistance1.port_b) annotation (
      Line(points={{-13.32,111.74},{-22,111.74},{-22,98.6},{-42,98.6}}, color={
          0,127,255}));
  ...
  connect(sensor_pT12.port, sHS2Tank_VN_SaltOuta.port_ch_a) annotation (Line(
        points={{-58,-40},{-58,-42},{-40,-42},{-40,-18.22},{-25.32,-18.22}},
                           color={0,127,255}));
  connect(Power.y, PID3.u_m)
    annotation (Line(points={{47,152},{60,152},{60,168},{76,168},{76,173.2}},
                                                          color={0,0,127}));
  ...
  connect(product2.y, max1.u1)
    annotation (Line(points={{-13.6,178},{-13.6,180},{9,180}},
                                                            color={0,0,127}));
  connect(one2.y, product2.u2) annotation (Line(points={{-87.7,177},{-87.7,
  ...
  connect(add1.y, product1.u1) annotation (Line(points={{-39.7,235},{-28.25,235},
          {-28.25,235.6},{-16.8,235.6}},
                                       color={0,0,127}));
  connect(one8.y, product1.u2) annotation (Line(points={{-61.7,251},{-22,251},{
          -22,240.4},{-16.8,240.4}},
                                  color={0,0,127}));
  ...
  connect(demand_BOP1.y[1], min3.u2) annotation (Line(points={{-121,206},{-110,
          206},{-110,217.6},{3.2,217.6}}, color={0,0,127}));
  connect(max1.u2, demand_BOP1.y[1]) annotation (Line(points={{9,186},{-112,186},
          {-112,206},{-121,206}}, color={0,0,127}));
  annotation (                    experiment(
      StopTime=25000,
      __Dymola_NumberOfIntervals=1000,
      __Dymola_Algorithm="Esdirk34a"));
end HTGR_TES_RhC_6a3;
