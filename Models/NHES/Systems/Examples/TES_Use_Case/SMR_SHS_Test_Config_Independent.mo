 ...
 max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
  ...
  BalanceOfPlant.Turbine.Intermediate_Rankine_Cycle_TESUC_1_Independent_SmallCycle
    ...
    redeclare
      ...
      CS(electric_demand=trapezoid.y))
    annotation (Placement(transformation(extent={{106,-84},{144,-42}})));
equation
  ...
  connect(stateSensor6.port_b,
    ...
    annotation (Line(points={{62,-68},{100,-68},{100,-60},{102,-60},{102,-50},{106,
          -50},{106,-54.6}}, color={0,127,255}));
  connect(stateSensor7.port_a,
    intermediate_Rankine_Cycle_TESUC_1_Independent_SmallCycle.port_b)
    annotation (Line(points={{68,-55},{68,-71.4},{106,-71.4}}, color={0,127,255}));
  connect(intermediate_Rankine_Cycle_TESUC_1_Independent_SmallCycle.portElec_b,
    SY.port_a[2]) annotation (Line(points={{144,-63},{152,-63},{152,-26},{108,-26},
          {108,1.1},{112,1.1}}, color={255,0,0}));
