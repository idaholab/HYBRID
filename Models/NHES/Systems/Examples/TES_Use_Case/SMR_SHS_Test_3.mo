...
model SMR_SHS_Test_3
 ...
 max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
  ...
  BalanceOfPlant.Turbine.SteamTurbine_L1_boundaries_no_heat
    ...
    p_reservoir=1200000,
    nPorts_a3=1)
    annotation (Placement(transformation(extent={{62,-76},{102,-36}})));
equation
  ...
  connect(EM.port_b3[1], two_Tank_SHS_System_NTU.port_ch_a) annotation (Line(
        points={{8,-20},{8,-32},{-40,-32},{-40,-68.4},{-19.6,-68.4}}, color={0,
          127,255}));
  connect(SHS_Throttle.port_a, two_Tank_SHS_System_NTU.port_ch_b) annotation (
      Line(points={{32,-32},{16,-32},{16,-34},{-26,-34},{-26,-45.2},{-19.6,-45.2}},
        color={0,127,255}));
  ...
  connect(BOP1.portElec_b, SY.port_a[2])
    annotation (Line(points={{102,-56},{112,-56},{112,1.1}}, color={255,0,0}));
  connect(two_Tank_SHS_System_NTU.port_dch_a, BOP1.port_b) annotation (Line(
        points={{19.6,-44.4},{36,-44.4},{36,-64},{62,-64}}, color={0,127,255}));
  connect(two_Tank_SHS_System_NTU.port_dch_b, BOP1.port_a) annotation (Line(
        points={{20,-68.4},{32,-68.4},{32,-72},{50,-72},{50,-48},{62,-48}},
        color={0,127,255}));
