...
model HTGR_TES_RhC_4
  ...
  BalanceOfPlant.Turbine.Reheat_cycle_drumOFH_connectors_salt3
    ...
    steam_Drum(p_start=20500000, alphag_start=0.8),
    CS(delay3(Ti=10)),
    DHX(
      NTU=3.5,
  ...
  EnergyStorage.SHS_Two_Tank.Components.SHS2Tank_VN_SaltOut2
    sHS2Tank_VN_SaltOut2_1(
    redeclare package Storage_Medium =
...
equation
  ...
  connect(sHS2Tank_VN_SaltOut.port_ch_a, sensor_pT3.port) annotation (Line(
        points={{-25.32,-16.22},{-40,-16.22},{-40,112},{-28,112}}, color={0,127,
          255}));
  connect(hTGR_PebbleBed_Primary_Loop.port_a, sensor_pT4.port) annotation (Line(
        ...
        color={0,127,255}));
  connect(hTGR_PebbleBed_Primary_Loop.port_b, sHS2Tank_VN_SaltOut2_1.port_ch_a)
    annotation (Line(points={{-95.05,11.21},{-95.05,46},{-15.32,46},{-15.32,
          75.78}}, color={0,127,255}));
  connect(sHS2Tank_VN_SaltOut2_1.port_ch_b, sHS2Tank_VN_SaltOut.port_ch_a)
    annotation (Line(points={{-15.32,111.74},{-40,111.74},{-40,-16.22},{-25.32,
          -16.22}}, color={0,127,255}));
  ...
  connect(sHS2Tank_VN_SaltOut2_1.port_dch_b,
    reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_in) annotation (Line(points={
          {52,75.78},{52,76},{200,76},{200,85.1765},{228.933,85.1765}}, color={
          0,127,255}));
  connect(sHS2Tank_VN_SaltOut2_1.port_dch_b, sensor_pT6.port) annotation (Line(
        points={{52,75.78},{61,75.78},{61,76},{70,76}}, color={0,127,255}));
  connect(reheat_cycle_drumOFH_connectors_salt3_1.HT_SH_in,
    sHS2Tank_VN_SaltOut2_1.port_dch_b) annotation (Line(points={{228,60.2353},{
          200,60.2353},{200,76},{52,76},{52,75.78}}, color={0,127,255}));
  connect(sHS2Tank_VN_SaltOut2_1.port_ch_b, sensor_pT3.port) annotation (Line(
        points={{-15.32,111.74},{-21.66,111.74},{-21.66,112},{-28,112}}, color=
          {0,127,255}));
  connect(sensor_pT5.port, sHS2Tank_VN_SaltOut2_1.port_dch_a) annotation (Line(
        points={{76,128},{76,112.98},{51.32,112.98}}, color={0,127,255}));
  connect(sensor_pT8.port, reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_in)
    annotation (Line(points={{220,106},{220,94},{228.933,94},{228.933,85.1765}},
        color={0,127,255}));
  connect(sensor_pT9.port, reheat_cycle_drumOFH_connectors_salt3_1.HT_SH_in)
    annotation (Line(points={{206,104},{208,104},{208,94},{210,94},{210,60.2353},
          {228,60.2353}}, color={0,127,255}));
  connect(sensor_pT10.port, reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_out)
    annotation (Line(points={{184,132},{184,69.1765},{228.467,69.1765}}, color=
          {0,127,255}));
  connect(sensor_pT11.port, reheat_cycle_drumOFH_connectors_salt3_1.HT_SH_out)
    annotation (Line(points={{170,130},{170,124},{176,124},{176,48.4706},{228,
          48.4706}}, color={0,127,255}));
  connect(sHS2Tank_VN_SaltOut2_1.port_dch_a, volume.port_b) annotation (Line(
  ...
  connect(volume.port_a, R_entry2.port_a) annotation (Line(points={{136,114},{
          ...
          255}));
  connect(R_entry2.port_b, reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_out)
