...
model HTGR_Case_02_DirectCoupling_VN
 ...
 parameter String fileName=Modelica.Utilities.Files.loadResource(
  ...
  Modelica.Blocks.Sources.CombiTimeTable demand_BOP(
    tableOnFile=true,
    table=[0,47e6; 20000,47e6; 23600,27e6; 50000,27e6; 53600,67e6; 70000,67e6; 80000,
        50e6; 90000,20e6; 100000,70e6; 120000,60e6],
    startTime=0,
    tableName="BOP",
    timeScale=timeScale,
    fileName=fileName)
  ...
  BalanceOfPlant.Turbine.HTGR_RankineCycles.SteamTurbine_Basic_DirectCoupling_HTGR
    ...
    redeclare
        ...
        electric_demand_TES=SC.demand_BOP.y[1], data(p_steam=5000000)))
...
end HTGR_Case_02_DirectCoupling_VN;
