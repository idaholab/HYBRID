...
model HTGR_TES_RhC_6a4new_AR_vn1_uprate200MWth_176MWe___polishedL
  ...
  Modelica.Blocks.Sources.RealExpression Cycle_Q_in(y=
    ...
    "Heat loss/gain not accounted for in connections (e.g., energy vented to atmosphere) [W]"
    annotation (Placement(transformation(extent={{226,86},{238,98}})));
  ...
  BalanceOfPlant.StagebyStageTurbineSecondary.Control_and_Distribution.MinMaxFilter
    Discharging_Valve_Position(min=1e-4, max=1)
        ...
        rotation=180,
        origin={174,190})));
  Modelica.Blocks.Sources.Constant MinLoad(k=10000000)
...
end HTGR_TES_RhC_6a4new_AR_vn1_uprate200MWth_176MWe___polishedL;
