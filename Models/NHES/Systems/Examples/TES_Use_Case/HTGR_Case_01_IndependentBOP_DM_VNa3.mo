...
model HTGR_Case_01_IndependentBOP_DM_VNa3
 ...
 max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
  ...
  BalanceOfPlant.Turbine.HTGR_RankineCycles.SteamTurbine_OpenFeedHeat_DivertPowerControl_HTGR
    ...
    redeclare
      ...
      FWCP_mflow(k=-0.001, Ti=1),
      ramp1(duration=20000),
      ramp3(height=-110, duration=20000),
...
end HTGR_Case_01_IndependentBOP_DM_VNa3;
