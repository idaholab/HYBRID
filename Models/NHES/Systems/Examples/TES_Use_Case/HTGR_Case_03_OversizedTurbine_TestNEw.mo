...
model HTGR_Case_03_OversizedTurbine_TestNEw
 ...
 max(SC.W_totalSetpoint_BOP/SC.W_nominal_BOP*fracNominal_BOP
  ...
  EnergyStorage.SHS_Two_Tank.Components.Two_Tank_SHS_System_BestModel
    ...
    redeclare package Storage_Medium =
        NHES.Media.SolarSalt_PCM.ConstantPropertyLiquidSolarSalt,
    m_flow_min=0.1,
    tank_height=11.7,
...
end HTGR_Case_03_OversizedTurbine_TestNEw;
