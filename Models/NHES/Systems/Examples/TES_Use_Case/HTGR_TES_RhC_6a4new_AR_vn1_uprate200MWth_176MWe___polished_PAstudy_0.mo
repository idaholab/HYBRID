...
model HTGR_TES_RhC_6a4new_AR_vn1_uprate200MWth_176MWe___polished_PAstudy_0
  ...
  BalanceOfPlant.Turbine.Reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0
    reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1(
  ...
  Modelica.Blocks.Sources.RealExpression Cycle_Q_in(y=
        reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.Q_in.y)
    "Heat loss/gain not accounted for in connections (e.g., energy vented to atmosphere) [W]"
  ...
  Modelica.Blocks.Sources.RealExpression Power(y=
        reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.powerSensor.power -
        reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.pump_SimpleMassFlow1.W
         -reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.pump_SimpleMassFlow2.W)
...
equation
  ...
  connect(sHS2Tank_VN_SaltOuta.port_dch_b,
    reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.LT_in) annotation (Line(
        points={{40,-18.22},{40,-18},{176,-18},{176,14},{194.634,14},{194.634,
          15.025}}, color={0,127,255}));
  connect(reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.LT_out,
  ...
  connect(sHS2Tank_VN_SaltOut3_1.port_dch_b,
    reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.HT_RH_in) annotation (
  ...
  connect(reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1.HT_SH_in,
  ...
  connect(sensor_pT8.port,reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1. HT_RH_in)
    annotation (Line(points={{190,86},{190,66},{195.062,66},{195.062,66.45}},
        color={0,127,255}));
  connect(sensor_pT9.port,reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1. HT_SH_in)
    annotation (Line(points={{166,86},{166,43.925},{194.207,43.925}}, color={0,
          127,255}));
  connect(sensor_pT10.port,reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1. HT_RH_out)
  ...
  connect(volume.port_a, R_entry2.port_a) annotation (Line(points={{98,114},{
          ...
          255}));
  connect(R_entry2.port_b,reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1. HT_RH_out)
  ...
  connect(R_entry1.port_b,reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1. HT_SH_out)
    annotation (Line(points={{114.2,33},{116,33.3},{194.207,33.3}}, color={0,
          127,255}));
  connect(sensor_pT11.port,reheat_cycle_drumOFH_Toutctr_AR_vn3_polished_PA0_1. HT_SH_out)
...
end HTGR_TES_RhC_6a4new_AR_vn1_uprate200MWth_176MWe___polished_PAstudy_0;
