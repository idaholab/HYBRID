...
model HTGR_TES_RhC_3
  ...
  TRANSFORM.Fluid.Sensors.PressureTemperature sensor_pT6(redeclare package
      Medium = NHES.Media.SolarSalt.ConstPropLiquidSolarSalt_NoLimit)
    annotation (Placement(transformation(extent={{-176,144},{-156,164}})));
  EnergyStorage.SHS_Two_Tank.Components.SHS2Tank_VN_SaltOut
...
equation
  ...
  connect(sHS2Tank_VN_SaltOut1.port_dch_b,
    reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_in) annotation (Line(points={
          {-186,143.78},{-182,143.78},{-182,144},{-120,144},{-120,207.176},{
          156.933,207.176}}, color={0,127,255}));
  connect(reheat_cycle_drumOFH_connectors_salt3_1.HT_RH_out,
    sHS2Tank_VN_SaltOut1.port_dch_a) annotation (Line(points={{156.467,191.176},
          {-150,191.176},{-150,180.98},{-186.68,180.98}}, color={0,127,255}));
  connect(sHS2Tank_VN_SaltOut1.port_dch_b, sensor_pT6.port) annotation (Line(
        points={{-186,143.78},{-182,143.78},{-182,144},{-166,144}}, color={0,
          127,255}));
