...
model Model_hx
  ...
  TRANSFORM.HeatExchangers.GenericDistributed_HX
                                      hx2(
    ...
    redeclare package Medium_shell = Medium_cw,
    ...
    annotation (Placement(transformation(extent={{-68,-122},{-88,-102}})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary16(
    redeclare package Medium = Medium_cw,
    p=data.p_hx_cw,
    T=data.T_hx_cw,
    nPorts=1)                                                       annotation (
     Placement(transformation(
        ...
        rotation=0,
        origin={-8,-92})));
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary17(
    redeclare package Medium = Medium_cw,
    m_flow=data.m_flow_cw,
    T=data.T_cw_hx,
    nPorts=1)   annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-146,-92})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT17(
    redeclare package Medium = Medium,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
    redeclare function iconUnit2 =
      ...
      Placement(transformation(
        ...
        rotation=0,
        origin={-108,-132})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT18(
    redeclare package Medium = Medium_cw,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
    redeclare function iconUnit2 =
        TRANSFORM.Units.Conversions.Functions.Temperature_K.to_degC)
    annotation (Placement(transformation(extent={{-58,-102},{-38,-82}})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT19(
    redeclare package Medium = Medium_cw,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
    redeclare function iconUnit2 =
        TRANSFORM.Units.Conversions.Functions.Temperature_K.to_degC)
    annotation (Placement(transformation(extent={{-118,-102},{-98,-82}})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT20(
    redeclare package Medium = Medium,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary18(
    ...
    nPorts=1)   annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-10,-132})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary19(
    redeclare package Medium = Medium,
    p=data.p_hx_co,
    T=data.T_hx_co,
    nPorts=1)                                                       annotation (
  ...
  Data.data_hx data_hx
    annotation (Placement(transformation(extent={{14,-120},{34,-100}})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT25(
    redeclare package Medium = Medium,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
    redeclare function iconUnit2 =
        TRANSFORM.Units.Conversions.Functions.Temperature_K.to_degC)
    annotation (Placement(transformation(extent={{-70,104},{-50,124}})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT26(
    redeclare package Medium = Medium,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
  ...
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT27(
    redeclare package Medium = Medium,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
    redeclare function iconUnit2 =
      ...
      Placement(transformation(
        ...
        rotation=180,
        origin={-120,114})));
  TRANSFORM.Fluid.Sensors.PressureTemperatureTwoPort sensor_pT28(
    redeclare package Medium = Medium,
    precision=1,
    redeclare function iconUnit =
        TRANSFORM.Units.Conversions.Functions.Pressure_Pa.to_bar,
  ...
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary28(
    redeclare package Medium = Medium,
    m_flow=data.m_flow,
    T=data.T_vc_rp,
    nPorts=1)   annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-158,114})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary29(
    redeclare package Medium = Medium,
    p=data.p_rp_vc,
    T=data.T_rp_vc,
    nPorts=1)                                                       annotation (
     Placement(transformation(
        ...
        rotation=0,
        origin={-160,74})));
  TRANSFORM.Fluid.BoundaryConditions.Boundary_pT boundary30(
    redeclare package Medium = Medium,
    p=data.p_rp_hx,
    T=data.T_rp_hx,
    nPorts=1)                                                       annotation (
     Placement(transformation(
        ...
        rotation=0,
        origin={-20,114})));
  TRANSFORM.Fluid.BoundaryConditions.MassFlowSource_T boundary31(
    redeclare package Medium = Medium,
    m_flow=data.m_flow,
    T=data.T_co_rp,
    nPorts=1)   annotation (Placement(transformation(
  ...
  TRANSFORM.Controls.LimPID PID2(
    ...
    k_s=1/(368 + 273.15),
    k_m=1/(368 + 273.15),
    yMin=0) annotation (Placement(transformation(extent={{64,82},{84,102}})));
  Modelica.Blocks.Sources.RealExpression realExpression4(y=368 + 273.15)
...
equation
  ...
  connect(boundary17.ports[1], sensor_pT19.port_a)
    annotation (Line(points={{-136,-92},{-118,-92}}, color={0,127,255}));
  connect(sensor_pT18.port_b, boundary16.ports[1])
    annotation (Line(points={{-38,-92},{-18,-92}}, color={0,127,255}));
  connect(boundary18.ports[1], sensor_pT20.port_a)
    annotation (Line(points={{-20,-132},{-38,-132}}, color={0,127,255}));
  connect(boundary19.ports[1], sensor_pT17.port_b)
    annotation (Line(points={{-138,-132},{-118,-132}}, color={0,127,255}));
  connect(sensor_pT19.port_b, hx2.port_a_shell) annotation (Line(points={{-98,
          -92},{-92,-92},{-92,-107.4},{-88,-107.4}}, color={0,127,255}));
  connect(hx2.port_b_shell, sensor_pT18.port_a) annotation (Line(points={{-68,
          -107.4},{-68,-106},{-62,-106},{-62,-92},{-58,-92}}, color={0,127,255}));
  connect(sensor_pT17.port_a, hx2.port_b_tube) annotation (Line(points={{-98,
          -132},{-92,-132},{-92,-112},{-88,-112}}, color={0,127,255}));
  connect(sensor_pT20.port_b, hx2.port_a_tube) annotation (Line(points={{-58,
          -132},{-62,-132},{-62,-112},{-68,-112}}, color={0,127,255}));
  connect(sensor_pT26.port_b, boundary29.ports[1])
    annotation (Line(points={{-130,74},{-150,74}}, color={0,127,255}));
  connect(boundary28.ports[1], sensor_pT27.port_a)
    annotation (Line(points={{-148,114},{-130,114}}, color={0,127,255}));
  connect(sensor_pT25.port_b, boundary30.ports[1])
    annotation (Line(points={{-50,114},{-30,114}}, color={0,127,255}));
  connect(sensor_pT28.port_a, boundary31.ports[1])
    annotation (Line(points={{-50,74},{-32,74}}, color={0,127,255}));
  connect(sensor_pT28.port_b, rp2.port_a_shell) annotation (Line(points={{-70,
          74},{-70,88},{-80,88},{-80,87.4}}, color={0,127,255}));
  connect(rp2.port_b_tube, sensor_pT25.port_a) annotation (Line(points={{-80,92},
          {-76,92},{-76,114},{-70,114}}, color={0,127,255}));
  connect(rp2.port_a_tube, sensor_pT27.port_b) annotation (Line(points={{-100,
          92},{-106,92},{-106,114},{-110,114}}, color={0,127,255}));
  connect(sensor_pT26.port_a, rp2.port_b_shell) annotation (Line(points={{-110,
          74},{-106,74},{-106,87.4},{-100,87.4}}, color={0,127,255}));
  connect(realExpression4.y, PID2.u_s)
    annotation (Line(points={{41,92},{62,92}}, color={0,0,127}));
  connect(sensor_pT26.T, PID2.u_m) annotation (Line(points={{-126,72},{-138,72},
          {-138,64},{74,64},{74,80}}, color={0,0,127}));
