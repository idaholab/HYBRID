within NHES.Systems.ExperimentalSystems.MAGNET.Examples;
model DynamicModel_LowPower "same as dynamic model but turns flowrates/heat down"
  ...
  Data.Summary summary(
    ...
    Q_flows={vc.Q_gen,rp.Q_flow,hx.Q_flow,co.W})
  ...
  Modelica.Blocks.Sources.Constant startTime(k=5000)
...
equation
  ...
  connect(m_flow.y, co.inputSignal)
    annotation (Line(points={{37,-68},{20,-68},{20,-83}}, color={0,0,127}));
