...
parameter SI.Length length_rp_vc = length_dummy;
...
parameter SI.Length length_vc_rp = length_dummy;
...
parameter SI.ThermalConductance UA_rp = 47.874603; // Calculated from PID

// Piping: Recuperator to Rejection Heat Exchanger (rp_hx)
parameter SI.Length d_rp_hx = d_inner_3in;
parameter SI.Length length_rp_hx = length_dummy;
...
parameter SI.ThermalConductance UA_hx = 698.87; // Calculated from PID
...
parameter SI.Length length_hx_co = length_dummy;
...
parameter SI.Length length_co_rp = length_dummy;
