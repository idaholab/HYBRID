within NHES.Systems.ExperimentalSystems.TEDS.Examples.OldExamples.Experiments2023;
model TEDSloop_allmodes_test_3WV_exp2023TTAdjTime
  ...
  TRANSFORM.Fluid.Sensors.MassFlowRate sensor_m_flow5(redeclare package Medium
      = TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C, precision=
       3) annotation (Placement(transformation(extent={{9,-8},{-9,8}},
        rotation=270,
        origin={-103,-128})));
  ControlSystems.Control_System_Therminol_4_element_all_modes_ExpTest
...
end TEDSloop_allmodes_test_3WV_exp2023TTAdjTime;
