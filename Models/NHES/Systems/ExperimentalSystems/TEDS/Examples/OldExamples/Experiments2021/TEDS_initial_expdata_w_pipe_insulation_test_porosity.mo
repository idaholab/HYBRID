...
model TEDS_initial_expdata_w_pipe_insulation_test_porosity
  "IC thermocline 70C, charge to 200F"
  ...
  ControlSystems.Control_System_Therminol_4_element_initial_exp
    control_System_Therminol_4_element_initial_exp_discharge(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
    T_hot_design(displayUnit="K") = Modelica.Units.Conversions.from_degF(200),
    T_cold_design(displayUnit="degC") = 293.65)
  ...
  TRANSFORM.Fluid.Sensors.MassFlowRate sensor_m_flow3(redeclare package Medium
      = TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C, precision=
       3) annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={154,40})));
  Systems.ExperimentalSystems.TEDS.Models.ThermoclineTank.Thermocline_Insulation_test_porosity_v1
  ...
  Modelica.Blocks.Sources.Constant const1(k=
        control_System_Therminol_4_element_initial_exp_discharge.T_cold_design)
  ...
  Modelica.Blocks.Sources.Constant const(k=
        control_System_Therminol_4_element_initial_exp_discharge.T_hot_design)
    annotation (Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={-146,46})));
  ...
  TRANSFORM.Fluid.Pipes.GenericPipe_withWallx2
    ...
    redeclare package Material_2 = Media.Solids.FoamGlass,
    redeclare model Geometry =
...
equation
  ...
  connect(T_discharge_outlet.port_a, thermocline_Insulation_test_porosity.port_a)
    annotation (Line(points={{154,-3},{154,-6},{118,-6}}, color={0,127,255}));
  connect(T_Charge_Inlet.port_b, thermocline_Insulation_test_porosity.port_a)
    annotation (Line(points={{83.5,-5},{83.5,-6},{118,-6}}, color={0,127,255}));
  connect(FM202.port_a, T_charge_outlet.port_a)
    annotation (Line(points={{154,-90},{154,-75}}, color={0,127,255}));
  connect(T_charge_outlet.port_b, thermocline_Insulation_test_porosity.port_b)
    annotation (Line(points={{154,-51},{154,-50},{118,-50}}, color={0,127,255}));
  connect(FM201.port_a, T_discharge_Inlet.port_a)
    annotation (Line(points={{80,-86},{80,-75}}, color={0,127,255}));
  connect(T_discharge_Inlet.port_b, thermocline_Insulation_test_porosity.port_b)
...
end TEDS_initial_expdata_w_pipe_insulation_test_porosity;
