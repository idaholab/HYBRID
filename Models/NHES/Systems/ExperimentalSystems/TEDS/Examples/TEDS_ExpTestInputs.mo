...
model TEDS_ExpTestInputs
  ...
  TRANSFORM.Fluid.Sensors.MassFlowRate FM_003(redeclare package Medium =
       ...
       3) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-103,-98})));
  ControlSystems.Control_System_TEDS_ExpTest
  ...
  BaseClasses_1.SignalSubBus_ActuatorInput SensorSubBus
    annotation (Placement(transformation(extent={{-72,130},{-50,154}})));
  BaseClasses_1.SignalSubBus_SensorOutput ActuatorSubBus
  ...
  TRANSFORM.Fluid.Sensors.MassFlowRate sensor_m_flow3(redeclare package Medium
      = TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C, precision=
       3) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={157,47})));
  Models.ThermoclineTank.Thermocline_Insulation_v3 thermocline_Insulation(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
...
equation
  ...
  connect(ActuatorSubBus,
    control_System_Therminol_4_element_all_modes_ExpTest3_1.SensorSubBus)
    annotation (Line(
  ...
  connect(SensorSubBus, control_System_Therminol_4_element_all_modes_ExpTest3_1.ActuatorSubBus)
    annotation (Line(
