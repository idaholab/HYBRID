...
model Thermocline_Insulation_test_porosity_v1
  "Thermocline Insulation subpackage"
  ThermoclineTank.Thermocline_fluidprops_heaters_newHC_70C_v1
  ...
  Data.Geometry geometry(Porosity=0.9) annotation (Dialog(group="Geometry"),
...
end Thermocline_Insulation_test_porosity_v1;
