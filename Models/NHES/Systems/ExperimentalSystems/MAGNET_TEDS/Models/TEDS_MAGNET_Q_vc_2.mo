...
package Medium_TEDS =
  ...
  TEDS.BaseClasses_1.SignalSubBus_ActuatorInput actuatorSubBus_
  ...
  Modelica.Blocks.Sources.Step step1(
    ...
    offset=data.m_flow,
    startTime=5000)
    annotation (Placement(transformation(extent={{-392,-176},{-372,-156}})));
public
  Systems.ExperimentalSystems.MAGNET.Data.Summary summary(
    Ts={sensor_cw_hx.T,sensor_rp_hx_2.T,sensor_hx_co.T,pT_co_rp_1.T,pT_rp_hx_1.T,
        pT_vc_pipe_rp.T,pT_rp_pipe_vc.T,pT_vc_pipe.T},
...
equation
  ...
  connect(sensor_m_flow5.port_b, pipe4.port_a) annotation (Line(points={{-80,-146},
          {-123,-146},{-123,-84}},
                               color={0,127,255}));
  connect(actuatorSubBus_.Valve_1_Opening, Valve1.opening) annotation (Line(
  ...
  connect(control_System_Therminol_4_element_all_modes.sensorSubBus,
    actuatorSubBus_) annotation (Line(
      points={{36.1333,118.092},{36.1333,106},{1,106}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(actuatorSubBus_.Valve_2_Opening, Valve2.opening) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(actuatorSubBus_.Valve_3_Opening, Valve3.opening) annotation (Line(
  ...
  connect(actuatorSubBus_.Valve_4_Opening, valve4.opening) annotation (Line(
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(actuatorSubBus_.Valve_5_Opening, Valve5.opening) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(actuatorSubBus_.Valve_6_Opening, Valve6.opening) annotation (Line(
  ...
  connect(sensorSubBus.Heater_Input, Heat_from_MAGNET.y) annotation (Line(
  ...
  connect(sensor_hx_cw.port_b,boundary. ports[1])
    annotation (Line(points={{-276,-98},{-236,-98}},
                                               color={0,127,255}));
  connect(hx.port_a2,sensor_hx_cw. port_a) annotation (Line(points={{-306,
          -116},{-300,-116},{-300,-98},{-296,-98}},
                                  color={0,127,255}));
  ...
  connect(boundary2.ports[1],sensor_cw_hx. port_a)
    annotation (Line(points={{-422,-96},{-360,-96}},
                                                  color={0,127,255}));
  connect(sensor_rp_hx_2.port_b,hx. port_b1) annotation (Line(points={{-292,
          -136},{-300,-136},{-300,-124},{-306,-124}},
                                          color={0,127,255}));
  connect(hx.port_a1,sensor_hx_co. port_a) annotation (Line(points={{-326,
          -124},{-332,-124},{-332,-136},{-338,-136}},
                                         color={0,127,255}));
  ...
  connect(opening_valve_tank.y,valve_ps. opening) annotation (Line(points={{-453,
          -116},{-392,-116},{-392,-128},{-430,-128}},
                                       color={0,0,127}));
  connect(pT_co_rp_1.port_b,rp. port_a2) annotation (Line(points={{-266,-58},
          {-298,-58},{-298,-46},{-306,-46}},
                                  color={0,127,255}));
  connect(pT_vc_pipe_rp.port_b,rp. port_a1) annotation (Line(points={{-340,
          -20},{-332,-20},{-332,-38},{-326,-38}},
                                       color={0,127,255}));
  connect(rp.port_b1,pT_rp_hx_1. port_a) annotation (Line(points={{-306,-38},
          {-276,-38},{-276,-22},{-268,-22}},
                               color={0,127,255}));
  connect(rp.port_b2,pT_rp_pipe_vc. port_a) annotation (Line(points={{-326,
          -46},{-356,-46},{-356,-60},{-362,-60}},
                                       color={0,127,255}));
  connect(pT_pipe_vc.port_b,vc. port_a) annotation (Line(points={{-456,-60},{
          -508,-60},{-508,-56}},
                          color={0,127,255}));
  connect(vc.port_b,resistance. port_a)
    annotation (Line(points={{-508,-44},{-508,-39}},
                                                   color={0,127,255}));
  connect(pT_vc_pipe.port_a,resistance. port_b) annotation (Line(points={{-490,
          -20},{-508,-20},{-508,-25}},   color={0,127,255}));
  connect(ps.ports[1],valve_ps. port_a) annotation (Line(points={{-490,-136},
          {-440,-136}},                color={0,127,255}));
  connect(pipe_hx_co.port_b,volume_co. port_a)
    annotation (Line(points={{-370,-200},{-342,-200}},
                                                   color={0,127,255}));
  connect(pipe_hx_co.port_a,valve_ps. port_b) annotation (Line(points={{-390,
          -200},{-408,-200},{-408,-136},{-420,-136}},
                                                  color={0,127,255}));
  connect(sensor_co_rp_2.port_b,pipe_co_rp. port_a)
    annotation (Line(points={{-252,-200},{-224,-200}},
                                                 color={0,127,255}));
  connect(pipe_co_rp.port_b,pT_co_rp_1. port_a) annotation (Line(points={{-204,
          -200},{-190,-200},{-190,-58},{-246,-58}},
                                          color={0,127,255}));
  ...
  connect(opening_valve_tank2.y,valve_TEDS_rp. opening) annotation (Line(
        points={{-349,54},{-360,54},{-360,77},{-367.4,77}},
                                                    color={0,0,127}));
  connect(valve_TEDS_rp.port_b,pT_TEDS_rp. port_a) annotation (Line(points={{-373,70},
          {-373,42},{-372,42},{-372,14}},              color={0,127,255}));
  ...
  connect(step1.y,co. inputSignal) annotation (Line(points={{-371,-166},{-302,
          -166},{-302,-193}},
                           color={0,0,127}));
  connect(m_flow_vc_TEDS.port_b, MAGNET_TEDS_simpleHX.port_b1) annotation (
      Line(points={{-430,98},{-48,98},{-48,54},{-70,54}},            color={0,
          127,255}));
  connect(MAGNET_TEDS_simpleHX.port_a1, valve_TEDS_rp.port_a) annotation (
      Line(points={{-90,54},{-186,54},{-186,84},{-373,84}}, color={0,127,255}));
  ...
  connect(MAGNET_TEDS_HX_exit_Temp.port_a, MAGNET_TEDS_simpleHX.port_a2)
    annotation (Line(points={{-22,46},{-70,46}}, color={0,127,255}));
  annotation (
