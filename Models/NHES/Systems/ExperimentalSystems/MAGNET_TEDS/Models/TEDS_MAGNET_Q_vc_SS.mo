...
package Medium_TEDS =
  ...
  TEDS.BaseClasses_1.SignalSubBus_SensorOutput sensorSubBus_
...
public
  ...
  TEDS.ControlSystems.Control_System_Therminol_4_element_SS
...
equation
  ...
  connect(control_System_Therminol_4_element_SS.actuatorSubBus, sensorSubBus_)
    annotation (Line(
  ...
  connect(sensorSubBus_.T_discharge_outlet, T_discharge_outlet.T) annotation (
      Line(
      points={{-31,106},{202,106},{202,9},{158.68,9}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.T_discharge_inlet, T_discharge_Inlet.T) annotation (
      Line(
      points={{-31,106},{26,106},{26,-63},{75.32,-63}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.T_charge_outlet, T_charge_outlet.T) annotation (Line(
      points={{-31,106},{202,106},{202,-63},{158.68,-63}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.T_charge_inlet, T_Charge_Inlet.T) annotation (Line(
      points={{-31,106},{26,106},{26,7},{79.32,7}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.Charging_flowrate, sensor_m_flow6.m_flow) annotation (
      Line(
      points={{-31,106},{202,106},{202,-101},{157.6,-101}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.Discharge_FlowRate, sensor_m_flow3.m_flow) annotation (
      Line(
      points={{-31,106},{202,106},{202,40},{157.6,40}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.Total_Mass_Flow_System, Chiller_Mass_flow_T66.m_flow)
    annotation (Line(
      points={{-31,106},{240,106},{240,-160},{119,-160},{119,-145.6}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(sensorSubBus_.Heater_flowrate, sensor_m_flow5.m_flow) annotation (
      Line(
  ...
  connect(sensorSubBus_.heater_BOP_massflow, BOP_Mass_flow.m_flow) annotation (
      Line(
  ...
  connect(sensorSubBus_.Heater_Input, Heat_from_MAGNET.y) annotation (Line(
