...
model TEDS_MAGNET_Integration_GT_0
  "Steady state simulation integrating MAGNET, TEDS, and Gas Turbine"
...
public
  ...
  Models.Magnet_TEDS.MAGNET_TEDS_ControlSystem.Control_System_Therminol_4_element_all_modes_MAGNET_GT_SS
