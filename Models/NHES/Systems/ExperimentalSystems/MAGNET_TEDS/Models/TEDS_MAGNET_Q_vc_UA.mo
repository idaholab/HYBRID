...
public
  ...
  TRANSFORM.Controls.LimPID PID2(
    ...
    yMin=0) annotation (Placement(transformation(extent={{-662,86},{-642,106}})));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=data.Q_flow_rp)
    annotation (Placement(transformation(extent={{-700,86},{-680,106}})));
  Modelica.Blocks.Sources.RealExpression realExpression4(y=rp.Q_flow)
    annotation (Placement(transformation(extent={{-700,64},{-680,84}})));
  TRANSFORM.Controls.LimPID PID3(
    ...
    yMax=1500,
    yMin=0) annotation (Placement(transformation(extent={{-660,22},{-640,42}})));
  Modelica.Blocks.Sources.RealExpression realExpression5(y=data.Q_flow_hx)
    annotation (Placement(transformation(extent={{-698,22},{-678,42}})));
  Modelica.Blocks.Sources.RealExpression realExpression6(y=hx.Q_flow)
    annotation (Placement(transformation(extent={{-698,0},{-678,20}})));
protected
...
equation
  ...
  connect(control_System_Therminol_4_element_SS.actuatorSubBus, sensorSubBus)
    annotation (Line(
      points={{90.7067,118.092},{90.7067,106},{-31,106}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(control_System_Therminol_4_element_SS.sensorSubBus, actuatorSubBus_)
    annotation (Line(
  ...
  connect(realExpression4.y,PID2. u_m)
    annotation (Line(points={{-679,74},{-652,74},{-652,84}},
                                                          color={0,0,127}));
  connect(realExpression1.y,PID2. u_s)
    annotation (Line(points={{-679,96},{-664,96}},
                                                 color={0,0,127}));
  connect(realExpression6.y,PID3. u_m)
    annotation (Line(points={{-677,10},{-650,10},{-650,20}}, color={0,0,127}));
  connect(realExpression5.y,PID3. u_s)
    annotation (Line(points={{-677,32},{-662,32}}, color={0,0,127}));
  annotation (
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-520,-220},{240,140}}),
                    graphics={
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-520,-220},{240,
            140}})),
    experiment(
      StopTime=18000,
      Interval=10,
