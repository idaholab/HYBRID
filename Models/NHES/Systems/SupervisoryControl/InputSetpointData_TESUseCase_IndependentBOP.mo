...
model InputSetpointData_TESUseCase_IndependentBOP
...
equation
  ...
  connect(nominal_EG.y, switch_EG.u1) annotation (Line(points={{-59,-30},{-50,-30},
          {-50,-42},{-42,-42}},
                            color={0,0,127}));
  connect(demand_EG.y[1], switch_EG.u3) annotation (Line(points={{-59,-70},{-50,
          -70},{-50,-58},{-42,-58}},
                              color={0,0,127}));
  connect(switch_EG.u2, switch_ES.u2) annotation (Line(points={{-42,-50},{-90,-50},
...
end InputSetpointData_TESUseCase_IndependentBOP;
