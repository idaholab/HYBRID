...
equation
  connect(boundary1.ports[1], mEE_FC_ss_nodelay.port_b)
    annotation (Line(points={{-100,-28},{-38,-28}}, color={0,127,255}));
  connect(mEE_FC_ss_nodelay.port_a, boundary.ports[1]) annotation (Line(
