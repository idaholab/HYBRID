...
model MEE_FC_ss_delay_fixsmoothconsatn "Multi-Effect Evaporator"
  ...
  Components.SEE_Tube_Side_PoolBoiling_smoothconsant
        ...
        rotation=270,
        origin={-122,0})));
  Components.SEE_Tube_Side_PoolBoiling_smooth_portlessconsatn
...
end MEE_FC_ss_delay_fixsmoothconsatn;
