...
model SEE_Tube_Side_PoolBoiling_smoothconsant
...
parameter  Modelica.Units.SI.CoefficientOfHeatTransfer [nV] ho_smooth=fill(7035,nV);
...
end SEE_Tube_Side_PoolBoiling_smoothconsant;
