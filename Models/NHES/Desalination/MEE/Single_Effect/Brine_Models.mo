within NHES.Desalination.MEE.Single_Effect;
package Brine_Models "These models use the SeaWater Media Package"
  ...
  model Single_Effect
    ...
    NHES.Desalination.MEE.Components.Evaporator_Brine_SHP Evaporator(
  ...
  model Single_Effect_FC
    ...
    TRANSFORM.Fluid.Interfaces.FluidPort_State Tube_Outlet(redeclare package
      ...
      annotation (Placement(transformation(extent={{92,-50},{112,-30}}), iconTransformation(extent={{92,-50},
              {112,-30}})));
    NHES.Desalination.MEE.Components.SEE_Tube_Side_Full_Cond sEE_Tube_Side
    ...
    parameter Modelica.Units.SI.Pressure p_start=100000 "Initial pressure";
  equation
  ...
  model Single_Effect_pool
    ...
    TRANSFORM.Fluid.Interfaces.FluidPort_State Tube_Outlet(redeclare package
      ...
      annotation (Placement(transformation(extent={{92,-50},{112,-30}}), iconTransformation(extent={{92,-50},
              {112,-30}})));
    NHES.Desalination.MEE.Components.SEE_Tube_Side_PoolBoiling sEE_Tube_Side(
      p_start=pT,
      Ax=Ax,
      Do=Do,
      th=th,
