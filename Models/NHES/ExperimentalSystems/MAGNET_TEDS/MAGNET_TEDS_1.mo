...
protected
  ...
  Modelica.Blocks.Sources.Constant TEDS_Temp_SP(k=data.T_hot_side)
    annotation (Placement(transformation(extent={{-72,246},{-52,266}})));
...
protected
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable1(table=[0,0; 60.037,
    ...
    annotation (Placement(transformation(extent={{-244,-6},{-224,14}})));
protected
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(table=[0,182.455699;
    ...
    annotation (Placement(transformation(extent={{-262,-92},{-242,-72}})));
protected
  Modelica.Blocks.Math.Gain gain1(k=1/3600)
    annotation (Placement(transformation(extent={{-214,-92},{-194,-72}})));
equation
  ...
  connect(TEDS_Temp_SP.y, TEDS_MassFlowControl.u_s)
    annotation (Line(points={{-51,256},{-42,256}}, color={0,0,127}));
  ...
  connect(MassFlowRate_MAGNET.y, gain.u)
    annotation (Line(points={{-97,-56},{-76,-56}}, color={0,0,127}));
  ...
  connect(valve_vc_rp.port_a, pipe_vc_rp.port_b) annotation (Line(points={{
          -134,91},{-149,91},{-149,90},{-164,90}}, color={0,127,255}));
  connect(valve_vc_rp.port_b, pT_vc_pipe_rp.port_a) annotation (Line(points={
          {-120,91},{-111,91},{-111,90},{-88,90}}, color={0,127,255}));
  connect(pT_TEDS_rp.port_b, pT_vc_pipe_rp.port_a) annotation (Line(points={{
          -100,104},{-100,90},{-88,90}}, color={0,127,255}));
  connect(opening_valve_tank3.y, valve_vc_rp.opening) annotation (Line(points=
         {{-126,135.2},{-126,118},{-127,118},{-127,96.6}}, color={0,0,127}));
  connect(combiTimeTable.y[1], gain1.u)
    annotation (Line(points={{-241,-82},{-216,-82}}, color={0,0,127}));
