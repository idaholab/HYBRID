...
package Medium_TEDS =
  ...
  NHES.Systems.Experiments.TEDS.Control_Systems.Control_System_Therminol_4_element_all_modes
  ...
  NHES.Systems.Experiments.TEDS.BaseClasses.SignalSubBus_ActuatorInput actuatorSubBus
    annotation (Placement(transformation(extent={{-42,94},{-20,118}})));
  NHES.Systems.Experiments.TEDS.BaseClasses.SignalSubBus_SensorOutput sensorSubBus
  ...
  TRANSFORM.Fluid.Sensors.MassFlowRate sensor_m_flow3(redeclare package Medium
      = TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C, precision=
       3) annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={154,40})));
  NHES.Systems.Experiments.TEDS.ThermoclineModels.Thermocline_Insulation thermocline_Insulation(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
