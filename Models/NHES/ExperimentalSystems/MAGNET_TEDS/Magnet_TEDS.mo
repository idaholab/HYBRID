...
package Magnet_TEDS
  ...
  public
    ...
    ExperimentalSystems.MAGNET.Data.Data_base data
    ...
    ExperimentalSystems.MAGNET.Data.Summary summary(
      ...
      ps={sensor_cw_hx.p,sensor_rp_hx_2.p,sensor_hx_co.p,sensor_co_rp_1.p,
          sensor_rp_hx_1.p,sensor_vc_pipe_rp.p,sensor_rp_pipe_vc.p,
          sensor_vc_pipe.p},
  ...
  package MAGNET_TEDS_ControlSystem
    ...
    extends NHES.Systems.SupervisoryControl;
    ...
    parameter Modelica.Units.SI.Power Q_TES_max=175e3;
    parameter Modelica.Units.SI.Power Heater_max=175e3;
    parameter Modelica.Units.SI.Temperature T_hot_design=325;
    parameter Modelica.Units.SI.Temperature T_cold_design=225;

    parameter Modelica.Units.SI.MassFlowRate m_tes_max=2;
                                            //=Q_TES_max/(Cp*(T_hot_design - T_cold_design));
    parameter Modelica.Units.SI.MassFlowRate m_heater_max=2;
                                               //Just a large number. Not ideal for control, but should work to start off the system.

    Modelica.Units.SI.MassFlowRate m_MAGNET_needed;
                                     // mass flow needed from MAGNET as calculated based on Tin on TEDS side
    Modelica.Units.SI.MassFlowRate m_MAGNET_left;
                                   // mass flow left on the MAGNET side not needed
    Modelica.Units.SI.Power Heat_needed;
    Modelica.Units.SI.SpecificHeatCapacity Cp=Medium.specificHeatCapacityCp(
          mediums.state);

    parameter Modelica.Units.SI.Pressure p_atm=1e5;
    parameter Modelica.Units.SI.Pressure p_MAGNET=
          TRANSFORM.Units.Conversions.Functions.Pressure_Pa.from_bar(11.5) +
          p_atm;
    parameter Modelica.Units.SI.Temperature Tin_MAGNET=
          TRANSFORM.Units.Conversions.Functions.Temperature_K.from_degC(602);
    parameter Modelica.Units.SI.Temperature Tout_MAGNET=
          TRANSFORM.Units.Conversions.Functions.Temperature_K.from_degC(430);
    ...
    Real Error1_MAGNET "Valve 1, MAGNET to TEDS ";
    Modelica.Units.SI.Power Heat_needed_GT;
                             // Heat needed to produce electricity
    Modelica.Units.SI.MassFlowRate m_MAGNET_GT;
                                 // mass flow needed from MAGNET to produce electricity
    ...
    Modelica.Units.SI.MassFlowRate m_bop_heater_demand;
                                         //Demand through Valve 2
    Modelica.Units.SI.MassFlowRate m_MAGNET_left;
                                   // mass flow left on the MAGNET side not needed
    Modelica.Units.SI.MassFlowRate m_tes_demand;
    Modelica.Units.SI.MassFlowRate m_heater_demand;
    ...
    parameter Modelica.Units.SI.Temperature Tin_MAGNET=
          TRANSFORM.Units.Conversions.Functions.Temperature_K.from_degC(602);
    parameter Modelica.Units.SI.Temperature Tout_MAGNET=
          TRANSFORM.Units.Conversions.Functions.Temperature_K.from_degC(450);
    ...
    Modelica.Units.SI.MassFlowRate m_MAGNET_left;
                                   // mass flow left on the MAGNET side not needed
    Modelica.Units.SI.MassFlowRate m_tes_discharged;
    Modelica.Units.SI.MassFlowRate m_tes_charged;
    Modelica.Units.SI.Power Q_TES_discharge;
    Modelica.Units.SI.Power Heat_needed_GT;
    Modelica.Units.SI.MassFlowRate m_MAGNET_GT;
                                 // mass flow needed from MAGNET to produce electricity
    ...
    Modelica.Units.SI.MassFlowRate m_tes_charged;
    Modelica.Units.SI.MassFlowRate m_heater_demand;
    Modelica.Units.SI.Power Q_TES_charge;
    Modelica.Units.SI.Power Q_TES_discharge;
    Modelica.Units.SI.Power Heat_needed_GT;
    Modelica.Units.SI.MassFlowRate m_MAGNET_GT;
                                 // mass flow needed from MAGNET to produce electricity
    ...
    Modelica.Units.SI.MassFlowRate m_bop_heater_demand;
                                         //Demand through Valve 2
    Modelica.Units.SI.MassFlowRate m_bop_heater_demand_graph;
    Modelica.Units.SI.MassFlowRate m_MAGNET_left;
                                   // mass flow left on the MAGNET side not needed
    Modelica.Units.SI.MassFlowRate m_tes_discharged;
    Modelica.Units.SI.MassFlowRate m_tes_charged;
    ...
    Modelica.Units.SI.Power Heat_needed_GT;
    Modelica.Units.SI.Power Heat_demand;
    Modelica.Units.SI.Power TES_Load;
    Modelica.Units.SI.MassFlowRate m_MAGNET_GT;
                                 // mass flow needed from MAGNET to produce electricity
    Modelica.Units.SI.SpecificHeatCapacity Cp=Medium.specificHeatCapacityCp(
          mediums.state);
