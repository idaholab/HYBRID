...
model TEDS_com_8_9_2021_charge200C
  "TEDS Commissioning 8/9/2021, getting the system to 50C top thermocline and 20C bottom thermocline"
  ...
  Control_Systems.Control_System_Therminol_4_TEDS_com_charge
    control_System_Therminol_4_TEDS_com_charge(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
    T_hot_design(displayUnit="degC") = 473.15,
    T_cold_design(displayUnit="degC") = 423.15)
  ...
  Modelica.Blocks.Sources.Constant const1(k=
        control_System_Therminol_4_TEDS_com_charge.T_cold_design) annotation (
  ...
  Modelica.Blocks.Sources.Constant const(k=
        control_System_Therminol_4_TEDS_com_charge.T_hot_design) annotation (
      Placement(transformation(
        extent={{-6,-6},{6,6}},
        rotation=0,
        origin={-146,46})));
...
equation
  ...
  connect(control_System_Therminol_4_TEDS_com_charge.actuatorSubBus,
    actuatorSubBus) annotation (Line(
      points={{33,118.458},{33,104},{-33,104}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
  connect(control_System_Therminol_4_TEDS_com_charge.sensorSubBus, sensorSubBus)
    annotation (Line(
...
end TEDS_com_8_9_2021_charge200C;
