...
model TEDS_com_8_9_2021_init
  ...
  Data.Data_TEDS data(T_hot_side(displayUnit="degC") = 323.15,
                                                 T_cold_side(displayUnit="degC")=
         293.65)
  ...
  Control_Systems.Control_System_Therminol_4_element_initial_exp
    ...
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
    T_hot_design(displayUnit="degC") = 323.15,
