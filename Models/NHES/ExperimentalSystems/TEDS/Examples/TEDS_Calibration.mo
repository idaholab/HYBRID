...
model TEDS_Calibration "Test from TEDS calibration experiment"
  ...
  Control_Systems.Control_System_Therminol_4_element_summer_day_real_100F
    ...
    T_cold_design(displayUnit="K") = Modelica.Units.Conversions.from_degF(50))
...
equation
  ...
  connect(control_System_Therminol_4_element_summer_day_real_100F.actuatorSubBus,
    actuatorSubBus) annotation (Line(
      points={{33,118.458},{33,106},{-31,106}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5));
