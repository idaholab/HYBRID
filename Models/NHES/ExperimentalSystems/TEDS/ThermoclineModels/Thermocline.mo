...
Modelica.Units.SI.Temperature Ts=95 + 273.15 "K";
Modelica.Units.SI.DynamicViscosity eta=Medium.dynamicViscosity(mediums[1].state);
Modelica.Units.SI.ThermalConductivity lambda=Medium.thermalConductivity(mediums[
      1].state);
...
Modelica.Units.SI.Density fluid_density=753.75
    "Fluid Density Assumed Constant for now kg/m^3";                             //First go is to match the paper
parameter Modelica.Units.SI.Density filler_density=2630
    "Filler Density (Granite)";

Modelica.Units.SI.SpecificHeatCapacity Cf=2474.5 "J/kg*K of fluid";
parameter Modelica.Units.SI.SpecificHeatCapacity Cr=775.0 "J/kg*K of granite";
Modelica.Units.SI.ThermalConductivity kf=0.086 "W/m*K of fluid";
parameter Modelica.Units.SI.ThermalConductivity kr=2.8 "W/m*K of filler";

Modelica.Units.SI.ReynoldsNumber Re "Unitless";
Modelica.Units.SI.MassFlowRate mf;
                     //=-128.74 "kg/s";
Modelica.Units.SI.Velocity vel "meter/s";
Modelica.Units.SI.CoefficientOfHeatTransfer h_c "W/m^2*K";
Modelica.Units.SI.PrandtlNumber Pr "Unitless";
...
Modelica.Units.SI.DynamicViscosity mu_f=1.8e-04 "Pa*s";
