...
parameter Modelica.Units.SI.Area XS_fluid=Porosity*(Radius_Tank^2.0)*Modelica.Constants.pi
    "Cross Sectional Area seen by the fluid at each axial location";
parameter Modelica.Units.SI.Length Height_Tank=14.6 "Tank Height [m]";

//Discretization
parameter Integer nodes=200 "Number of axial nodes";

parameter Modelica.Units.SI.Length dz=Height_Tank/nodes
    "delta height in each node";
...
Modelica.Units.SI.SpecificHeatCapacity Cf[nodes]=Medium.specificHeatCapacityCp(
      mediums.state);
