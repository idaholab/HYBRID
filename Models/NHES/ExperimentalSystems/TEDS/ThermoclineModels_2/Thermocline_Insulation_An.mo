...
model Thermocline_Insulation_An "Thermocline Insulation subpackage"
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder simpleWall[
    thermocline_fluidprops_heaters_newHC_225C.nodes](
    length=fill(thermocline_fluidprops_heaters_newHC_225C.Height_Tank/
        thermocline_fluidprops_heaters_newHC_225C.nodes,
        thermocline_fluidprops_heaters_newHC_225C.nodes),
  ...
  Thermocline_fluidprops_heaters_newHC_225C
    ...
    kr=16.181,
    dr=geometry.dr)
    annotation (Placement(transformation(extent={{-26,-28},{26,32}})));
equation
  ...
  connect(thermocline_fluidprops_heaters_newHC_225C.port_b, port_b) annotation (
     Line(points={{0,-28},{0,-100}},                   color={0,127,255}));
  connect(port_a, thermocline_fluidprops_heaters_newHC_225C.port_a)
    annotation (Line(points={{0,100},{0,32}}, color={0,127,255}));
  connect(simpleWall.port_b, thermocline_fluidprops_heaters_newHC_225C.heatPorts[
    :, 1]) annotation (Line(points={{-40,2},{-26.52,2}}, color={191,0,0}));
