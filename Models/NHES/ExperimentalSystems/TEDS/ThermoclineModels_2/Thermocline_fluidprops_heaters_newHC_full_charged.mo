...
model Thermocline_fluidprops_heaters_newHC_full_charged
...
parameter SI.Density filler_density = 3950 "Filler Density (Alumina)";
...
end Thermocline_fluidprops_heaters_newHC_full_charged;
