...
model Thermocline_Insulation_full_charged
  "Thermocline Insulation subpackage"
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder simpleWall[
    thermocline_fluidprops_heaters_newHC_full_charged.nodes](
    length=fill(thermocline_fluidprops_heaters_newHC_full_charged.Height_Tank/
        thermocline_fluidprops_heaters_newHC_full_charged.nodes,
        thermocline_fluidprops_heaters_newHC_full_charged.nodes),
  ...
  Systems.Experiments.TEDS.Data.Geometry geometry(nodes=200) annotation (Dialog(
        group="Geometry"), Placement(transformation(extent={{-98,78},{-78,98}})));

  Thermocline_fluidprops_heaters_newHC_full_charged
    thermocline_fluidprops_heaters_newHC_full_charged(
    ...
    kr=16.181,
    dr=geometry.dr)
    annotation (Placement(transformation(extent={{-30,-34},{30,38}})));
equation
  ...
  connect(boundary2.port, Insulation.port_a) annotation (Line(points={{-90,
          -14},{-90,-8},{-86,-8},{-86,2}}, color={191,0,0}));
  connect(thermocline_fluidprops_heaters_newHC_full_charged.port_a, port_a)
    annotation (Line(points={{0,38},{0,100}}, color={0,127,255}));
  connect(thermocline_fluidprops_heaters_newHC_full_charged.port_b, port_b)
    annotation (Line(points={{0,-34},{0,-100}}, color={0,127,255}));
  connect(simpleWall.port_b, thermocline_fluidprops_heaters_newHC_full_charged.heatPorts[
    :, 1]) annotation (Line(points={{-40,2},{-30.6,2}}, color={191,0,0}));
...
end Thermocline_Insulation_full_charged;
