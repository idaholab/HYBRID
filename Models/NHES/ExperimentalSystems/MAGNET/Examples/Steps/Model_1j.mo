...
model Model_1j
  ...
  TRANSFORM.Controls.LimPID PID(
    ...
    yMin=0) annotation (Placement(transformation(extent={{-156,82},{-136,102}})));
  Modelica.Blocks.Sources.RealExpression realExpression(y=data.Q_flow_rp)
    annotation (Placement(transformation(extent={{-194,82},{-174,102}})));
  ...
  TRANSFORM.Controls.LimPID PID1(
    ...
    yMin=0) annotation (Placement(transformation(extent={{-154,36},{-134,56}})));
...
equation
  ...
  connect(realExpression1.y,PID. u_m)
    annotation (Line(points={{-173,70},{-146,70},{-146,80}},
                                                        color={0,0,127}));
  connect(realExpression.y,PID. u_s)
    annotation (Line(points={{-173,92},{-158,92}},
                                                 color={0,0,127}));
  connect(realExpression3.y, PID1.u_m)
    annotation (Line(points={{-171,24},{-144,24},{-144,34}}, color={0,0,127}));
  connect(realExpression2.y, PID1.u_s)
    annotation (Line(points={{-171,46},{-156,46}}, color={0,0,127}));
