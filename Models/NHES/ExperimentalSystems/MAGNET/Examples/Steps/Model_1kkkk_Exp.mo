...
model Model_1kkkk_Exp
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    table=[0.0,400; 2600,500; 4200,600; 9400,500; 18200,600; 18200,50],
...
protected
  ...
  TRANSFORM.Fluid.Volumes.SimpleVolume vc(
    ...
    redeclare model Geometry =
        ...
        (V=0.1),
    Q_gen=PID1.y) annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={-92,52})));
  ...
  Modelica.Blocks.Sources.RealExpression realExpression1(y=vc.medium.T)
    annotation (Placement(transformation(extent={{-178,30},{-158,50}})));
equation
  connect(rp.port_b1, sensor_pT6.port_a) annotation (Line(points={{40,64},{46,
          64},{46,80},{50,80}}, color={0,127,255}));
  connect(rp.port_b2, sensor_pT2.port_a) annotation (Line(points={{20,56},{14,
          56},{14,40},{10,40}}, color={0,127,255}));
  connect(sensor_pT5.port_b, rp.port_a1) annotation (Line(points={{10,80},{14,
          80},{14,64},{20,64}}, color={0,127,255}));
  connect(sensor_pT1.port_b, rp.port_a2) annotation (Line(points={{50,40},{46,
          40},{46,56},{40,56}}, color={0,127,255}));
  connect(sensor_pT8.port_a, hx.port_b1) annotation (Line(points={{-70,-60},{-66,
  ...
  connect(hx.port_b2, sensor_pT10.port_a) annotation (Line(points={{-40,-36},{-34,
  ...
  connect(hx.port_a1, sensor_pT7.port_b) annotation (Line(points={{-40,-44},{-34,
  ...
  connect(sensor_pT1.T, PID.u_m) annotation (Line(points={{54,38},{48,38},{48,
          -28},{60,-28},{60,-58}}, color={0,0,127}));
  connect(realExpression1.y, PID1.u_m)
    annotation (Line(points={{-157,40},{-150,40},{-150,58}}, color={0,0,127}));
  connect(combiTimeTable.y[1], PID1.u_s)
